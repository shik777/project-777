...
!function(n) {
    ...
    var s = function(e, t) {
        ...
        be.FE.OPTS_MAPPING[r] = be.FE.OPTS_MAPPING[r] || this.id, this.sid = be.FE.OPTS_MAPPING[r], be.FE.SHARED[this.sid] = be.FE.SHARED[this.sid] || {}, this.shared = be.FE.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = be(e), this.$oel.data("froala.editor", this), this.o_doc = e.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow;
        var i = be(this.o_win).scrollTop();
        this.$oel.on("froala.doInit", be.proxy(function() {
            this.$oel.off("froala.doInit"), this.doc = this.$el.get(0).ownerDocument, this.win = "defaultView" in this.doc ? this.doc.defaultView : this.doc.parentWindow, this.$doc = be(this.doc), this.$win = be(this.win), this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(be.FE.PLUGINS)), this.opts.initOnClick ? (this.load(be.FE.MODULES), this.$el.on("touchstart.init", function() {
                be(this).data("touched", !0)
            }), this.$el.on("touchmove.init", function() {
                be(this).removeData("touched")
            }), this.$el.on("mousedown.init touchend.init dragenter.init focus.init", be.proxy(function(e) {
                if ("touchend" == e.type && !this.$el.data("touched"))
                    return !0;
                if (1 === e.which || !e.which) {
                    this.$el.off("mousedown.init touchstart.init touchmove.init touchend.init dragenter.init focus.init"), this.load(be.FE.MODULES), this.load(be.FE.PLUGINS);
                    var t = e.originalEvent && e.originalEvent.originalTarget;
                    t && "IMG" == t.tagName && be(t).trigger("mousedown"), "undefined" == typeof this.ul && this.destroy(), "touchend" == e.type && this.image && e.originalEvent && e.originalEvent.target && be(e.originalEvent.target).is("img") && setTimeout(be.proxy(function() {
                        this.image.edit(be(e.originalEvent.target))
                    }, this), 100), this.ready = !0, this.events.trigger("initialized")
                }
            }, this)), this.events.trigger("initializationDelayed")) : (this.load(be.FE.MODULES), this.load(be.FE.PLUGINS), be(this.o_win).scrollTop(i), "undefined" == typeof this.ul && this.destroy(), this.ready = !0, this.events.trigger("initialized"))
        }, this)), this._init()
    };
    s.DEFAULTS = {
        initOnClick: !1,
        ...
        for (var t in e)
            if (e.hasOwnProperty(t)) {
                if (this[t])
                    continue;
                if (be.FE.PLUGINS[t] && this.opts.pluginsEnabled.indexOf(t) < 0)
                    continue;
        ...
        if (this.opts.iframe && (this.events.disableBlur(), this.win.focus(), this.events.enableBlur()), this.events.trigger("destroy", [], !0), this.events.trigger("shared.destroy", undefined, !0), 0 === this.shared.count) {
            for (var t in this.shared)
                this.shared.hasOwnProperty(t) && (this.shared[t], be.FE.SHARED[this.sid][t] = null);
            delete be.FE.SHARED[this.sid]
        }
        this.$oel.parents("form").off("." + this.id), this.$oel.off("click.popup"), this.$oel.removeData("froala.editor"), this.$oel.off("froalaEditor"), this.core.destroy(e), be.FE.INSTANCES.splice(be.FE.INSTANCES.indexOf(this), 1)
    }, be.fn.froalaEditor = function(i) {
        for (var a = [], e = 0; e < arguments.length; e++)
            a.push(arguments[e]);
        if ("string" == typeof i) {
            var o = [];
            return this.each(function() {
                var e = be(this).data("froala.editor");
                if (e) {
                    var t,
                        n;
                    if (0 < i.indexOf(".") && e[i.split(".")[0]] ? (e[i.split(".")[0]] && (t = e[i.split(".")[0]]), n = i.split(".")[1]) : (t = e, n = i.split(".")[0]), !t[n])
                        return be.error("Method " + i + " does not exist in Froala Editor.");
        ...
        if ("object" == typeof i || !i)
            return this.each(function() {
                if (!be(this).data("froala.editor")) {
                    new s(this, i)
                }
            })
    }, be.fn.froalaEditor.Constructor = s, be.FroalaEditor = s, be.FE = s, be.FE.XS = 0, be.FE.SM = 1, be.FE.MD = 2, be.FE.LG = 3;
    if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function(a) {
        function e() {
            var e,
                t,
                n = {},
        ...
        return {
            ...
            isEmail: function(e) {
                return !/^(https?:|ftps?:|)\/\//i.test(e) && be.FE.MAIL_REGEX.test(e)
            },
            ...
            getPX: o,
            screenSize: function() {
                var e = be('<div class="fr-visibility-helper"></div>').appendTo("body:first");
                try {
            ...
            sanitizeURL: function(e) {
                return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(" + be.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            },
            isArray: function(e) {
            ...
            isURL: function(e) {
                return !!/^(https?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^" + be.FE.LinkRegExHTTP + be.FE.LinkRegExEnd + "$", "gi").test(e))
            },
            getAlignment: function(e) {
                var t = (e.css("text-align") || "").replace(/-(.*)-/g, "");
                if (["left", "right", "justify", "center"].indexOf(t) < 0) {
                    if (!s) {
                        var n = be('<div dir="' + ("rtl" == a.opts.direction ? "rtl" : "auto") + '" style="text-align: ' + a.$el.css("text-align") + '; position: fixed; left: -3000px;"><span id="s1">.</span><span id="s2">.</span></div>');
                        be("body:first").append(n);
    ...
    }, be.FE.MODULES.events = function(s) {
        var e,
            o = {};
        function t(e, t, n) {
            f(e, t, n)
        ...
        function n(e) {
            if (void 0 === e && (e = !0), !s.$wp)
                return !1;
            if (s.helpers.isIOS() && s.$win.get(0).focus(), s.core.hasFocus())
                return !1;
            if (!s.core.hasFocus() && e) {
                var t = s.$win.scrollTop();
                if (s.browser.msie && s.$box && s.$box.css("position", "fixed"), s.browser.msie && s.$wp && s.$wp.css("overflow", "visible"), a(), s.$el.focus(), s.events.trigger("focus"), i(), s.browser.msie && s.$box && s.$box.css("position", ""), s.browser.msie && s.$wp && s.$wp.css("overflow", "auto"), t != s.$win.scrollTop() && s.$win.scrollTop(t), !s.selection.info(s.el).atStart)
                    return !1
            }
            if (!s.core.hasFocus() || 0 < s.$el.find(".fr-marker").length)
                return !1;
            if (s.selection.info(s.el).atStart && s.selection.isCollapsed() && null != s.html.defaultTag()) {
                ...
                if (n && !s.node.blockParent(n)) {
                    ...
                    r && (be(r).prepend(be.FE.MARKERS), s.selection.restore())
                } else
                    n && be(n).remove()
            }
        }
            ...
            if (!s.edit.isDisabled() || n) {
                ...
                if (r)
                    for (var a = 0; a < r.length; a++)
                        if (!1 === (i = r[a].apply(s, t)))
                            return !1;
                return !1 !== (i = s.$oel.triggerHandler("froalaEditor." + e, be.merge([s], t || []))) && i
            }
        }
        function h() {
            for (var e in o)
        ...
        function g() {
            for (var e in s.shared._events)
                s.shared._events.hasOwnProperty(e) && delete s.shared._events[e]
        }
        return {
            _init: function() {
                s.shared.$_events = s.shared.$_events || [], s.shared._events = {}, s.helpers.isMobile() ? (s._mousedown = "touchstart", s._mouseup = "touchend", s._move = "touchmove", s._mousemove = "touchmove") : (s._mousedown = "mousedown", s._mouseup = "mouseup", s._move = "", s._mousemove = "mousemove"), t(s.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function(e) {
                    ...
                    for (var e = 0; e < be.FE.INSTANCES.length; e++)
                        be.FE.INSTANCES[e] != s && be.FE.INSTANCES[e].popups && be.FE.INSTANCES[e].popups.areVisible() && be.FE.INSTANCES[e].$el.find(".fr-marker").remove()
            ...
            bindClick: function(e, t, n) {
                f(e, s._mousedown, t, function(e) {
                    var t,
                        n;
                    s.edit.isDisabled() || (n = be((t = e).currentTarget), s.edit.isDisabled() || s.node.hasClass(n.get(0), "fr-disabled") ? t.preventDefault() : "mousedown" === t.type && 1 !== t.which || (s.helpers.isMobile() || t.preventDefault(), (s.helpers.isAndroid() || s.helpers.isWindowsPhone()) && 0 === n.parents(".fr-dropdown-menu").length && (t.preventDefault(), t.stopPropagation()), n.addClass("fr-selected"), s.events.trigger("commands.mousedown", [n])))
                }, !0), f(e, s._mouseup + " " + s._move, t, function(e) {
                    s.edit.isDisabled() || function(e, t) {
                        var n = be(e.currentTarget);
                        if (s.edit.isDisabled() || s.node.hasClass(n.get(0), "fr-disabled"))
                            return e.preventDefault();
                        if (("mouseup" !== e.type || 1 === e.which) && s.node.hasClass(n.get(0), "fr-selected"))
                            if ("touchmove" != e.type) {
                                if (e.stopPropagation(), e.stopImmediatePropagation(), e.preventDefault(), !s.node.hasClass(n.get(0), "fr-selected"))
                                    return s.button.getButtons(".fr-selected", !0).removeClass("fr-selected");
                                if (s.button.getButtons(".fr-selected", !0).removeClass("fr-selected"), n.data("dragging") || n.attr("disabled"))
                    ...
                    be(this).hasClass("fr-options") && be(this).prev(".fr-btn").addClass("fr-btn-hover"), be(this).next(".fr-btn").hasClass("fr-options") && be(this).next(".fr-btn").addClass("fr-btn-hover")
                }), f(e, "mouseleave", t, function() {
                    be(this).hasClass("fr-options") && be(this).prev(".fr-btn").removeClass("fr-btn-hover"), be(this).next(".fr-btn").hasClass("fr-options") && be(this).next(".fr-btn").removeClass("fr-btn-hover")
                })
            },
            disableBlur: a,
            enableBlur: i,
            ...
            chainTrigger: function(e, t, n) {
                if (!s.edit.isDisabled() || n) {
                    ...
                    if (r)
                        for (var a = 0; a < r.length; a++)
                            void 0 !== (i = r[a].apply(s, [t])) && (t = i);
                    return void 0 !== (i = s.$oel.triggerHandler("froalaEditor." + e, be.merge([s], [t]))) && (t = i), t
                }
            },
            $on: f,
            $off: function() {
    ...
    }, be.FE.MODULES.node = function(o) {
        function s(e) {
            return e && "IFRAME" != e.tagName ? Array.prototype.slice.call(e.childNodes || []) : []
        }
        function l(e) {
            return !!e && (e.nodeType == Node.ELEMENT_NODE && 0 <= be.FE.BLOCK_TAGS.indexOf(e.tagName.toLowerCase()))
        }
        function d(e) {
            var t = {},
                n = e.attributes;
        ...
        return {
            ...
            isEmpty: function(e, t) {
                ...
                return !(e.querySelectorAll(be.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length || e.querySelector(o.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || 1 < e.querySelectorAll(be.FE.BLOCK_TAGS.join(",")).length || e.querySelector(o.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)"))
            },
            ...
            deepestParent: function(e, t, n) {
                if (void 0 === t && (t = []), void 0 === n && (n = !0), t.push(o.el), 0 <= t.indexOf(e.parentNode) || e.parentNode && o.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= be.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n)
                    return null;
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !o.node.hasClass(e.parentNode, "fr-inner") && (be.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || !l(e.parentNode) || !n);)
                    e = e.parentNode;
                return e
            },
            rawAttributes: d,
            ...
            contents: s,
            isVoid: function(e) {
                return e && e.nodeType == Node.ELEMENT_NODE && 0 <= be.FE.VOID_ELEMENTS.indexOf((e.tagName || "").toLowerCase())
            },
            hasFocus: function(e) {
            ...
            hasClass: function(e, t) {
                return e instanceof be && (e = e.get(0)), e && e.classList && e.classList.contains(t)
            },
            filter: function(e) {
    ...
    }, be.FE.INVISIBLE_SPACE = "&#8203;", be.FE.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>", be.FE.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>", be.FE.MARKERS = be.FE.START_MARKER + be.FE.END_MARKER, be.FE.MODULES.markers = function(d) {
        function l() {
            if (!d.$wp)
                return null;
            try {
                ...
                if (t != d.el && 0 === d.$el.find(t).length)
                    return null;
                var n = e.cloneRange(),
                    r = e.cloneRange();
                n.collapse(!0);
                var i = be('<span class="fr-marker" style="display: none; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>", d.doc)[0];
                if (n.insertNode(i), i = d.$el.find("span.fr-marker").get(0)) {
                    for (var a = i.nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;)
                        be(a).remove(), a = d.$el.find("span.fr-marker").get(0).nextSibling;
        ...
        return {
            place: function(e, t, n) {
                ...
                try {
                    var o = e.cloneRange();
                    if (o.collapse(t), o.insertNode(be('<span class="fr-marker" data-id="' + n + '" data-type="' + t + '" style="display: ' + (d.browser.safari ? "none" : "inline-block") + '; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>", d.doc)[0]), !0 === t)
                        for (a = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="' + n + '"]').get(0)).nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;)
                            be(a).remove(), a = r.nextSibling;
                    if (!0 === t && !e.collapsed) {
                        for (; !d.node.isElement(r.parentNode) && !a;)
                            be(r.parentNode).after(r), a = r.nextSibling;
                    ...
                    if (!1 === t && !e.collapsed) {
                        ...
                        r.parentNode && 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) && r.parentNode.previousSibling && !r.previousSibling && be(r.parentNode.previousSibling).append(r)
                    }
            ...
            split: function() {
                ...
                if (null == e && (e = l()), null == e)
                    return null;
                var t = d.node.deepestParent(e);
                if (t || (t = d.node.blockParent(e)) && "LI" != t.tagName && (t = null), t)
                    if (d.node.isBlock(t) && d.node.isEmpty(t))
                        "LI" != t.tagName || t.parentNode.firstElementChild != t || d.node.isEmpty(t.parentNode) ? be(t).replaceWith('<span class="fr-marker"></span>') : be(t).append('<span class="fr-marker"></span>');
                    else if (d.cursor.isAtStart(e, t))
                        be(t).before('<span class="fr-marker"></span>'), be(e).remove();
                    else if (d.cursor.isAtEnd(e, t))
                        be(t).after('<span class="fr-marker"></span>'), be(e).remove();
                    else {
                        ...
                        var a = d.node.openTagString(t) + be(t).html() + d.node.closeTagString(t);
                        a = a.replace(/<span id="fr-break"><\/span>/g, r + '<span class="fr-marker"></span>' + i), be(t).replaceWith(a)
                    }
    ...
    }, be.FE.MODULES.selection = function(T) {
        function s() {
            var e = "";
            ...
            if (T.$wp) {
                ...
                for (t = 0; t < n.length; t++)
                    if (n[t].startContainer !== T.doc || T.browser.msie) {
                        ...
                        if (void 0 !== a && a || !i || (be(".fr-marker").remove(), T.selection.setAtEnd(T.el)), T.el.normalize(), T.browser.safari && !i)
                            try {
                                (e = T.doc.createRange()).setStartAfter(a), e.setEndBefore(o), r.push(e)
                            } catch (s) {}
                    }
                if (T.browser.safari && r.length)
                    for (T.selection.clear(), t = 0; t < r.length; t++)
                    ...
                    try {
                        ...
                        if (i.nextSibling == o || o.nextSibling == i) {
                            for (var h = i.nextSibling == o ? i : o, g = h == i ? o : i, m = h.previousSibling; m && m.nodeType == Node.TEXT_NODE && 0 === m.length;)
                                m = (l = m).previousSibling, be(l).remove();
                            if (m && m.nodeType == Node.TEXT_NODE)
                                for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;)
                                    m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, be(m.nextSibling).remove();
                            for (var v = g.nextSibling; v && v.nodeType == Node.TEXT_NODE && 0 === v.length;)
                                v = (l = v).nextSibling, be(l).remove();
                            if (v && v.nodeType == Node.TEXT_NODE)
                                for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;)
                                    v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, be(v.previousSibling).remove();
                            if (m && (T.node.isVoid(m) || T.node.isBlock(m)) && (m = null), v && (T.node.isVoid(v) || T.node.isBlock(v)) && (v = null), m && v && m.nodeType == Node.TEXT_NODE && v.nodeType == Node.TEXT_NODE) {
                                be(i).remove(), be(o).remove();
                                var E = m.textContent.length;
                                m.textContent = m.textContent + v.textContent, be(v).remove(), T.opts.htmlUntouched || T.spaces.normalize(m), a.setStart(m, E), a.setEnd(m, E), d = !0
                            } else
                        ...
                        if (!d)
                            (T.browser.chrome || T.browser.edge) && i.nextSibling == o ? (f = y(o, a, !0) || a.setStartAfter(o), p = y(i, a, !1) || a.setEndBefore(i)) : (i.previousSibling == o && (o = (i = o).nextSibling), o.nextSibling && "BR" === o.nextSibling.tagName || !o.nextSibling && T.node.isBlock(i.previousSibling) || i.previousSibling && "BR" == i.previousSibling.tagName || (i.style.display = "inline", o.style.display = "inline", s = be(T.doc.createTextNode("\u200b"))), f = y(i, a, !0) || be(i).before(s) && a.setStartBefore(i), p = y(o, a, !1) || be(o).after(s) && a.setEndAfter(o)), "function" == typeof f && f(), "function" == typeof p && p()
                    } catch (b) {}
                }
                s && s.remove();
                try {
        ...
        function y(e, t, n) {
            var r,
                i = e.previousSibling,
                a = e.nextSibling;
            return i && a && i.nodeType == Node.TEXT_NODE && a.nodeType == Node.TEXT_NODE ? (r = i.textContent.length, n ? (a.textContent = i.textContent + a.textContent, be(i).remove(), be(e).remove(), T.opts.htmlUntouched || T.spaces.normalize(a), function() {
                t.setStart(a, r)
            }) : (i.textContent = i.textContent + a.textContent, be(a).remove(), be(e).remove(), T.opts.htmlUntouched || T.spaces.normalize(i), function() {
                t.setEnd(i, r)
        ...
        function i(e) {
            ...
            if (T.win.getSelection) {
                ...
                T.doc.selection && "Control" != T.doc.selection.type && ((n = (t = T.doc.selection.createRange()).duplicate()).moveToElementText(e), n.setEndPoint("EndToStart", t), r = "" === n.text, n.moveToElementText(e), n.setEndPoint("StartToEnd", t), i = "" === n.text);
            return {
                atStart: r,
                atEnd: i
            }
        ...
        function L(e, t) {
            void 0 === t && (t = !0);
            var n = be(e).html();
            n && n.replace(/\u200b/g, "").length != n.length && be(e).html(n.replace(/\u200b/g, ""));
            for (var r = T.node.contents(e), i = 0; i < r.length; i++)
                r[i].nodeType != Node.ELEMENT_NODE ? be(r[i]).remove() : (L(r[i], 0 === i), 0 === i && (t = !1));
            e.nodeType == Node.TEXT_NODE ? be(e).replaceWith('<span data-first="true" data-text="true"></span>') : t && be(e).attr("data-first", !0)
        }
        function x() {
            return 0 === be(this).find("fr-inner").length
        }
        function p() {
            try {
                if (!T.$wp)
        ...
        function r(e, t) {
            ...
            for (var n = e.firstChild; n && (T.node.isBlock(n) || t && !T.node.isVoid(n) && n.nodeType == Node.ELEMENT_NODE);)
                n = (e = n).firstChild;
            e.innerHTML = be.FE.MARKERS + e.innerHTML
        }
        function a(e, t) {
            if (!e || 0 < e.getElementsByClassName("fr-marker").length)
                return !1;
            ...
            r.setAttribute("id", "fr-sel-markers"), r.innerHTML = be.FE.MARKERS, e.appendChild(r);
        ...
        return {
                    ...
                    if (e.rangeCount) {
                        ...
                        if (r.nodeType == Node.TEXT_NODE && n.startOffset == (r.textContent || "").length && r.nextSibling && (r = r.nextSibling), r.nodeType == Node.ELEMENT_NODE) {
                            ...
                            if (0 < r.childNodes.length && r.childNodes[n.startOffset]) {
                                ...
                                !n.collapsed && r.nextSibling && r.nextSibling.nodeType == Node.ELEMENT_NODE && (t = r.nextSibling) && t.textContent.replace(/\u200B/g, "") === s().replace(/\u200B/g, "") && (r = t, i = !0);
                            !i && 0 < r.childNodes.length && be(r.childNodes[0]).text().replace(/\u200B/g, "") === s().replace(/\u200B/g, "") && ["BR", "IMG", "HR"].indexOf(r.childNodes[0].tagName) < 0 && (r = r.childNodes[0])
                        }
            ...
            isFull: function() {
                ...
                for (e = 0; e < t.length; e++)
                    t[e].nextSibling && (t[e].innerHTML = '<span class="fr-mk">' + be.FE.INVISIBLE_SPACE + "</span>" + t[e].innerHTML);
                var n = !1,
                    r = i(T.el);
            ...
            remove: function() {
                ...
                var n = function(e) {
                        for (var t = e.previousSibling; t && t.nodeType == Node.TEXT_NODE && 0 === t.textContent.length;) {
                            var n = t;
                            t = t.previousSibling, be(n).remove()
                        }
                        return t
                    },
                    r = function(e) {
                ...
                for (t = 0; t < o.length; t++) {
                    for (var s = o[t]; !(r(s) || T.node.isBlock(s.parentNode) || T.$el.is(s.parentNode) || T.node.hasClass(s.parentNode, "fr-inner"));)
                        be(s.parentNode).after(s);
                    s.parentNode && T.node.isBlock(s.parentNode) && T.node.isEmpty(s.parentNode) && !T.$el.is(s.parentNode) && !T.node.hasClass(s.parentNode, "fr-inner") && T.opts.keepFormatOnDelete && be(s.parentNode).after(s)
                }
                if (function() {
                    for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++)
                        if (be(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length)
                            return !1;
                    return !0
                }()) {
                    !function e(t, n) {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            var a = r[i];
                            T.node.hasClass(a, "fr-marker") ? n = (n + 1) % 2 : n ? 0 < be(a).find(".fr-marker").length ? n = e(be(a), n) : ["TD", "TH"].indexOf(a.tagName) < 0 && !T.node.hasClass(a, "fr-inner") ? !T.opts.keepFormatOnDelete || 0 < T.$el.find("[data-first]").length || T.node.isVoid(a) ? be(a).remove() : L(a) : T.node.hasClass(a, "fr-inner") ? 0 === be(a).find(".fr-inner").length ? be(a).html("<br>") : be(a).find(".fr-inner").filter(x).html("<br>") : (be(a).empty(), be(a).attr("data-del-cell", !0)) : 0 < be(a).find(".fr-marker").length && (n = e(be(a), n))
                        }
                        return n
                    }(T.$el, 0);
                    var l = T.$el.find('[data-first="true"]');
                    if (l.length)
                        T.$el.find(".fr-marker").remove(), l.append(be.FE.INVISIBLE_SPACE + be.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html());
                    else
                        for (T.$el.find("table").filter(function() {
                            return 0 < be(this).find("[data-del-cell]").length && be(this).find("[data-del-cell]").length == be(this).find("td, th").length
                        }).remove(), T.$el.find("[data-del-cell]").removeAttr("data-del-cell"), i = T.$el.find('.fr-marker[data-type="true"]'), t = 0; t < i.length; t++) {
                            var d = i[t],
                                c = d.nextSibling,
                                f = T.$el.find('.fr-marker[data-type="false"][data-id="' + be(d).data("id") + '"]').get(0);
                            if (f) {
                                if (d && (!c || c != f)) {
                                    var p = T.node.blockParent(d),
                                        ...
                                        h = !1,
                                        g = !1;
                                    if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (g = !(u = null)), be(d).after(f), p != u)
                                        if (null != p || h)
                                            if (null != u || g || 0 !== be(p).parentsUntil(T.$el, "table").length)
                                                p && u && 0 === be(p).parentsUntil(T.$el, "table").length && 0 === be(u).parentsUntil(T.$el, "table").length && 0 === be(p).find(u).length && 0 === be(u).find(p).length && (be(p).append(be(u).html()), be(u).remove());
                                            else {
                                                ...
                                                c && "BR" == c.tagName && be(c).remove()
                                            }
                                        else {
                                            var v = T.node.deepestParent(d);
                                            v ? (be(v).after(be(u).html()), be(u).remove()) : 0 === be(u).parentsUntil(T.$el, "table").length && (be(d).next().after(be(u).html()), be(u).remove())
                                        }
                                }
                            } else
                                f = be(d).clone().attr("data-type", !1), be(d).after(f)
                        }
                }
            ...
            blocks: function() {
                ...
                for (e = t.length - 1; 0 < e; e--)
                    be(t[e]).find(t).length && t.splice(e, 1);
                return t
            },
            info: i,
            setAtEnd: a,
            ...
            setBefore: function(e, t) {
                ...
                for (var n = e.previousSibling; n && n.nodeType == Node.TEXT_NODE && 0 === n.textContent.length;)
                    n = n.previousSibling;
                return n ? (T.node.isBlock(n) ? a(n) : "BR" == n.tagName ? be(n).before(be.FE.MARKERS) : be(n).after(be.FE.MARKERS), !0) : !!t && (T.node.isBlock(e) ? r(e) : be(e).before(be.FE.MARKERS), !0)
            },
            setAfter: function(e, t) {
                void 0 === t && (t = !0);
                for (var n = e.nextSibling; n && n.nodeType == Node.TEXT_NODE && 0 === n.textContent.length;)
                    n = n.nextSibling;
                return n ? (T.node.isBlock(n) ? r(n) : be(n).before(be.FE.MARKERS), !0) : !!t && (T.node.isBlock(e) ? a(e) : be(e).after(be.FE.MARKERS), !0)
            },
            rangeElement: f
        }
        ...
        I: "EM",
        STRIKE: "S"
    }, be.FE.MODULES.clean = function(c) {
        var f,
            p,
            u,
            h;
        function i(e) {
            ...
            var t,
                ...
                r = [];
            for (t = 0; t < n.length; t++)
                n[t].nodeType != Node.ELEMENT_NODE || c.node.isVoid(n[t]) ? n[t].nodeType == Node.TEXT_NODE && (n[t].textContent = n[t].textContent.replace(/\u200b/g, "")) : n[t].textContent.replace(/\u200b/g, "").length != n[t].textContent.length && i(n[t]);
        ...
        function d(e, t) {
            ...
            if (r) {
                ...
                for (n = 0; n < a.length; n++)
                    t(a[n]);
                for (a = c.node.contents(r), n = 0; n < a.length; n++)
                    i += s(a[n])
            }
            return i
        }
        ...
        function E(e) {
            ...
            !function(e) {
                if ("SPAN" == e.tagName && 0 <= (e.getAttribute("class") || "").indexOf("fr-marker"))
                    return;
                var t,
                    n;
                ...
                if (e.nodeType == Node.ELEMENT_NODE && be.FE.HTML5Map[e.tagName] && "" === c.node.attributes(e)) {
                    var r = be.FE.HTML5Map[e.tagName],
                        i = "<" + r + ">" + e.innerHTML + "</" + r + ">";
                ...
                if (c.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE)
                    ...
                    else if (e.tagName && !e.tagName.match(f))
                        "svg" === e.tagName ? e.parentNode.removeChild(e) : c.browser.safari && "path" == e.tagName && e.parentNode && "svg" == e.parentNode.tagName || (c.browser.safari ? e.replaceWith(e.innerHTML) : e.outerHTML = e.innerHTML);
                    else {
                        var a = e.attributes;
                        if (a)
                    ...
                    0 !== e.data.indexOf("[FROALA.EDITOR") && e.parentNode.removeChild(e)
            }(e)
        }
        return {
            _init: function() {
                c.opts.fullPage && be.merge(c.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
            },
            html: function(e, t, n, r) {
                void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
                var i,
                    a = be.merge([], c.opts.htmlAllowedTags);
                for (i = 0; i < t.length; i++)
                    0 <= a.indexOf(t[i]) && a.splice(a.indexOf(t[i]), 1);
                var o = be.merge([], c.opts.htmlAllowedAttrs);
            ...
            toHTML5: function() {
                var e = c.el.querySelectorAll(Object.keys(be.FE.HTML5Map).join(","));
                if (e.length) {
                    var t = !1;
                    c.el.querySelector(".fr-marker") || (c.selection.save(), t = !0);
                    for (var n = 0; n < e.length; n++)
                        "" === c.node.attributes(e[n]) && be(e[n]).replaceWith("<" + be.FE.HTML5Map[e[n].tagName] + ">" + e[n].innerHTML + "</" + be.FE.HTML5Map[e[n].tagName] + ">");
            ...
            lists: function() {
                !function() {
                    ...
                    do {
                        ...
                        t = [];
                        for (var a = c.el.querySelectorAll("li"), o = 0; o < a.length; o++)
                            e = a[o], c.node.isList(e.parentNode) || t.push(a[o])
                    } while (0 < t.length)
                }(), function() {
                    for (var e = c.el.querySelectorAll("ol + ol, ul + ul"), t = 0; t < e.length; t++) {
                        ...
                        if (c.node.isList(n.previousSibling) && c.node.openTagString(n) == c.node.openTagString(n.previousSibling)) {
                            for (var r = c.node.contents(n), i = 0; i < r.length; i++)
                    ...
                    for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--)
                            "LI" != n[i].tagName ? (r || (r = be("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(), function() {
                    var e,
                        t,
                        n;
                    ...
                    for (var e = c.el.querySelectorAll("ul > ul, ol > ol, ul > ol, ol > ul"), t = 0; t < e.length; t++) {
                        var n = e[t],
                            r = n.previousSibling;
                        r && ("LI" == r.tagName ? r.appendChild(n) : be(n).wrap("<li></li>"))
                    }
                }(), function() {
                    ...
                    for (var e = c.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (c.node.isFirstSibling(n))
                            be(n).before("<br/>");
                        else if (n.previousSibling && "BR" == n.previousSibling.tagName) {
                            for (var r = n.previousSibling.previousSibling; r && c.node.hasClass(r, "fr-marker");)
                                r = r.previousSibling;
                            r && "BR" != r.tagName && be(n.previousSibling).remove()
                        }
                    }
                }(), function() {
                    for (var e = c.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++)
                        be(e[t]).remove()
                }()
            },
    ...
    }, be.FE.MODULES.spaces = function(l) {
        function r(e, t) {
    ...
    }, be.FE.UNICODE_NBSP = String.fromCharCode(160), be.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], be.FE.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], be.extend(be.FE.DEFAULTS, {
    ...
    }), be.FE.MODULES.html = function(x) {
        function c() {
            return x.opts.enter == be.FE.ENTER_P ? "p" : x.opts.enter == be.FE.ENTER_DIV ? "div" : x.opts.enter == be.FE.ENTER_BR ? null : void 0
        }
        function s(e, t) {
        ...
        function a(e) {
            ...
            if (e) {
                ...
                r = x.el.querySelectorAll(p());
            var l = p();
            for (l += "," + be.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + x.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--)
        ...
        function p() {
            return be.FE.BLOCK_TAGS.join(", ")
        }
        function e(e) {
            var t,
                n,
                r = be.merge([], be.FE.VOID_ELEMENTS);
            r = be.merge(r, x.opts.htmlAllowedEmptyTags), r = void 0 === e ? be.merge(r, be.FE.BLOCK_TAGS) : be.merge(r, be.FE.NO_DELETE_TAGS), t = x.el.querySelectorAll("*:empty:not(" + r.join("):not(") + "):not(.fr-marker)");
            do {
                n = !1;
        ...
        function o(e, t) {
            ...
            if (t && (n = "div"), n) {
                for (var r = x.doc.createDocumentFragment(), i = null, a = !1, o = e.firstChild, s = !1; o;) {
                    var l = o.nextSibling;
                    if (o.nodeType == Node.ELEMENT_NODE && (x.node.isBlock(o) || 0 <= x.opts.htmlDoNotWrapTags.indexOf(o.tagName.toLowerCase()) && !x.node.hasClass(o, "fr-marker")))
                        i = null, r.appendChild(o.cloneNode(!0));
                    else if (o.nodeType != Node.ELEMENT_NODE && o.nodeType != Node.TEXT_NODE)
                        i = null, r.appendChild(o.cloneNode(!0));
                    else if ("BR" == o.tagName)
                        null == i ? (i = x.doc.createElement(n), s = !0, t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0)), i.appendChild(o.cloneNode(!0)), r.appendChild(i)) : !1 === a && (i.appendChild(x.doc.createElement("br")), t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0))), i = null;
                    else {
                        var d = o.textContent;
                        o.nodeType !== Node.TEXT_NODE || 0 < d.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || d.replace(/(^ *)|( *$)/g, "").length && d.indexOf("\n") < 0 ? (null == i && (i = x.doc.createElement(n), s = !0, t && i.setAttribute("class", "fr-temp-div"), r.appendChild(i), a = !1), i.appendChild(o.cloneNode(!0)), a || x.node.hasClass(o, "fr-marker") || o.nodeType == Node.TEXT_NODE && 0 === d.replace(/ /g, "").length || (a = !0)) : s = !0
                    }
                    o = l
                }
        ...
        function n(e) {
            if (void 0 === e && (e = x.el), e && 0 <= ["SCRIPT", "STYLE", "PRE"].indexOf(e.tagName))
                return !1;
        ...
        function d(e) {
            ...
            if (t && (x.node.isBlock(t) || x.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                for (var n = e.previousSibling, r = e.nextSibling; n && (n.nodeType == Node.TEXT_NODE && 0 === n.textContent.replace(/\n|\r/g, "").length || x.node.hasClass(n, "fr-tmp"));)
                    n = n.previousSibling;
                if (r)
                    return !1;
                n && t && "BR" != n.tagName && !x.node.isBlock(n) && !r && 0 < t.textContent.replace(/\u200B/g, "").length && 0 < n.textContent.length && !x.node.hasClass(n, "fr-marker") && (x.el == t && !r && x.opts.enter == be.FE.ENTER_BR && x.browser.msie || e.parentNode.removeChild(e))
            } else
                !t || x.node.isBlock(t) || x.node.isElement(t) || e.previousSibling || e.nextSibling || !x.node.isDeletable(e.parentNode) || d(e.parentNode)
        }
        function u() {
        ...
        function E(e) {
            var t = null;
            if (void 0 === e && (t = x.selection.element()), x.opts.keepFormatOnDelete)
                return !1;
            var n,
                r,
                i = t ? (t.textContent.match(/\u200B/g) || []).length - t.querySelectorAll(".fr-marker").length : 0;
            if ((x.el.textContent.match(/\u200B/g) || []).length - x.el.querySelectorAll(".fr-marker").length == i)
                return !1;
            do {
                ...
                for (var a = 0; a < n.length; a++) {
                    ...
                    if (t != o) {
                        var s = o.textContent;
                        0 === o.children.length && 1 === s.length && 8203 == s.charCodeAt(0) && "TD" !== o.tagName && (be(o).remove(), r = !0)
                    }
                }
            } while (r)
        }
        return {
            ...
            emptyBlockTagsQuery: function() {
                return be.FE.BLOCK_TAGS.join(":empty, ") + ":empty"
            },
            blockTagsQuery: p,
            fillEmptyBlocks: function(e) {
                var t = a(e);
                x.node.isEmpty(x.el) && x.opts.enter === be.FE.ENTER_BR && t.push(x.el);
                ...
                if (x.browser.msie && x.opts.enter == be.FE.ENTER_BR) {
            ...
            set: function(e) {
                var t,
                    n,
                    r,
                    i = x.clean.html((e || "").trim(), [], [], x.opts.fullPage);
                if (x.opts.fullPage) {
                    var a = h(i, "body") || (0 <= i.indexOf("<body") ? "" : i),
                        o = g(i, "body"),
                        s = h(i, "head") || "<title></title>",
                        l = g(i, "head"),
                        d = be("<div>").append(s).contents().each(function() {
                    ...
                    s = be("<div>").append(s).contents().map(function() {
            ...
            get: function(e, t) {
                if (!x.$wp)
                    return x.$oel.clone().removeClass("fr-view").removeAttr("contenteditable").get(0).outerHTML;
                var n = "";
                            ...
                            for (var p = 0, u = c.length; p < u; p++)
                                if (c[p].selectorText && 0 < c[p].style.cssText.length) {
                                    ...
                                    for (i = 0; i < h.length; i++) {
                                        ...
                                        for (var m = 1e3 * f + N(c[p].selectorText), v = c[p].style.cssText.split(";"), E = 0; E < v.length; E++) {
                ...
                if (x.node.isEmpty(x.el))
                    x.opts.fullPage && (n = w(x.iframe_document), n += "<html" + x.node.attributes(x.$html.get(0)) + ">" + x.$html.find("head").get(0).outerHTML + "<body></body></html>");
                else if (void 0 === e && (e = !1), x.opts.fullPage) {
                    n = w(x.iframe_document), x.$el.removeClass("fr-view");
            ...
            getSelected: function() {
                var e,
                    t,
                    n = function(e, t) {
                        for (; t && (t.nodeType == Node.TEXT_NODE || !x.node.isBlock(t)) && !x.node.isElement(t) && !x.node.hasClass(t, "fr-inner");)
                            t && t.nodeType != Node.TEXT_NODE && be(e).wrapInner(x.node.openTagString(t) + x.node.closeTagString(t)), t = t.parentNode;
                ...
                if ("undefined" != typeof x.win.getSelection) {
                    ...
                    "undefined" != typeof x.doc.selection && "Text" == x.doc.selection.type && (r = x.doc.selection.createRange().htmlText);
                return r
            },
            insert: function(e, t, n) {
                var r,
                    i,
                    a;
                if (x.selection.isCollapsed() || x.selection.remove(), r = t ? e : x.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = x.doc.createElement("div")).innerHTML = i, x.selection.setAtEnd(a), r = a.innerHTML), x.node.isEmpty(x.el) && !x.opts.keepFormatOnDelete && f(r))
                    x.el.innerHTML = r;
                else {
                    var o = x.markers.insert();
                    if (o) {
                        x.node.isLastSibling(o) && be(o).parent().hasClass("fr-deletable") && be(o).insertAfter(be(o).parent());
                        var s = x.node.blockParent(o);
                        if ((f(r) || n) && (x.node.deepestParent(o) || s && "LI" == s.tagName)) {
                            if (s && "LI" == s.tagName && (r = function(e) {
                                if (!x.html.defaultTag())
                                    return e;
                                var t = x.doc.createElement("div");
                                t.innerHTML = e;
                                for (var n = t.querySelectorAll(":scope > " + x.html.defaultTag()), r = n.length - 1; 0 <= r; r--) {
                                    var i = n[r];
                                    x.node.isBlock(i.previousSibling) || (i.previousSibling && !x.node.isEmpty(i) && be("<br>").insertAfter(i.previousSibling), i.outerHTML = i.innerHTML)
                                }
                                return t.innerHTML
                            }(r)), !(o = x.markers.split()))
                                return !1;
                        ...
                        x.el.innerHTML = x.el.innerHTML + r
                }
            ...
            unwrap: function() {
                x.$el.find("div.fr-temp-div").each(function() {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && be(this).before("<br>"), be(this).attr("data-empty") || !this.nextSibling || x.node.isBlock(this.nextSibling) && !be(this.nextSibling).hasClass("fr-temp-div") ? be(this).replaceWith(be(this).html()) : be(this).replaceWith(be(this).html() + "<br>")
                }), x.$el.find(".fr-temp-div").removeClass("fr-temp-div").filter(function() {
                    return "" === be(this).attr("class")
                }).removeAttr("class")
            },
            ...
            extractDoctype: m,
            cleanBRs: function() {
                for (var e = x.el.getElementsByTagName("br"), t = 0; t < e.length; t++)
                    d(e[t])
            },
            _init: function() {
                if (x.$wp) {
        ...
        language: null
    }), be.FE.LANGUAGE = {}, be.FE.MODULES.language = function(e) {
        var t;
        return {
            _init: function() {
                be.FE.LANGUAGE && (t = be.FE.LANGUAGE[e.opts.language]), t && t.direction && (e.opts.direction = t.direction)
            },
    ...
    }), be.FE.MODULES.placeholder = function(c) {
        function e() {
            c.$placeholder || (c.$placeholder = be('<span class="fr-placeholder"></span>'), c.$wp.append(c.$placeholder));
            var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0),
                ...
                l = be(c.selection.element()).css("text-align");
            if (s.length && s[0].nodeType == Node.ELEMENT_NODE) {
                ...
                c.$placeholder.css("font-size", c.$el.css("font-size")), c.$placeholder.css("line-height", c.$el.css("line-height"));
        ...
        return {
            _init: function() {
                if (be.FE.INSTANCES.push(a), a.drag_support = {
            ...
            injectStyle: function(e) {
                if (a.opts.iframe) {
                    ...
                    for (var t = 0; t < a.opts.iframeStyleFiles.length; t++) {
                        var n = be('<link data-fr-style="true" rel="stylesheet" href="' + a.opts.iframeStyleFiles[t] + '">');
    ...
    }, be.FE.MODULES.cursorLists = function(g) {
        function m(e) {
        ...
        return {
            _startEnter: function(e) {
                ...
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + be.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + be.FE.MARKERS + "<br></" + a + ">" + o : s + be.FE.MARKERS + "<br>" + o; ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;)
                        l = l.parentNode;
                    be(n).replaceWith('<span id="fr-break"></span>');
                    var c = g.node.openTagString(l) + be(l).html() + g.node.closeTagString(l);
                    c = c.replace(/<span id="fr-break"><\/span>/g, d), be(l).replaceWith(c), g.$el.find("li:empty").remove()
                    ...
                    be(n).before("<li>" + f + "</li>"), be(e).remove()
                } else if (i) {
                    t = v(n);
                    for (var u = be.FE.MARKERS + "<br>", h = e.parentNode; h && "LI" != h.tagName;)
                        u = g.node.openTagString(h) + u + g.node.closeTagString(h), h = h.parentNode;
                    t.parentNode && "LI" == t.parentNode.tagName ? be(t.parentNode).after("<li>" + u + "</li>") : a ? be(t).after("<" + a + ">" + u + "</" + a + ">") : be(t).after(u), be(n).remove()
                } else
                    (t = v(n)).parentNode && "LI" == t.parentNode.tagName ? r ? be(t.parentNode).before(g.node.openTagString(n) + be.FE.MARKERS + "<br></li>") : be(t.parentNode).after(g.node.openTagString(n) + be.FE.MARKERS + "<br></li>") : a ? be(t).before("<" + a + ">" + be.FE.MARKERS + "<br></" + a + ">") : be(t).before(be.FE.MARKERS + "<br>"), be(n).remove()
            },
            _middleEnter: function(e) {
                for (var t = m(e), n = "", r = e, i = "", a = ""; r != t;) {
                    var o = "A" == (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                    i = g.node.openTagString(be(r).clone().addClass(o).get(0)) + i, a = g.node.closeTagString(r) + a
                }
                n = a + n + i + be.FE.MARKERS + (g.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : ""), be(e).replaceWith('<span id="fr-break"></span>');
                var s = g.node.openTagString(t) + be(t).html() + g.node.closeTagString(t);
                s = s.replace(/<span id="fr-break"><\/span>/g, n), be(t).replaceWith(s)
            },
            _endEnter: function(e) {
                for (var t = m(e), n = be.FE.MARKERS, r = "", i = e, a = !1; i != t;) {
                    var o = "A" == (i = i.parentNode).tagName && g.cursor.isAtEnd(e, i) ? "fr-to-remove" : "";
                    a || i == t || g.node.isBlock(i) || (a = !0, r += be.FE.INVISIBLE_SPACE), r = g.node.openTagString(be(i).clone().addClass(o).get(0)) + r, n += g.node.closeTagString(i)
                }
                var s = r + n;
                be(e).remove(), be(t).after(s)
            },
            _backspace: function(e) {
                var t = m(e),
                    n = t.previousSibling;
                if (n) {
                    n = be(n).find(g.html.blockTagsQuery()).get(-1) || n, be(e).replaceWith(be.FE.MARKERS);
                    var r = g.node.contents(n);
                    r.length && "BR" == r[r.length - 1].tagName && be(r[r.length - 1]).remove(), be(t).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                        this.parentNode == t && be(this).replaceWith(be(this).html() + (g.node.isEmpty(this) ? "" : "<br>"))
                    });
                    for (var i, a = g.node.contents(t)[0]; a && !g.node.isList(a);)
                        i = a.nextSibling, be(n).append(a), a = i;
                    for (n = t.previousSibling; a;)
                        i = a.nextSibling, be(n).append(a), a = i;
                    1 < (r = g.node.contents(n)).length && "BR" === r[r.length - 1].tagName && be(r[r.length - 1]).remove(), be(t).remove()
                } else {
                    var o = v(t);
                    if (be(e).replaceWith(be.FE.MARKERS), o.parentNode && "LI" == o.parentNode.tagName) {
                        var s = o.previousSibling;
                        g.node.isBlock(s) ? (be(t).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                            this.parentNode == t && be(this).replaceWith(be(this).html() + (g.node.isEmpty(this) ? "" : "<br>"))
                        }), be(s).append(be(t).html())) : be(o).before(be(t).html())
                    } else {
                        var l = g.html.defaultTag();
                        l && 0 === be(t).find(g.html.blockTagsQuery()).length ? be(o).before("<" + l + ">" + be(t).html() + "</" + l + ">") : be(o).before(be(t).html())
                    }
                    be(t).remove(), g.html.wrap(), 0 === be(o).find("li").length && be(o).remove()
                }
            },
            _del: function(e) {
                var t,
                    ...
                    r = n.nextSibling;
                if (r) {
                    (t = g.node.contents(r)).length && "BR" == t[0].tagName && be(t[0]).remove(), be(r).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                        this.parentNode == r && be(this).replaceWith(be(this).html() + (g.node.isEmpty(this) ? "" : "<br>"))
                    });
                    for (var i, a = e, o = g.node.contents(r)[0]; o && !g.node.isList(o);)
                        i = o.nextSibling, be(a).after(o), a = o, o = i;
                    for (; o;)
                        i = o.nextSibling, be(n).append(o), o = i;
                    be(e).replaceWith(be.FE.MARKERS), be(r).remove()
                } else {
                    ...
                    if (s = s.nextSibling, g.node.isBlock(s))
                        be.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (be(e).replaceWith(be.FE.MARKERS), (t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(n).append(be(s).html()), be(s).remove());
                    else
                        for ((t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(e).replaceWith(be.FE.MARKERS); s && !g.node.isBlock(s) && "BR" != s.tagName;)
                            be(n).append(be(s)), s = s.nextSibling
                }
            }
        }
    }, be.FE.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], be.FE.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], be.FE.MODULES.cursor = function(u) {
        function a(e) {
        ...
        function s(e) {
            return 0 < be(e).parentsUntil(u.$el, "LI").length && 0 === be(e).parentsUntil("LI", "TABLE").length
        }
        function d(e, t) {
        ...
        function c(e) {
            for (var t, n = e; !n.previousSibling;)
                if (n = n.parentNode, u.node.isElement(n))
                    return !1;
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    var r = n.textContent,
                        i = r.length;
                    if (r.length && "\n" === r[r.length - 1])
                        return n.textContent = r.substring(0, i - 2), 0 === n.textContent.length && n.parentNode.removeChild(n), c(e);
                    if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
                        0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(be.FE.UNICODE_NBSP, "g"), "").length && (i = r.length - u.opts.tabSpaces + 1);
                    n.textContent = r.substring(0, i - d(r));
                    var a = r.length != n.textContent.length;
                    if (0 === n.textContent.length)
                        if (a && u.opts.keepFormatOnDelete)
                            be(n).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS);
                            ...
                            be(n).after(be.FE.MARKERS), u.node.isElement(n.parentNode) && !e.nextSibling && n.previousSibling && "BR" == n.previousSibling.tagName && be(e).after("<br>"), n.parentNode.removeChild(n)
                        } else
                            be(n.parentNode).after(be.FE.MARKERS), be(n.parentNode).remove();
                    else
                        be(n).after(be.FE.MARKERS)
                } else
                    u.node.isDeletable(n) ? (be(n).after(be.FE.MARKERS), be(n).remove()) : e.nextSibling && "BR" == e.nextSibling.tagName && u.node.isVoid(n) && "BR" != n.tagName ? (be(e.nextSibling).remove(), be(e).replaceWith(be.FE.MARKERS)) : !1 !== u.events.trigger("node.remove", [be(n)]) && (be(n).after(be.FE.MARKERS), be(n).remove())
            } else if (be.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n))
                    be(e).replaceWith(be.FE.MARKERS), be(n).remove();
                else if (u.node.isEmpty(n) && !u.node.isList(n))
                    be(n).remove(), be(e).replaceWith(be.FE.MARKERS);
                else {
                    for (u.node.isList(n) && (n = be(n).find("li:last").get(0)), (t = u.node.contents(n)) && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), t = u.node.contents(n); t && u.node.isBlock(t[t.length - 1]);)
                        n = t[t.length - 1], t = u.node.contents(n);
                    be(n).append(be.FE.MARKERS);
                    for (var s = e; !s.previousSibling;)
                        s = s.parentNode;
                    for (; s && "BR" !== s.tagName && !u.node.isBlock(s);) {
                        var l = s;
                        s = s.nextSibling, be(n).append(l)
                    }
                    s && "BR" == s.tagName && be(s).remove(), be(e).remove()
                }
            else
                e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove()
        }
        function l(e) {
            var t = 0 < be(e).parentsUntil(u.$el, "BLOCKQUOTE").length,
                n = u.node.deepestParent(e, [], !t);
            if (n && "BLOCKQUOTE" == n.tagName) {
                var r = u.node.deepestParent(e, [be(e).parentsUntil(u.$el, "BLOCKQUOTE").get(0)]);
                r && r.nextSibling && (n = r)
            }
            if (null !== n) {
                var i,
                    a = n.nextSibling;
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && be.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0)
                    if (u.node.isDeletable(a))
                        be(a).remove(), be(e).replaceWith(be.FE.MARKERS);
                    else if (u.node.isBlock(a) && u.node.isEditable(a))
                        if (u.node.isList(a))
                            if (u.node.isEmpty(n, !0))
                                be(n).remove(), be(a).find("li:first").prepend(be.FE.MARKERS);
                            else {
                                var o = be(a).find("li:first");
                                "BLOCKQUOTE" == n.tagName && (i = u.node.contents(n)).length && u.node.isBlock(i[i.length - 1]) && (n = i[i.length - 1]), 0 === o.find("ul, ol").length && (be(e).replaceWith(be.FE.MARKERS), o.find(u.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                                    this.parentNode == o.get(0) && be(this).replaceWith(be(this).html() + (u.node.isEmpty(this) ? "" : "<br>"))
                                }), be(n).append(u.node.contents(o.get(0))), o.remove(), 0 === be(a).find("li").length && be(a).remove())
                            }
                        else {
                            if ((i = u.node.contents(a)).length && "BR" == i[0].tagName && be(i[0]).remove(), "BLOCKQUOTE" != a.tagName && "BLOCKQUOTE" == n.tagName)
                                for (i = u.node.contents(n); i.length && u.node.isBlock(i[i.length - 1]);)
                                    n = i[i.length - 1], i = u.node.contents(n);
                            else if ("BLOCKQUOTE" == a.tagName && "BLOCKQUOTE" != n.tagName)
                                for (i = u.node.contents(a); i.length && u.node.isBlock(i[0]);)
                                    a = i[0], i = u.node.contents(a);
                            be(e).replaceWith(be.FE.MARKERS), be(n).append(a.innerHTML), be(a).remove()
                        }
                    else {
                        for (be(e).replaceWith(be.FE.MARKERS); a && "BR" !== a.tagName && !u.node.isBlock(a) && u.node.isEditable(a);) {
                            var s = a;
                            a = a.nextSibling, be(n).append(s)
                        }
                        a && "BR" == a.tagName && u.node.isEditable(a) && be(a).remove()
                    }
            }
        }
        function n(e) {
            ...
            if ("BR" == (n = n.nextSibling).tagName && u.node.isEditable(n))
                if (n.nextSibling) {
                    if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
                        if (!(be.FE.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                            return void be(n).remove();
                        n = n.nextSibling, be(n.previousSibling).remove()
                    }
                } else if (a(n)) {
                    if (s(e))
                        u.cursorLists._del(e);
                    else
                        u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && be.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && be(n).remove(), l(e));
                    return
                }
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                n.nodeType == Node.TEXT_NODE ? (be(n).before(be.FE.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (be(n).before(be.FE.MARKERS), be(n).remove()) : !1 !== u.events.trigger("node.remove", [be(n)]) && (be(n).before(be.FE.MARKERS), be(n).remove()), be(e).remove()
            } else if (be.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n))
                    be(e).replaceWith(be.FE.MARKERS), be(n).remove();
                else if (u.node.isList(n))
                    e.previousSibling ? (be(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (be(n).find("li:first").prepend(be.FE.MARKERS), be(e).remove());
                else if ((t = u.node.contents(n)) && "BR" == t[0].tagName && be(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
                    var r = t[0];
                    for (be(e).before(be.FE.MARKERS); r && "BR" != r.tagName;) {
                        var i = r;
                        r = r.nextSibling, be(e).before(i)
                    }
                    r && "BR" == r.tagName && be(r).remove()
                } else
                    be(e).after(be(n).html()).after(be.FE.MARKERS), be(n).remove()
        }
        function f() {
        ...
        function p(e, t, n) {
            ...
            if (i && "BLOCKQUOTE" == i.tagName)
                return g(e, i) ? (r = u.html.defaultTag(), t ? be(e).replaceWith("<br>" + be.FE.MARKERS) : r ? be(i).after("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : be(i).after(be.FE.MARKERS + "<br>"), be(e).remove()) : m(e, t, n), !1;
            if (null == i)
                (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? be(e).replaceWith("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || be(e.previousSibling).is("br") || e.nextSibling ? be(e).replaceWith("<br>" + be.FE.MARKERS) : be(e).replaceWith("<br>" + be.FE.MARKERS + "<br>");
            else {
                var a = e,
                    o = "";
        ...
        function m(e, t, n) {
            ...
            if (null == r)
                ...
                do {
                    var l = i;
                    if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < be(l).find(e).length && be(l).after(e), "BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i))
                        if (!t || i != r || t && !u.node.isBlock(r)) {
                            o += u.node.closeTagString(i);
                            var d = "A" == i.tagName && g(e, i) ? "fr-to-remove" : "";
                            s = u.node.openTagString(be(i).clone().addClass(d).removeAttr("id").get(0)) + s
                        } else
                            "BLOCKQUOTE" == r.tagName && t && (s = o = "")
                } while (i != r);
                var c = r == e.parentNode && u.node.isBlock(r) || e.nextSibling;
                if ("BLOCKQUOTE" == r.tagName)
                    if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (be(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove()), t)
                        a = o + a + be.FE.MARKERS + s;
                    else {
                        var f = u.html.defaultTag();
                        a = o + a + (f ? "<" + f + ">" : "") + be.FE.MARKERS + "<br>" + (f ? "</" + f + ">" : "") + s
                    }
                else
                    a = o + a + s + (c ? "" : be.FE.INVISIBLE_SPACE) + be.FE.MARKERS;
                be(e).replaceWith('<span id="fr-break"></span>');
                var p = u.node.openTagString(r) + be(r).html() + u.node.closeTagString(r);
                p = p.replace(/<span id="fr-break"><\/span>/g, a), be(r).replaceWith(p)
            }
        }
        return {
            enter: function(t) {
                ...
                u.el.normalize();
                var r = !1;
                0 < be(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), be(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
                    var i,
                        a = u.node.deepestParent(t, [], !r);
                    if (a && "TABLE" == a.tagName)
                        return be(a).find("td:first, th:first").prepend(t), e(t, n, r);
                    if (a && "BLOCKQUOTE" == a.tagName)
                        if (h(t, a)) {
                            if (!n)
                                return (i = u.html.defaultTag()) ? be(a).before("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(a).before(be.FE.MARKERS + "<br>"), be(t).remove(), !1
                        } else
                            g(t, a) ? p(t, n, !0) : m(t, n, !0);
                    if (null == a)
                        (i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? be(t).replaceWith("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(t).replaceWith("<br>" + be.FE.MARKERS);
                    else {
                        if (u.node.isBlock(a))
                            if ("PRE" == a.tagName && (n = !0), n)
                                be(t).remove(), be(a).prepend("<br>" + be.FE.MARKERS);
                            else {
                                if (u.node.isEmpty(a, !0))
                                    return p(t, n, r);
                                if (u.opts.keepFormatOnDelete) {
                                    for (var o = t, s = be.FE.INVISIBLE_SPACE; o != a && !u.node.isElement(o);)
                                        o = o.parentNode, s = u.node.openTagString(o) + s + u.node.closeTagString(o);
                                    be(a).before(s)
                                } else
                                    be(a).before(u.node.openTagString(be(a).clone().removeAttr("id").get(0)) + "<br>" + u.node.closeTagString(a))
                            }
                        else
                            be(a).before("<br>");
                        be(t).remove()
                    ...
                    be(this).replaceWith(this.innerHTML)
            ...
            backspace: function() {
                ...
                for (var n = t.parentNode; n && !u.node.isElement(n);) {
                    if ("false" === n.getAttribute("contenteditable"))
                        return be(t).replaceWith(be.FE.MARKERS), u.selection.restore(), !1;
                ...
                if (r) {
                    var i = r.textContent;
                    i && i.length && 8203 == i.charCodeAt(i.length - 1) && (1 == i.length ? be(r).remove() : r.textContent = r.textContent.substr(0, i.length - d(i)))
                }
                return a(t) ? e = c(t) : o(t) ? s(t) && h(t, be(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function(e) {
                    for (var t = 0 < be(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" != n.tagName && n.parentElement != u.el && !u.node.hasClass(n.parentElement, "fr-inner") && be.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;)
                        n = n.parentElement;
                    if (n && "BLOCKQUOTE" == n.tagName) {
                        var i = u.node.deepestParent(e, [be(e).parentsUntil(u.$el, "BLOCKQUOTE").get(0)]);
                        i && i.previousSibling && (r = n = i)
                    }
                    if (null !== n) {
                        var a,
                            o = n.previousSibling;
                        if (u.node.isBlock(n) && u.node.isEditable(n) && o && be.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0)
                            if (u.node.isDeletable(o))
                                be(o).remove(), be(e).replaceWith(be.FE.MARKERS);
                            else if (u.node.isEditable(o))
                                if (u.node.isBlock(o))
                                    if (u.node.isEmpty(o) && !u.node.isList(o))
                                        be(o).remove(), be(e).after(u.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : "");
                                    else {
                                        if (u.node.isList(o) && (o = be(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && be(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName)
                                            for (a = u.node.contents(o); a.length && u.node.isBlock(a[a.length - 1]);)
                                                o = a[a.length - 1], a = u.node.contents(o);
                                        else if ("BLOCKQUOTE" != o.tagName && "BLOCKQUOTE" == r.tagName)
                                            for (a = u.node.contents(r); a.length && u.node.isBlock(a[0]);)
                                                r = a[0], a = u.node.contents(r);
                                        if (u.node.isEmpty(n))
                                            be(e).remove(), u.selection.setAtEnd(o, !0);
                                        else {
                                            be(e).replaceWith(be.FE.MARKERS);
                                            var s = o.childNodes;
                                            u.node.isBlock(s[s.length - 1]) ? be(s[s.length - 1]).append(r.innerHTML) : be(o).append(r.innerHTML)
                                        }
                                        be(r).remove(), u.node.isEmpty(n) && be(n).remove()
                                    }
                                else
                                    be(e).replaceWith(be.FE.MARKERS), "BLOCKQUOTE" == n.tagName && o.nodeType == Node.ELEMENT_NODE ? be(o).remove() : (be(o).after(u.node.isEmpty(n) ? "" : be(n).html()), be(n).remove(), "BR" == o.tagName && be(o).remove())
                    }
                }(t) : e = c(t), be(t).remove(), f(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()), u.selection.restore(), e
            },
            del: function() {
                ...
                if (u.el.normalize(), a(e))
                    if (s(e))
                        if (0 === be(e).parents("li:first").find("ul, ol").length)
                            u.cursorLists._del(e);
                        else {
                            var t = be(e).parents("li:first").find("ul:first, ol:first").find("li:first");
                    ...
                    o(e), n(e);
                be(e).remove(), f(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists()), u.spaces.normalizeAroundCursor(), u.selection.restore()
            },
            isAtEnd: g,
            isAtStart: h
        }
    }, be.FE.ENTER_P = 0, be.FE.ENTER_DIV = 1, be.FE.ENTER_BR = 2, be.FE.KEYCODE = {
        BACKSPACE: 8,
        TAB: 9,
        ENTER: 13,
        SHIFT: 16,
        ...
        function t() {
            l.selection.isFull() && setTimeout(function() {
                ...
                e ? l.$el.html("<" + e + ">" + be.FE.MARKERS + "<br/></" + e + ">") : l.$el.html(be.FE.MARKERS + "<br/>"), l.selection.restore(), l.placeholder.refresh(), l.button.bulkRefresh(), l.undo.saveStep()
            }, 0)
        }
        function i() {
            c = !1
        ...
        function f() {
            var e = l.html.defaultTag();
            e ? l.$el.html("<" + e + ">" + be.FE.MARKERS + "<br/></" + e + ">") : l.$el.html(be.FE.MARKERS + "<br/>"), l.selection.restore()
        }
        function o(e) {
            ...
            var r,
                ...
                a,
                o = m(n) && !h(e) && !e.altKey,
                s = n == be.FE.KEYCODE.BACKSPACE || n == be.FE.KEYCODE.DELETE;
            if ((!(e.shiftKey && (33 === n || 34 === n || 35 === n || 36 === n)) && l.selection.isFull() && !l.opts.keepFormatOnDelete && !l.placeholder.isVisible() || s && l.placeholder.isVisible() && l.opts.keepFormatOnDelete) && (o || s) && (f(), !m(n)))
                return e.preventDefault(), !0;
            n == be.FE.KEYCODE.ENTER ? e.shiftKey ? ((a = e).preventDefault(), a.stopPropagation(), l.opts.multiLine && (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0))) : (i = e, l.opts.multiLine ? (l.helpers.isIOS() || (i.preventDefault(), i.stopPropagation()), l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter()) : (i.preventDefault(), i.stopPropagation())) : n === be.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? setTimeout(function() {
                l.events.disableBlur(), l.events.focus()
            }, 0) : n != be.FE.KEYCODE.BACKSPACE || h(e) || e.altKey ? n != be.FE.KEYCODE.DELETE || h(e) || e.altKey || e.shiftKey ? n == be.FE.KEYCODE.SPACE ? function(e) {
                var t = l.selection.element();
                if (!l.helpers.isMobile() && t && "A" == t.tagName) {
                    ...
                    if (n) {
                        ...
                        !n.nextSibling && n.parentNode && "A" == n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + be.FE.MARKERS), n.parentNode.removeChild(n)) : (r && r.nodeType == Node.TEXT_NODE && 1 == r.textContent.length && 160 == r.textContent.charCodeAt(0) ? r.textContent = r.textContent + " " : n.insertAdjacentHTML("beforebegin", "&nbsp;"), n.outerHTML = be.FE.MARKERS), l.selection.restore()
                    }
                }
            }(e) : n == be.FE.KEYCODE.TAB ? function(e) {
                if (0 < l.opts.tabSpaces)
                    if (l.selection.isCollapsed()) {
                        ...
                        e.preventDefault(), e.stopPropagation(), e.shiftKey ? l.commands.outdent() : l.commands.indent()
                ...
                if (l.selection.isCollapsed())
                    ...
                    e.preventDefault(), e.stopPropagation(), l.selection.remove();
        ...
        function u(e) {
            ...
            if (c)
                return !1;
            if (e && l.helpers.isIOS() && e.which == be.FE.KEYCODE.ENTER && l.doc.execCommand("undo"), !l.selection.isCollapsed())
                return !0;
            if (e && (e.which === be.FE.KEYCODE.META || e.which == be.FE.KEYCODE.CTRL))
                return !0;
            if (e && g(e.which))
                return !0;
            if (e && !l.helpers.isIOS() && (e.which == be.FE.KEYCODE.ENTER || e.which == be.FE.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !l.browser.msie))
                try {
                    s()
                } catch (n) {}
            p()
        ...
        function g(e) {
            if (e >= be.FE.KEYCODE.ARROW_LEFT && e <= be.FE.KEYCODE.ARROW_DOWN)
                return !0
        }
        function m(e) {
            if (e >= be.FE.KEYCODE.ZERO && e <= be.FE.KEYCODE.NINE)
                return !0;
            if (e >= be.FE.KEYCODE.NUM_ZERO && e <= be.FE.KEYCODE.NUM_MULTIPLY)
                return !0;
            if (e >= be.FE.KEYCODE.A && e <= be.FE.KEYCODE.Z)
                return !0;
            if (l.browser.webkit && 0 === e)
                return !0;
            switch (e) {
            case be.FE.KEYCODE.SPACE:
            case be.FE.KEYCODE.QUESTION_MARK:
            case be.FE.KEYCODE.NUM_PLUS:
            case be.FE.KEYCODE.NUM_MINUS:
            case be.FE.KEYCODE.NUM_PERIOD:
            case be.FE.KEYCODE.NUM_DIVISION:
            case be.FE.KEYCODE.SEMICOLON:
            case be.FE.KEYCODE.FF_SEMICOLON:
            case be.FE.KEYCODE.DASH:
            case be.FE.KEYCODE.EQUALS:
            case be.FE.KEYCODE.FF_EQUALS:
            case be.FE.KEYCODE.COMMA:
            case be.FE.KEYCODE.PERIOD:
            case be.FE.KEYCODE.SLASH:
            case be.FE.KEYCODE.APOSTROPHE:
            case be.FE.KEYCODE.SINGLE_QUOTE:
            case be.FE.KEYCODE.OPEN_SQUARE_BRACKET:
            case be.FE.KEYCODE.BACKSLASH:
            case be.FE.KEYCODE.CLOSE_SQUARE_BRACKET:
                return !0;
            default:
                return !1
            }
        ...
        function v(e) {
            var t = e.which;
            if (h(e) || 37 <= t && t <= 40 || !m(t) && t != be.FE.KEYCODE.DELETE && t != be.FE.KEYCODE.BACKSPACE && t != be.FE.KEYCODE.ENTER && t != be.FE.KEYCODE.IME)
                return !0;
        ...
        function T(e) {
            var t = l.el.childNodes,
                n = l.html.defaultTag();
            return !(!e.target || e.target === l.el) || (0 === t.length || void (l.$el.outerHeight() - e.offsetY <= 10 ? b(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.append(be.FE.MARKERS + "<br>"), l.selection.restore(), s()) : e.offsetY <= 10 && b(t[0]) && (n ? l.$el.prepend("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(be.FE.MARKERS + "<br>"), l.selection.restore(), s())))
        }
        function A() {
            n && clearTimeout(n)
        }
        return {
            _init: function() {
                l.events.on("keydown", v), l.events.on("input", e), l.events.on("mousedown", a), l.events.on("keyup input", E), l.events.on("keypress", i), l.events.on("keydown", o), l.events.on("keyup", u), l.events.on("destroy", A), l.events.on("html.inserted", u), l.events.on("cut", t), l.events.on("click", T)
            },
            ctrlKey: h,
            isCharacter: m,
            isArrow: g,
            ...
            isBrowserAction: function(e) {
                var t = e.which;
                return h(e) || t == be.FE.KEYCODE.F5
            },
            positionCaret: s
        }
    }, be.FE.MODULES.accessibility = function(f) {
        var a = !0;
        function s(t) {
                ...
                if (0 === a && !n || a == i.length - 1 && n) {
                    ...
                    if (t) {
                        if (e.parent().is(".fr-popup"))
                            o = !u(e.parent().children().not(".fr-buttons"), !n);
        ...
        function g(e) {
            if (f.shared.$f_el) {
                ...
                if (f.shared.$f_el.is(".fr-dropdown.fr-active"))
                    return s(t = e ? f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").last()), !1;
                if (f.shared.$f_el.is("a.fr-command"))
                    return (t = e ? f.shared.$f_el.closest("li").nextAll(":visible:first").find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.closest("li").prevAll(":visible:first").find(".fr-command:not(.fr-disabled)").first()).length || (t = e ? f.shared.$f_el.closest(".fr-dropdown-menu").find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.closest(".fr-dropdown-menu").find(".fr-command:not(.fr-disabled)").last()), s(t), !1
            }
        }
        function m() {
            if (f.shared.$f_el) {
        ...
        function r(r) {
            r && r.length && (f.events.$on(r, "keydown", function(e) {
                if (!be(e.target).is("a.fr-command, button.fr-command, .fr-group span.fr-command"))
                    return !0;
        ...
        function e(e) {
            ...
            if (e.which == be.FE.KEYCODE.F10 && !t && !e.shiftKey && e.altKey) {
                f.shared.with_kb = !0;
        ...
        return {
                    ...
                    n = (d = e, c = f.popups.get(d), {
                        _tiKeydown: function(e) {
                            ...
                            if (be.FE.KEYCODE.TAB == n) {
                                ...
                                if (0 <= o && o < a.length)
                                    return t.events.disableBlur(), be(a[o]).focus(), e.stopPropagation(), !1;
                                var s = c.find(".fr-buttons");
                                if (s.length && p(s, !!e.shiftKey))
                                    return e.stopPropagation(), !1;
                                if (u(i))
                                    return e.stopPropagation(), !1
                            } else {
                                if (be.FE.KEYCODE.ENTER != n || !e.target || "TEXTAREA" === e.target.tagName)
                                    return be.FE.KEYCODE.ESC == n ? (e.preventDefault(), e.stopPropagation(), t.accessibility.restoreSelection(), t.popups.isVisible(d) && c.find(".fr-back:visible").length ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()), t.button.exec(c.find(".fr-back:visible:first")), E(c)) : t.popups.isVisible(d) && c.find(".fr-dismiss:visible").length ? t.button.exec(c.find(".fr-dismiss:visible:first")) : (t.popups.hide(d), t.opts.toolbarInline && t.toolbar.showInline(null, !0), E(c)), !1) : be.FE.KEYCODE.SPACE == n && (r.is(".fr-submit") || r.is(".fr-dismiss")) ? (e.preventDefault(), e.stopPropagation(), t.events.disableBlur(), t.button.exec(r), !0) : t.keys.isBrowserAction(e) ? void e.stopPropagation() : r.is("input[type=text], textarea") ? void e.stopPropagation() : be.FE.KEYCODE.SPACE == n && (r.is(".fr-link-attr") || r.is("input[type=file]")) ? void e.stopPropagation() : (e.stopPropagation(), e.preventDefault(), !1);
                                var l = null;
            ...
            exec: function(e, t) {
                var n = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                    r = e.which,
                    i = !1;
                return r != be.FE.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ENTER && r != be.FE.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r != be.FE.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (i = l()) : i = function(e) {
                    if (f.shared.$f_el) {
                        var t = d();
    ...
    }, be.FE.MODULES.format = function(g) {
        function l(e, t) {
            var n = "<" + e;
            for (var r in t)
        ...
        function m(e, t, n) {
            if (e) {
                for (; e.nodeType === Node.COMMENT_NODE;)
                    e = e.nextSibling;
                if (e) {
                    if (g.node.isBlock(e) && "HR" !== e.tagName)
                        return m(e.firstChild, t, n), !1;
                    for (var r = be(l(t, n)).insertBefore(e), i = e; i && !be(i).is(".fr-marker") && 0 === be(i).find(".fr-marker").length && "UL" != i.tagName && "OL" != i.tagName;) {
                        var a = i;
                        if (g.node.isBlock(i) && "HR" !== e.tagName)
                            return m(i.firstChild, t, n), !1;
                        i = i.nextSibling, r.append(a)
                    }
                    if (i)
                        (be(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName) && m(i.firstChild, t, n);
                    else {
                        for (var o = r.get(0).parentNode; o && !o.nextSibling && !g.node.isElement(o);)
                            o = o.parentNode;
                        if (o) {
                            for (var s = o.nextSibling; "BR" === s.tagName;)
                                s = s.nextSibling;
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, g.selection.isCollapsed()) {
                g.markers.insert(), g.$el.find(".fr-marker").replaceWith(l(e, t) + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + ("</" + e + ">")), g.selection.restore()
            } else {
                var r;
        ...
        function v(e, t, n, r) {
            if (!r) {
                var i = !1;
                if (!0 === e.data("type"))
                    for (; g.node.isFirstSibling(e.get(0)) && !e.parent().is(g.$el) && !e.parent().is("ol") && !e.parent().is("ul");)
                        e.parent().before(e), i = !0;
                else if (!1 === e.data("type"))
                    for (; g.node.isLastSibling(e.get(0)) && !e.parent().is(g.$el) && !e.parent().is("ol") && !e.parent().is("ul");)
            ...
            if (e.parents(t).length || void 0 === t) {
                var a = "",
                    o = "",
                    s = e.parent();
                if (s.is(g.$el) || g.node.isBlock(s.get(0)))
                    return !1;
        ...
        function r(t, n) {
            ...
            !function e(t, n, r, i) {
                for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
                    var s = a[o];
                    if (g.node.hasClass(s, "fr-marker"))
                        n = (n + 1) % 2;
                    else if (n)
                        if (0 < be(s).find(".fr-marker").length)
                            n = e(be(s), n, r, i);
                        else {
                            for (var l = be(s).find(r || "*:not(a):not(br)"), d = l.length - 1; 0 <= d; d--) {
                                var c = l[d];
                            ...
                            void 0 === r && s.nodeType == Node.ELEMENT_NODE && !g.node.isVoid(s) || p(s, f(r, i)) ? g.node.isBlock(s) || be(s).replaceWith(s.innerHTML) : void 0 === r && s.nodeType == Node.ELEMENT_NODE && g.node.isBlock(s) && "TABLE" != s.tagName && g.node.clearAttributes(s)
                        }
                    else
                        0 < be(s).find(".fr-marker").length && (n = e(be(s), n, r, i))
                }
                return n
            }(g.$el, 0, t, n), r || (g.$el.find(".fr-marker").remove(), g.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), r && g.$el.find(".fr-marker").before(be.FE.INVISIBLE_SPACE).after(be.FE.INVISIBLE_SPACE), g.html.cleanEmptyTags(), g.el.normalize(), g.selection.restore()
        }
        function t(e, t) {
            var n,
                r,
            ...
            if (g.selection.isCollapsed()) {
                ...
                if (g.node.openTagString(l.get(0)) == '<span style="' + e + ": " + l.css(e) + ';">') {
                    if (g.node.isEmpty(l.get(0)))
                        s = be('<span style="' + e + ": " + t + ';">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>"), l.replaceWith(s);
                    else {
                        var d = {};
                        d["style*"] = e + ":", v(r, "span", d, !0), r = g.$el.find(".fr-marker"), t ? (s = be('<span style="' + e + ": " + t + ';">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>"), r.replaceWith(s)) : r.replaceWith(be.FE.INVISIBLE_SPACE + be.FE.MARKERS)
                    }
                    g.html.cleanEmptyTags()
                } else
                    g.node.isEmpty(l.get(0)) && l.is("span") ? (r.replaceWith(be.FE.MARKERS), l.css(e, t)) : (s = be('<span style="' + e + ": " + t + ';">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>"), r.replaceWith(s));
                s && E(s, e, t)
            } else {
                if (g.selection.save(), null == t || "color" == e && 0 < g.$el.find(".fr-marker").parents("u, a").length) {
                    var c = g.$el.find(".fr-marker");
                    for (n = 0; n < c.length; n++)
                        if (!0 === (r = be(c[n])).data("type"))
                            for (; g.node.isFirstSibling(r.get(0)) && !r.parent().is(g.$el) && !g.node.isElement(r.parent().get(0)) && !g.node.isBlock(r.parent().get(0));)
                                r.parent().before(r);
                        else
                            for (; g.node.isLastSibling(r.get(0)) && !r.parent().is(g.$el) && !g.node.isElement(r.parent().get(0)) && !g.node.isBlock(r.parent().get(0));)
                                r.parent().after(r)
                }
                for (var f = g.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild;)
                    f = f.firstChild;
                var p = {
                    "class": "fr-unprocessed"
                };
                for (t && (p.style = e + ": " + t + ";"), m(f, "span", p), g.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                    be(this).prepend(be(this).prev())
                }), g.$el.find(".fr-unprocessed + .fr-marker").each(function() {
                    be(this).prev().append(this)
                    ...
                    for (n = h.length - 1; 0 <= n; n--)
                        i = h[n], a = e, o = void 0, (o = be(i)).css(a, ""), "" === o.attr("style") && o.replaceWith(o.html());
                    E(s, e, t)
                }
            }
            !function() {
                ...
                g.$el.find(".fr-split").removeClass("fr-split"), g.$el.find('[style=""]').removeAttr("style"), g.$el.find('[class=""]').removeAttr("class"), g.html.cleanEmptyTags(), be(g.$el.find("span").get().reverse()).each(function() {
                    this.attributes && 0 !== this.attributes.length || be(this).replaceWith(this.innerHTML)
                }), g.el.normalize();
                ...
                g.$el.find("span[style] span[style]").each(function() {
                    if (0 <= be(this).attr("style").indexOf("font-size")) {
                        var e = be(this).parents("span[style]");
                        0 <= e.attr("style").indexOf("background-color") && (be(this).attr("style", be(this).attr("style") + ";" + e.attr("style")), v(be(this), "span[style]", {}, !1))
                    }
        ...
        function E(e, t, n) {
            ...
            for (r = o.length - 1; 0 <= r; r--)
                i = o[r], a = t, 0 === be(i).attr("style").indexOf(a + ":") || 0 <= be(i).attr("style").indexOf(";" + a + ":") || 0 <= be(i).attr("style").indexOf("; " + a + ":") || s.push(o[r]);
            if ((o = o.not(s)).length) {
                for (var l = "", d = "", c = "", f = "", p = e.get(0); p = p.parentNode, be(p).addClass("fr-split"), l += g.node.closeTagString(p), d = g.node.openTagString(be(p).clone().addClass("fr-split").get(0)) + d, o.get(0) != p && (c += g.node.closeTagString(p), f = g.node.openTagString(be(p).clone().addClass("fr-split").get(0)) + f), o.get(0) != p;)
                    ;
                var u = l + g.node.openTagString(be(o.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + c + "</span>" + d;
                e.replaceWith('<span id="fr-break"></span>');
                var h = o.get(0).outerHTML;
                be(o.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, u))
            }
        }
        function i(e, t) {
            ...
            for (var i = r; i && i.nodeType == Node.ELEMENT_NODE && !p(i, f(e, t));)
                i = i.firstChild;
            if (i && i.nodeType == Node.ELEMENT_NODE && p(i, f(e, t)))
                return !0;
            var a = r;
    ...
    }, be.FE.RegisterCommand = function(e, t) {
        be.FE.COMMANDS[e] = t
    }, be.FE.MODULES.commands = function(o) {
        function i(e) {
        ...
        var a = {
            ...
            insertHR: function() {
                ...
                if (n.removeAttr("id"), 0 === n.next().length) {
                    ...
                    r ? n.after(be("<" + r + ">").append("<br>")) : n.after("<br>")
                }
                n.prev().is("hr") ? t = o.selection.setAfter(n.get(0), !1) : n.next().is("hr") ? t = o.selection.setBefore(n.get(0), !1) : o.selection.setAfter(n.get(0), !1) || o.selection.setBefore(n.get(0), !1), t || void 0 === t || (e = i(e = be.FE.MARKERS + "<br>"), n.after(e)), o.selection.restore()
            },
        ...
        function t(e, t) {
            if (!1 !== o.events.trigger("commands.before", be.merge([e], t || []))) {
                var n = be.FE.COMMANDS[e] && be.FE.COMMANDS[e].callback || a[e],
                    r = !0,
                    i = !1;
                be.FE.COMMANDS[e] && ("undefined" != typeof be.FE.COMMANDS[e].focus && (r = be.FE.COMMANDS[e].focus), "undefined" != typeof be.FE.COMMANDS[e].accessibilityFocus && (i = be.FE.COMMANDS[e].accessibilityFocus)), (!o.core.hasFocus() && r && !o.popups.areVisible() || !o.core.hasFocus() && i && o.accessibility.hasFocus()) && o.events.focus(!0), be.FE.COMMANDS[e] && !1 !== be.FE.COMMANDS[e].undo && (o.$el.find(".fr-marker").length && (o.events.disableBlur(), o.selection.restore()), o.undo.saveStep()), n && n.apply(o, be.merge([e], t || [])), o.events.trigger("commands.after", be.merge([e], t || [])), be.FE.COMMANDS[e] && !1 !== be.FE.COMMANDS[e].undo && o.undo.saveStep()
            }
        }
        function e(e, t) {
            o.format.toggle(t)
        ...
        function n(e) {
            ...
            for (var t = o.selection.blocks(), n = 0; n < t.length; n++)
                if ("LI" != t[n].tagName && "LI" != t[n].parentNode.tagName) {
                    ...
                    if (r.width() < 2 * o.opts.indentMargin && 0 < e)
                        continue;
        ...
        return be.extend(s, {
            ...
            _init: function() {
                o.events.on("keydown", function(e) {
                    ...
                    if (t && "HR" == t.tagName && !o.keys.isArrow(e.which))
                        return e.preventDefault(), !1
                }), o.events.on("keyup", function(e) {
                    var t = o.selection.element();
                    if (t && "HR" == t.tagName)
                        if (e.which == be.FE.KEYCODE.ARROW_LEFT || e.which == be.FE.KEYCODE.ARROW_UP) {
                            if (t.previousSibling)
                                return o.node.isBlock(t.previousSibling) ? o.selection.setAtEnd(t.previousSibling) : be(t).before(be.FE.MARKERS), o.selection.restore(), !1
                        } else if ((e.which == be.FE.KEYCODE.ARROW_RIGHT || e.which == be.FE.KEYCODE.ARROW_DOWN) && t.nextSibling)
                            return o.node.isBlock(t.nextSibling) ? o.selection.setAtStart(t.nextSibling) : be(t).after(be.FE.MARKERS), o.selection.restore(), !1
                    ...
                    e == o.selection.endElement() && e && "HR" == e.tagName && (e.nextSibling && (o.node.isBlock(e.nextSibling) ? o.selection.setAtStart(e.nextSibling) : be(e).after(be.FE.MARKERS)), o.selection.restore())
                })
            }
        })
    }, be.FE.MODULES.data = function(p) {
            ...
            _init: function() {
                ...
                for (var n, r, i, a = !(p.ul = !0), o = 0, s = 0; s < e.length; s++) {
                    ...
                    if (d === E(g(E("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(h, d.length - h.length) || C(h)) {
                        if (!((null === (n = l[1]) || new Date(n) < new Date(E("uB2C1D7B5E1E5E4A1E3C11=="))) && 0 < (h || "").length) || C(h)) {
                            p.ul = !1;
                            break
                        }
    ...
    }), be.FE.MODULES.paste = function(b) {
        var o,
            s,
            i,
            T;
        ...
        function e(e) {
            ...
            n(t, be("<div>").html(t).text()), "cut" == e.type && (b.undo.saveStep(), setTimeout(function() {
        ...
        function t(e) {
            if (a)
                return !1;
            if (e.originalEvent && (e = e.originalEvent), !1 === b.events.trigger("paste.before", [e]))
                return e.preventDefault(), !1;
            if (b.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (b.helpers.isArray(n))
                    ...
                    t = n;
                if (o = "", /text\/rtf/.test(t) && (s = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !b.browser.safari ? o = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && b.browser.safari ? o = s : /public.rtf/.test(t) && b.browser.safari && (o = e.clipboardData.getData("text/rtf")), "" !== o)
                    return l(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                o = null
            }
            return function() {
                b.selection.save(), b.events.disableBlur(), o = null, i ? (i.html(""), b.browser.edge && b.opts.iframe && b.$el.append(i)) : (i = be('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), b.browser.webkit ? (i.css("top", b.$sc.scrollTop()), b.$el.after(i)) : b.browser.edge && b.opts.iframe ? b.$el.append(i) : b.$box.after(i), b.events.on("destroy", function() {
                    i.remove()
                }));
                b.helpers.isIOS() || i.focus();
            ...
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (o = "", /text\/rtf/.test(t) && (s = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? o = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && b.browser.safari ? o = s : /text\/plain/.test(t) && !this.browser.mozilla && (o = b.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== o) {
                    ...
                    if (b.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), b.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), b.selection.restore(), b.selection.remove(), b.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== i) {
                        ...
                        return be(a).replaceWith(be.FE.MARKERS), b.selection.restore(), l(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else
                    o = null
            }
        ...
        function d(e, t, n) {
            ...
            if (!t && ((l = function(e) {
                ...
                return !(!t || be("<div>").html(e).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
            ...
            !t || b.wordPaste && n || (0 === (e = e.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (e = "<table>" + e + "</table>"), e = C(e = function(e) {
                ...
                for (t = 0; t < i.length; t++)
                    (n = i[t]).outerHTML = "<" + (b.html.defaultTag() || "DIV") + ">" + n.innerHTML + "</" + (b.html.defaultTag() || "DIV") + ">";
                ...
                var a = function(e) {
                    for (var t = b.node.contents(e), n = 0; n < t.length; n++)
            ...
            if ("string" == typeof c && (e = c), "" !== e) {
                ...
                var h = b.selection.element(),
                    g = !1;
                if (h && be(h).parentsUntil(b.el, "ul, ol").length && (g = !0), g) {
                    var m = f.children;
                ...
                if (b.opts.enter == be.FE.ENTER_BR)
                    for (r = (i = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--)
                        0 === (a = i[r]).attributes.length && (a.outerHTML = a.innerHTML + (a.nextSibling && !b.node.isEmpty(a) ? "<br>" : ""));
                else if (b.opts.enter == be.FE.ENTER_DIV)
                    for (r = (i = f.getElementsByTagName("p")).length - 1; 0 <= r; r--)
                        0 === (a = i[r]).attributes.length && (a.outerHTML = "<div>" + a.innerHTML + "</div>");
                else
                    b.opts.enter == be.FE.ENTER_P && 1 == f.childNodes.length && "P" == f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
                e = f.innerHTML, l && (e = function(e) {
                    var t,
                        n = b.o_doc.createElement("div");
                    n.innerHTML = e;
                    var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + be.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")");
                    for (; r.length;) {
                        for (t = 0; t < r.length; t++)
                            r[t].parentNode.removeChild(r[t]);
                        r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + be.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")")
                    }
                    return n.innerHTML
                }(e)), b.html.insert(e, !0)
            }
        ...
        function C(e) {
            ...
            for (var r = c(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var i = r[r.length - 1];
                if (b.html.defaultTag() && "div" != b.html.defaultTag())
                    i.querySelector(b.html.blockTagsQuery()) ? i.outerHTML = i.innerHTML : i.outerHTML = "<" + b.html.defaultTag() + ">" + i.innerHTML + "</" + b.html.defaultTag() + ">";
                else {
                    var a = i.querySelectorAll("*");
                    !a.length || "BR" !== a[a.length - 1].tagName && 0 === i.innerText.length ? i.outerHTML = i.innerHTML + "<br>" : i.nextSibling ? i.outerHTML = i.innerHTML + "<br>" : i.outerHTML = i.innerHTML
                }
        ...
        shortcutsEnabled: [],
        shortcutsHint: !0
    }), be.FE.SHORTCUTS_MAP = {}, be.FE.RegisterShortcut = function(e, t, n, r, i, a) {
        be.FE.SHORTCUTS_MAP[(i ? "^" : "") + (a ? "@" : "") + e] = {
            cmd: t,
            val: n,
            letter: r,
            shift: i,
            option: a
        }, be.FE.DEFAULTS.shortcutsEnabled.push(t)
    }, be.FE.RegisterShortcut(be.FE.KEYCODE.E, "show", null, "E", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.B, "bold", null, "B", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.I, "italic", null, "I", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.U, "underline", null, "U", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.S, "strikeThrough", null, "S", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Z, "undo", null, "Z", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Z, "redo", null, "Z", !0, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Y, "redo", null, "Y", !1, !1), be.FE.MODULES.shortcuts = function(s) {
        var r = null;
        var l = !1;
        function e(e) {
            if (!s.core.hasFocus())
            ...
            if ("keyup" == e.type && l && t != be.FE.KEYCODE.META)
                return l = !1;
            "keydown" == e.type && (l = !1);
            var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t;
            if (n && be.FE.SHORTCUTS_MAP[r]) {
                var i = be.FE.SHORTCUTS_MAP[r].cmd;
                if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
                    var a,
                        o = be.FE.SHORTCUTS_MAP[r].val;
                    if (i && !o ? a = s.$tb.find('.fr-command[data-cmd="' + i + '"]') : i && o && (a = s.$tb.find('.fr-command[data-cmd="' + i + '"][data-param1="' + o + '"]')), a.length)
                        return e.preventDefault(), e.stopPropagation(), a.parents(".fr-toolbar").data("instance", s), "keydown" == e.type && (s.button.exec(a), l = !0), !1;
                    if (i && (s.commands[i] || be.FE.COMMANDS[i] && be.FE.COMMANDS[i].callback))
                        return e.preventDefault(), e.stopPropagation(), "keydown" == e.type && ((s.commands[i] || be.FE.COMMANDS[i].callback)(), l = !0), !1
                }
            }
        }
        return {
            ...
            get: function(e) {
                if (!s.opts.shortcutsHint)
                    return null;
                if (!r)
                    for (var t in r = {}, be.FE.SHORTCUTS_MAP)
                        be.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(be.FE.SHORTCUTS_MAP[t].cmd) && (r[be.FE.SHORTCUTS_MAP[t].cmd + "." + (be.FE.SHORTCUTS_MAP[t].val || "")] = {
                            shift: be.FE.SHORTCUTS_MAP[t].shift,
                            option: be.FE.SHORTCUTS_MAP[t].option,
                            letter: be.FE.SHORTCUTS_MAP[t].letter
                        });
                var n = r[e];
    ...
    }, be.FE.MODULES.snapshot = function(l) {
        function n(e) {
        ...
        return {
            ...
            reset: i,
            saveStep: function(e) {
                if (!n.undo_stack || n.undoing || n.el.querySelector(".fr-marker"))
                    return !1;
    ...
    }, be.FE.DefineIconTemplate = function(e, t) {
        be.FE.ICON_TEMPLATES[e] = t
    }, be.FE.DefineIcon = function(e, t) {
        be.FE.ICONS[e] = t
    }, be.extend(be.FE.DEFAULTS, {
        iconsTemplate: "font_awesome"
    }), be.FE.MODULES.icon = function(i) {
        return {
            create: function(n) {
                var e = null,
                    r = be.FE.ICONS[n];
                if (void 0 !== r) {
                    var t = r.template || be.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate;
                    t && t.apply && (t = t.apply(i)), r.FA5NAME || (r.FA5NAME = r.NAME), t && (t = be.FE.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function(e, t) {
            ...
            getTemplate: function(e) {
                ...
                return void 0 !== t ? n = t.template || be.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate : n
            }
        }
    }, be.extend(be.FE.DEFAULTS, {
        tooltips: !0
    }), be.FE.MODULES.tooltip = function(i) {
        function r() {
            if (i.helpers.isMobile())
                return !1;
        ...
        function a(e, t) {
            if (i.helpers.isMobile())
                return !1;
            if (e.data("title") || e.data("title", e.attr("title")), !e.data("title"))
                return !1;
            i.$tooltip || i.opts.tooltips && !i.helpers.isMobile() && (i.shared.$tooltip ? i.$tooltip = i.shared.$tooltip : (i.shared.$tooltip = be('<div class="fr-tooltip"></div>'), i.$tooltip = i.shared.$tooltip, i.opts.theme && i.$tooltip.addClass(i.opts.theme + "-theme"), be(i.o_doc).find("body:first").append(i.$tooltip)), i.events.on("shared.destroy", function() {
            ...
            n < 0 && (n = 0), n + i.$tooltip.outerWidth() > be(i.o_win).width() && (n = be(i.o_win).width() - i.$tooltip.outerWidth()), void 0 === t && (t = i.opts.toolbarBottom);
            var r = t ? e.offset().top - i.$tooltip.height() : e.offset().top + e.outerHeight();
            i.$tooltip.css("position", ""), i.$tooltip.css("left", n), i.$tooltip.css("top", Math.ceil(r)), "static" != be(i.o_doc).find("body:first").css("position") ? (i.$tooltip.css("margin-left", -be(i.o_doc).find("body:first").offset().left), i.$tooltip.css("margin-top", -be(i.o_doc).find("body:first").offset().top)) : (i.$tooltip.css("margin-left", ""), i.$tooltip.css("margin-top", ""))
        }
        return {
            hide: r,
            to: a,
        ...
        function t(e) {
            ...
            if (0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(), t.popups.areVisible() && !t.popups.areVisible(t)) {
                for (var n = 0; n < be.FE.INSTANCES.length; n++)
                    be.FE.INSTANCES[n] != t && be.FE.INSTANCES[n].popups && be.FE.INSTANCES[n].popups.areVisible() && be.FE.INSTANCES[n].$el.find(".fr-marker").remove();
                t.popups.hideAll()
            }
            u.node.hasClass(e.get(0), "fr-dropdown") ? function(e) {
                ...
                if (i.helpers.isIOS() && !i.el.querySelector(".fr-marker") && (i.selection.save(), i.selection.clear(), i.selection.restore()), !n) {
                    var a = e.data("cmd");
                    t.find(".fr-command").removeClass("fr-active").attr("aria-selected", !1), be.FE.COMMANDS[a] && be.FE.COMMANDS[a].refreshOnShow && be.FE.COMMANDS[a].refreshOnShow.apply(i, [e, t]), t.css("left", e.offset().left - e.parent().offset().left - ("rtl" == u.opts.direction ? t.width() - e.outerWidth() : 0)), t.addClass("test-height");
                    var o = t.outerHeight();
                    t.removeClass("test-height"), t.css("top", "").css("bottom", ""), !u.opts.toolbarBottom && t.offset().top + e.outerHeight() + o < be(u.o_doc).height() ? t.css("top", e.position().top + e.outerHeight()) : t.css("bottom", e.parents(".fr-popup, .fr-toolbar").first().height() - e.position().top)
                }
            ...
            }(e) : (r(e), be.FE.COMMANDS[e.data("cmd")] && !1 !== be.FE.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh())
        }
        function a(e) {
            t(be(e.currentTarget))
        }
        function c(e) {
        ...
        function p(e) {
            if (e.stopPropagation(), !u.helpers.isMobile())
                return !1
        }
        function h(e, t, n) {
            if (t = be.extend(!0, {}, t), u.helpers.isMobile() && !1 === t.showOnMobile)
                return "";
            ...
            if ("options" !== t.type)
                if (r) {
                    ...
                    i = u.icon.create(t.icon || e), i += '<span class="fr-sr-only">' + (u.language.translate(t.title) || "") + "</span>";
            ...
            if ("dropdown" == t.type || "options" == t.type) {
                ...
                p += function(e, t) {
                    var n = "";
                    if (t.html)
                        "function" == typeof t.html ? n += t.html.call(u) : n += t.html;
                    else {
                        var r = t.options;
        ...
        function e(i) {
            ...
            if (!1 === u.events.trigger("buttons.refresh"))
                return !0;
            setTimeout(function() {
                for (var e = a.selection.inEditor() && a.core.hasFocus(), t = 0; t < i.length; t++) {
                    var n = be(i[t]),
                        r = n.data("cmd");
                    0 === n.parents(".fr-popup").length ? e || be.FE.COMMANDS[r] && be.FE.COMMANDS[r].forcedRefresh ? a.button.refresh(n) : u.node.hasClass(n.get(0), "fr-dropdown") || (n.removeClass("fr-active"), n.attr("aria-pressed") && n.attr("aria-pressed", !1)) : n.parents(".fr-popup").is(":visible") && a.button.refresh(n)
                }
            }, 0)
        }
        function n() {
        ...
        return {
            ...
            bindCommands: function(t, e) {
                ...
                var n = t.get(0).ownerDocument,
                    ...
                    i = function(e) {
                        (!e || e.type == u._mouseup && e.target != be("html").get(0) || "keydown" == e.type && (u.keys.isCharacter(e.which) && !u.keys.ctrlKey(e) || e.which == be.FE.KEYCODE.ESC)) && c(t)
                    };
                u.events.$on(be(r), u._mouseup + " resize keydown", i, !0), u.opts.iframe && u.events.$on(u.$win, u._mouseup, i, !0), u.node.hasClass(t.get(0), "fr-popup") ? be.merge(s, t.find(".fr-btn").toArray()) : be.merge(o, t.find(".fr-btn").toArray()), u.tooltip.bind(t, ".fr-btn, .fr-title", e)
            },
            refresh: function(e) {
                var t,
                    n = e.parents(".fr-popup, .fr-toolbar").data("instance") || u,
                    r = e.data("cmd");
                u.node.hasClass(e.get(0), "fr-dropdown") ? t = e.next() : (e.removeClass("fr-active"), e.attr("aria-pressed") && e.attr("aria-pressed", !1)), be.FE.COMMANDS[r] && be.FE.COMMANDS[r].refresh ? be.FE.COMMANDS[r].refresh.apply(n, [e, t]) : u.refresh[r] && n.refresh[r](e, t)
            },
            bulkRefresh: n,
            exec: r,
            click: t,
    ...
    }, be.FE.MODULES.modals = function(l) {
        ...
        function c(e, t) {
            if (d[e]) {
                var n = d[e].$modal,
                    r = n.data("instance") || l;
                r.events.enableBlur(), n.hide(), s.hide(), be(r.o_doc).find("body:first").removeClass("prevent-scroll fr-mobile"), n.removeClass("fr-active"), t || (r.accessibility.restoreSelection(), r.events.trigger("modals.hide"))
            }
        }
        function n(e) {
            var t;
        ...
        return {
            ...
            create: function(n, e, t) {
                if (l.shared.$overlay || (l.shared.$overlay = be('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                    var r = (i = e, a = t, o = '<div tabIndex="-1" class="fr-modal' + (l.opts.theme ? " " + l.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">', o += '<div class="fr-modal-head">' + i + '<i title="' + l.language.translate("Cancel") + '" class="fa fa-times fr-modal-close"></i></div>', o += '<div tabIndex="-1" class="fr-modal-body">' + a + "</div>", be(o += "</div></div>"));
                    d[n] = {
                        $modal: r,
                        ...
                        var t = e.which;
                        return t == be.FE.KEYCODE.ESC ? (c(n), l.accessibility.focusModalButton(r), !1) : !(!be(e.target).is("input[type=text], textarea") && t != be.FE.KEYCODE.ARROW_UP && t != be.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1))
                    }, !0), c(n, !0)
                }
                var i,
                    a,
            ...
            show: function(e) {
                if (d[e]) {
                    var t = d[e].$modal;
                    t.data("instance", l), t.show(), s.show(), be(l.o_doc).find("body:first").addClass("prevent-scroll"), l.helpers.isMobile() && be(l.o_doc).find("body:first").addClass("fr-mobile"), t.addClass("fr-active"), l.accessibility.focusModal(t)
                }
            },
            hide: c,
            resize: function(e) {
            ...
            areVisible: function(e) {
                for (var t in d)
                    if (d.hasOwnProperty(t) && n(t) && (void 0 === e || d[t].$modal.data("instance") == e))
                        return d[t].$modal;
                return !1
            }
        }
    }, be.FE.POPUP_TEMPLATES = {
        "text.edit": "[_EDIT_]"
    }, be.FE.RegisterTemplate = function(e, t) {
        be.FE.POPUP_TEMPLATES[e] = t
    }, be.FE.MODULES.popups = function(c) {
        ...
        function h(e) {
            for (var t in f)
                if (f.hasOwnProperty(t) && u(t) && (void 0 === e || f[t].data("instance") == e))
                    return f[t];
            return !1
        }
        function n(e) {
        ...
        function i(e, t) {
            ...
            return i ? (n = be('<div class="fr-popup' + (c.helpers.isMobile() ? " fr-mobile" : " fr-desktop") + (c.opts.toolbarInline ? " fr-inline" : "") + '"><span class="fr-arrow"></span>' + i + "</div>"), c.opts.theme && n.addClass(c.opts.theme + "-theme"), 1 < c.opts.zIndex && (c.opts.editInPopup ? n.css("z-index", c.opts.zIndex + 2) : c.$tb.css("z-index", c.opts.zIndex + 2)), "auto" != c.opts.direction && n.removeClass("fr-ltr fr-rtl").addClass("fr-" + c.opts.direction), n.find("input, textarea").attr("dir", c.opts.direction).attr("disabled", "disabled"), (r = be("body:first")).append(n), n.data("container", r), f[e] = n, c.button.bindCommands(n, !1), n) : (n = be('<div class="fr-popup fr-empty"></div>'), (r = be("body:first")).append(n), n.data("container", r), f[e] = n)
        }
        function v(r) {
            var i = f[r];
            return {
                ...
                _inputFocus: function(e) {
                    ...
                    if (n.is("input:file") && n.closest(".fr-layer").addClass("fr-input-focus"), e.preventDefault(), e.stopPropagation(), setTimeout(function() {
                        ...
                        var r = be(t.o_win).scrollTop();
                        setTimeout(function() {
                            be(t.o_win).scrollTop(r)
                        }, 0)
                    }
                },
                _inputBlur: function(e) {
                    var t = i.data("instance") || c,
                        n = be(e.currentTarget);
                    n.is("input:file") && n.closest(".fr-layer").removeClass("fr-input-focus"), document.activeElement != this && be(this).is(":visible") && (t.events.blurActive() && t.events.trigger("blur"), t.events.enableBlur())
                },
                _editorKeydown: function(e) {
                    var t = i.data("instance") || c;
                    t.keys.ctrlKey(e) || e.which == be.FE.KEYCODE.ALT || e.which == be.FE.KEYCODE.ESC || (u(r) && i.find(".fr-back:visible").length ? t.button.exec(i.find(".fr-back:visible:first")) : e.which != be.FE.KEYCODE.ALT && t.popups.hide(r))
                },
                _preventFocus: function(e) {
                    var t = i.data("instance") || c,
                        n = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
                    "mouseup" == e.type || be(n).is(":focus") || t.events.disableBlur(), "mouseup" != e.type || be(n).hasClass("fr-command") || 0 < be(n).parents(".fr-command").length || be(n).hasClass("fr-dropdown-content") || c.button.hideActiveDropdowns(i), (c.browser.safari || c.browser.mozilla) && "mousedown" == e.type && be(n).is("input[type=file]") && t.events.disableBlur();
                    var r = "input, textarea, button, select, label, .fr-command";
                    if (n && !be(n).is(r) && 0 === be(n).parents(r).length)
                        return e.stopPropagation(), !1;
                    n && be(n).is(r) && e.stopPropagation(), m()
                },
                ...
                _windowKeydown: function(e) {
                    ...
                    var t = i.data("instance") || c,
                        n = e.which;
                    if (be.FE.KEYCODE.ESC == n) {
                        if (t.popups.isVisible(r) && t.opts.toolbarInline)
                            return e.stopPropagation(), t.popups.isVisible(r) && (i.find(".fr-back:visible").length ? (t.button.exec(i.find(".fr-back:visible:first")), t.accessibility.focusPopupButton(i)) : i.find(".fr-dismiss:visible").length ? t.button.exec(i.find(".fr-dismiss:visible:first")) : (t.popups.hide(r), t.toolbar.showInline(null, !0), t.accessibility.FocusPopupButton(i))), !1;
                        if (t.popups.isVisible(r))
                            return i.find(".fr-back:visible").length ? (t.button.exec(i.find(".fr-back:visible:first")), t.accessibility.focusPopupButton(i)) : i.find(".fr-dismiss:visible").length ? t.button.exec(i.find(".fr-dismiss:visible:first")) : (t.popups.hide(r), t.accessibility.focusPopupButton(i)), !1
                    }
                },
                _doPlaceholder: function() {
                    0 === be(this).next().length && be(this).attr("placeholder") && be(this).after('<label for="' + be(this).attr("id") + '">' + be(this).attr("placeholder") + "</label>"), be(this).toggleClass("fr-not-empty", "" !== be(this).val())
                },
                _repositionPopup: function() {
                    if (!c.opts.height && !c.opts.heightMax || c.opts.toolbarInline)
                        return !0;
        ...
        return c.shared.exit_flag = !1, {
            _init: function() {
                c.events.on("shared.destroy", e, !0), c.events.on("window.mousedown", t), c.events.on("window.touchmove", m), c.events.$on(be(c.o_win), "scroll", m), c.events.on("mousedown", function(e) {
            ...
            create: function(e, t) {
                ...
                return o(r, e), c.events.$on(n, "mousedown mouseup touchstart touchend touch", "*", r._preventFocus, !0), c.events.$on(n, "focus", "input, textarea, button, select", r._inputFocus, !0), c.events.$on(n, "blur", "input, textarea, button, select", r._inputBlur, !0), c.accessibility.registerPopup(e), c.events.$on(n, "keydown keyup change input", "input, textarea", r._doPlaceholder, !0), c.helpers.isIOS() && c.events.$on(n, "touchend", "label", function() {
                    be("#" + be(this).attr("for")).prop("checked", function(e, t) {
                        return !t
                    })
                }, !0), c.events.$on(be(c.o_win), "resize", r._windowResize, !0), n
            },
            get: function(e) {
                var t = f[e];
            ...
            show: function(e, t, n, r) {
                if (u(e) || (h() && 0 < c.$el.find(".fr-marker").length ? (c.events.disableBlur(), c.selection.restore()) : h() || (c.events.disableBlur(), c.events.focus(), c.events.enableBlur())), g([e]), !f[e])
                    return !1;
    ...
    }, be.FE.MODULES.position = function(v) {
        function i() {
        ...
        function n(e) {
            ...
            if (void 0 === r) {
                n.data("sticky-top", 0);
                var a = be('<div class="fr-sticky-dummy" style="height: ' + n.outerHeight() + 'px;"></div>');
                v.$box.prepend(a)
            } else
                v.$box.find(".fr-sticky-dummy").css("height", n.outerHeight());
            if (v.core.hasFocus() || 0 < v.$tb.find("input:visible:focus").length) {
                ...
                clearTimeout(be(e).css("sticky-timeout")), n.css("top", "0"), n.css("position", ""), n.width(""), n.data("sticky-top", 0), n.removeClass("fr-sticky-on"), v.$box.removeClass("fr-sticky-box")
        }
        function t(e) {
            if (e.offsetWidth) {
                var t,
                    ...
                    o = be("body" == v.opts.scrollableContainer ? v.o_win : v.opts.scrollableContainer).outerHeight(),
                    s = 0,
                    l = 0;
                "body" !== v.opts.scrollableContainer && (s = v.$sc.offset().top, l = be(v.o_win).outerHeight() - s - o);
                    ...
                    if (v._stickyElements = [], v.helpers.isIOS()) {
                        var t = function() {
                            if (v.helpers.requestAnimationFrame()(t), !1 !== v.events.trigger("position.refresh"))
                                for (var e = 0; e < v._stickyElements.length; e++)
                                    n(v._stickyElements[e])
                        };
                        t(), v.events.$on(be(v.o_win), "scroll", function() {
                            if (v.core.hasFocus())
                                for (var e = 0; e < v._stickyElements.length; e++) {
                                    var t = be(v._stickyElements[e]),
                                        n = t.parent(),
                        ...
                        "body" !== v.opts.scrollableContainer && v.events.$on(be(v.opts.scrollableContainer), "scroll", e, !0), v.events.$on(be(v.o_win), "scroll", e, !0), v.events.$on(be(v.o_win), "resize", e, !0), v.events.on("initialized", e), v.events.on("focus", e), v.events.$on(be(v.o_win), "resize", "textarea", e, !0);
    ...
    }, be.FE.MODULES.refresh = function(i) {
        function a(e, t) {
        ...
        return {
            ...
            outdent: function(e) {
                if (i.node.hasClass(e.get(0), "fr-no-refresh"))
                    return !1;
                for (var t = i.selection.blocks(), n = 0; n < t.length; n++) {
                    var r = "rtl" == i.opts.direction || "rtl" == be(t[n]).css("direction") ? "margin-right" : "margin-left";
                    if ("LI" == t[n].tagName || "LI" == t[n].parentNode.tagName)
                        return a(e, !1), !0;
                    if (0 < i.helpers.getPX(be(t[n]).css(r)))
                        return a(e, !1), !0
                }
                a(e, !0)
            },
        ...
        editInPopup: !1
    }), be.FE.MODULES.textEdit = function(n) {
        function t() {
    ...
    }, be.FE.RegisterCommand("updateText", {
        focus: !1,
        undo: !1,
        callback: function() {
    ...
    }), be.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "|", "fontFamily", "fontSize", "color", "inlineClass", "inlineStyle", "paragraphStyle", "lineHeight", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "-", "insertLink", "insertImage", "insertVideo", "embedly", "insertFile", "insertTable", "|", "emoticons", "fontAwesome", "specialCharacters", "insertHR", "selectAll", "clearFormatting", "|", "print", "getPDF", "spellChecker", "help", "html", "|", "undo", "redo"], be.FE.TOOLBAR_BUTTONS_MD = null, be.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"], be.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"], be.FE.MODULES.toolbar = function(i) {
        var r = [];
        function a(e, t) {
            for (var n = 0; n < t.length; n++)
        ...
        function e() {
            ...
            for (var t = 0; t < e.length; t++)
                if ("|" == e[t] || "-" == e[t])
                    i.$tb.append(i.button.buildList([e[t]]));
                else {
        ...
        function t(e, t) {
            setTimeout(function() {
                if ((!e || e.which != be.FE.KEYCODE.ESC) && i.selection.inEditor() && i.core.hasFocus() && !i.popups.areVisible() && (i.opts.toolbarVisibleWithoutSelection || !i.selection.isCollapsed() && !i.keys.isIME() || t)) {
                    if (i.$tb.data("instance", i), !1 === i.events.trigger("toolbar.show", [e]))
                        return !1;
        ...
        function d() {
            i.events.on("window.mousedown", n), i.events.on("keydown", n), i.events.on("blur", n), i.helpers.isMobile() || i.events.on("window.mouseup", t), i.helpers.isMobile() ? i.helpers.isIOS() || (i.events.on("window.touchend", t), i.browser.mozilla && setInterval(t, 200)) : i.events.on("window.keyup", l), i.events.on("keydown", function(e) {
                e && e.which == be.FE.KEYCODE.ESC && n()
            }), i.events.on("keydown", function(e) {
                if (e.which == be.FE.KEYCODE.ALT)
                    return e.stopPropagation(), !1
        ...
        function p() {
            i.opts.theme && i.$tb.addClass(i.opts.theme + "-theme"), 1 < i.opts.zIndex && i.$tb.css("z-index", i.opts.zIndex + 1), "auto" != i.opts.direction && i.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-" + i.opts.direction), i.helpers.isMobile() ? i.$tb.addClass("fr-mobile") : i.$tb.addClass("fr-desktop"), i.opts.toolbarContainer ? (i.opts.toolbarInline && (d(), n()), i.opts.toolbarBottom ? i.$tb.addClass("fr-bottom") : i.$tb.addClass("fr-top")) : i.opts.toolbarInline ? (i.$sc.append(i.$tb), i.$tb.data("container", i.$sc), i.$tb.addClass("fr-inline"), i.$tb.prepend('<span class="fr-arrow"></span>'), d(), i.opts.toolbarBottom = !1) : (i.opts.toolbarBottom && !i.helpers.isIOS() ? (i.$box.append(i.$tb), i.$tb.addClass("fr-bottom"), i.$box.addClass("fr-bottom")) : (i.opts.toolbarBottom = !1, i.$box.prepend(i.$tb), i.$tb.addClass("fr-top"), i.$box.addClass("fr-top")), i.$tb.addClass("fr-basic"), i.opts.toolbarSticky && (i.opts.toolbarStickyOffset && (i.opts.toolbarBottom ? i.$tb.css("bottom", i.opts.toolbarStickyOffset) : i.$tb.css("top", i.opts.toolbarStickyOffset)), i.position.addSticky(i.$tb))), function() {
                var e = be.merge([], o());
                a(e, r[be.FE.XS]), a(e, r[be.FE.SM]), a(e, r[be.FE.MD]), a(e, r[be.FE.LG]);
                for (var t = e.length - 1; 0 <= t; t--)
                    "-" != e[t] && "|" != e[t] && e.indexOf(e[t]) < t && e.splice(t, 1);
                var n = i.button.buildList(e, o());
                i.$tb.append(n), i.button.bindCommands(i.$tb)
            }(), i.events.$on(be(i.o_win), "resize", e), i.events.$on(be(i.o_win), "orientationchange", e), i.accessibility.registerToolbar(i.$tb), i.events.$on(i.$tb, i._mousedown + " " + i._mouseup, function(e) {
                var t = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
                if (t && "INPUT" != t.tagName && !i.edit.isDisabled())
        ...
        return {
            _init: function() {
                if (i.$sc = be(i.opts.scrollableContainer).first(), !i.$wp)
                    return !1;
                i.opts.toolbarContainer ? (i.shared.$tb ? (i.$tb = i.shared.$tb, i.opts.toolbarInline && d()) : (i.shared.$tb = be('<div class="fr-toolbar"></div>'), i.$tb = i.shared.$tb, be(i.opts.toolbarContainer).append(i.$tb), p(), i.$tb.data("instance", i)), i.opts.toolbarInline ? i.$box.addClass("fr-inline") : i.$box.addClass("fr-basic"), i.events.on("focus", function() {
                    i.$tb.data("instance", i)
                }, !0), i.opts.toolbarInline = !1) : i.opts.toolbarInline ? (i.$box.addClass("fr-inline"), i.shared.$tb ? (i.$tb = i.shared.$tb, d()) : (i.shared.$tb = be('<div class="fr-toolbar"></div>'), i.$tb = i.shared.$tb, p())) : (i.$box.addClass("fr-basic"), i.$tb = be('<div class="fr-toolbar"></div>'), p(), i.$tb.data("instance", i)), i.events.on("destroy", f, !0), i.events.on(i.opts.toolbarInline || i.opts.toolbarContainer ? "shared.destroy" : "destroy", c, !0)
            },
            hide: n,
            show: function() {
                if (!1 === i.events.trigger("toolbar.show"))
                    return !1;
                i.$tb.show()
            },
            showInline: t,
    ...
    }, be.FE.PLUGINS.align = function(i) {
        return {
            apply: function(e) {
                var t = i.selection.element();
                if (be(t).parents(".fr-img-caption").length)
                    be(t).css("text-align", e);
                else {
                    i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
                    for (var n = i.selection.blocks(), r = 0; r < n.length; r++)
                        i.helpers.getAlignment(be(n[r].parentNode)) == e ? be(n[r]).css("text-align", "").removeClass("fr-temp-div") : be(n[r]).css("text-align", e).removeClass("fr-temp-div"), "" === be(n[r]).attr("class") && be(n[r]).removeAttr("class"), "" === be(n[r]).attr("style") && be(n[r]).removeAttr("style");
            ...
            refresh: function(e) {
                ...
                if (t.length) {
                    var n = i.helpers.getAlignment(be(t[0]));
            ...
            refreshOnShow: function(e, t) {
                ...
                if (n.length) {
                    var r = i.helpers.getAlignment(be(n[0]));
    ...
    }, be.FE.DefineIcon("align", {
        NAME: "align-left"
    }), be.FE.DefineIcon("align-left", {
        NAME: "align-left"
    }), be.FE.DefineIcon("align-right", {
        NAME: "align-right"
    }), be.FE.DefineIcon("align-center", {
        NAME: "align-center"
    }), be.FE.DefineIcon("align-justify", {
        NAME: "align-justify"
    }), be.FE.RegisterCommand("align", {
        type: "dropdown",
        title: "Align",
        options: {
            left: "Align Left",
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.align.options;
            for (var n in t)
        ...
        plugin: "align"
    }), be.FE.RegisterCommand("alignLeft", {
        type: "button",
        icon: "align-left",
        callback: function() {
    ...
    }), be.FE.RegisterCommand("alignRight", {
        type: "button",
        icon: "align-right",
        callback: function() {
    ...
    }), be.FE.RegisterCommand("alignCenter", {
        type: "button",
        icon: "align-center",
        callback: function() {
    ...
    }), be.FE.RegisterCommand("alignJustify", {
        type: "button",
        icon: "align-justify",
        callback: function() {
        ...
        charCounterMax: -1,
        charCounterCount: !0
    }), be.FE.PLUGINS.charCounter = function(n) {
        var r;
        function i() {
            return (n.el.textContent || "").replace(/\u200B/g, "").length
        }
        function e(e) {
            if (n.opts.charCounterMax < 0)
                return !0;
            if (i() < n.opts.charCounterMax)
                return !0;
            var t = e.which;
            return !(!n.keys.ctrlKey(e) && n.keys.isCharacter(t) || t === be.FE.KEYCODE.IME) || (e.preventDefault(), e.stopPropagation(), n.events.trigger("charCounter.exceeded"), !1)
        }
        function t(e) {
            return n.opts.charCounterMax < 0 ? e : be("<div>").html(e).text().length + i() <= n.opts.charCounterMax ? e : (n.events.trigger("charCounter.exceeded"), "")
        }
        function a() {
        ...
        return {
            _init: function() {
                return !!n.$wp && !!n.opts.charCounterCount && ((r = be('<span class="fr-counter"></span>')).css("bottom", n.$wp.css("border-bottom-width")), n.$box.append(r), n.events.on("keydown", e, !0), n.events.on("paste.afterCleanup", t), n.events.on("keyup contentChanged input", function() {
                        ...
                        be(n.o_win).off("resize.char" + n.id), r.removeData().remove(), r = null
                    }))
            },
            count: i
        }
    }, be.FE.PLUGINS.codeBeautifier = function() {
        var e,
            t,
            n,
            r,
        ...
        function x(r, e) {
            ...
            for (var _, L, x = {
                ...
                if ("/" === c && "*" === g()) {
                    ...
                    $ || "{" === k || x.trim(), x.singleSpace(), w.push(b()), x.newLine();
                else if ("@" === c) {
                    ...
                    "#" === c && "{" === g() ? (x.preserveSingleSpace(), w.push(m("}"))) : "{" === c ? "}" === g(!0) ? (v(), h(), x.singleSpace(), w.push("{}"), x.newLine(), l && 0 === R && x.newLine(!0)) : (R++, C += S, x["{"](c), I ? (I = !1, N = y < R) : N = y <= R) : "}" === c ? (R--, C = C.slice(0, -i), x["}"](c), O = N = !1, y && y--, l && 0 === R && x.newLine(!0)) : ":" === c ? (v(), !N && !I || T("&") || A() ? ":" === g() ? (h(), w.push("::")) : w.push(":") : (O = !0, w.push(":"), x.singleSpace())) : '"' === c || "'" === c ? (x.preserveSingleSpace(), w.push(m(c))) : ";" === c ? (O = !1, w.push(c), x.newLine()) : "(" === c ? T("url") ? (w.push(c), v(), h() && (")" !== c && '"' !== c && "'" !== c ? w.push(m(")")) : p--)) : (u++, x.preserveSingleSpace(), w.push(c), v()) : ")" === c ? (w.push(c), u--) : "," === c ? (w.push(c), v(), o && !O && u < 1 ? x.newLine() : x.singleSpace()) : ("]" === c || ("[" === c ? x.preserveSingleSpace() : "=" === c ? (v(), c = "=") : x.preserveSingleSpace()), w.push(c))
            }
            var U = "";
        ...
        function i(r, e) {
            ...
            for (u = {
                TK_START_EXPR: function() {
                    ...
                    var e = k.Expression;
                    if ("[" === s.text) {
                        if ("TK_WORD" === l || ")" === f.last_text)
                            return "TK_RESERVED" === l && G(f.last_text, a.line_starters) && (o.space_before_token = !0), y(e), S(), R(), void (h.space_in_paren && (o.space_before_token = !0));
                        e = k.ArrayLiteral, _(f.mode) && ("[" !== f.last_text && ("," !== f.last_text || "]" !== d && "}" !== d) || h.keep_array_indentation || A())
                    } else
                        "TK_RESERVED" === l && "for" === f.last_text ? e = k.ForInitializer : "TK_RESERVED" === l && G(f.last_text, ["if", "while"]) && (e = k.Conditional);
                ...
                TK_OPERATOR: function() {
                    N();
                    if ("TK_RESERVED" === l && O(f.last_text))
                        return o.space_before_token = !0, void S();
                    if ("*" === s.text && "TK_DOT" === l)
                        return void S();
                    if (":" === s.text && f.in_case)
                        return f.case_body = !0, R(), S(), A(), void (f.in_case = !1);
                    if ("::" === s.text)
                        return void S();
                    "TK_OPERATOR" === l && T();
                    var e = !0,
                ...
                TK_COMMA: function() {
                    if (f.declaration_statement)
                        return L(f.parent.mode) && (f.declaration_assignment = !1), S(), void (f.declaration_assignment ? A(f.declaration_assignment = !1, !0) : (o.space_before_token = !0, h.comma_first && T()));
                ...
                TK_BLOCK_COMMENT: function() {
                    if (o.raw)
                        return o.add_raw_token(s), void (s.directives && "end" === s.directives.preserve && (h.test_output_raw || (o.raw = !1)));
                    if (s.directives)
                        return A(!1, !0), S(), "start" === s.directives.preserve && (o.raw = !0), void A(!1, !0);
                    if (!Y.newline.test(s.text) && !s.wanted_newline)
                        return o.space_before_token = !0, S(), void (o.space_before_token = !0);
                    var e,
                        t = function(e) {
                            e = e.replace(/\x0d/g, "");
                            var t = [],
            ...
            function b(e) {
                var t = e.newlines;
                if (h.keep_array_indentation && _(f.mode))
                    for (n = 0; n < t; n += 1)
                        A(0 < n);
            ...
            function T(e) {
                if (e = e !== undefined && e, !o.just_added_newline())
                    if (h.preserve_newlines && s.wanted_newline || e)
                        A(!1, !0);
            ...
            function D() {
                ...
                if (N() || !s.wanted_newline || L(f.mode) || "TK_OPERATOR" === l && "--" !== f.last_text && "++" !== f.last_text || "TK_EQUALS" === l || !h.preserve_newlines && "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const", "set", "get"]) || A(), f.do_block && !f.do_while) {
                    if ("TK_RESERVED" === s.type && "while" === s.text)
                        return o.space_before_token = !0, S(), o.space_before_token = !0, void (f.do_while = !0);
                    A(), f.do_block = !1
                }
                if (f.if_block)
                    if (f.else_block || "TK_RESERVED" !== s.type || "else" !== s.text) {
                        ...
                        f.else_block = !0;
                if ("TK_RESERVED" === s.type && ("case" === s.text || "default" === s.text && f.in_case_statement))
                    return A(), (f.case_body || h.jslint_happy) && (0 < f.indentation_level && (!f.parent || f.indentation_level > f.parent.indentation_level) && (f.indentation_level -= 1), f.case_body = !1), S(), f.in_case = !0, void (f.in_case_statement = !0);
                if ("TK_RESERVED" === s.type && "function" === s.text && ((G(f.last_text, ["}", ";"]) || o.just_added_newline() && !G(f.last_text, ["[", "{", ":", "=", ","])) && (o.just_added_blankline() || s.comments_before.length || (A(), A(!0))), "TK_RESERVED" === l || "TK_WORD" === l ? "TK_RESERVED" === l && G(f.last_text, ["get", "set", "new", "return", "export", "async"]) ? o.space_before_token = !0 : "TK_RESERVED" === l && "default" === f.last_text && "export" === d ? o.space_before_token = !0 : A() : "TK_OPERATOR" === l || "=" === f.last_text ? o.space_before_token = !0 : (f.multiline_frame || !L(f.mode) && !_(f.mode)) && A()), "TK_COMMA" !== l && "TK_START_EXPR" !== l && "TK_EQUALS" !== l && "TK_OPERATOR" !== l || w() || T(), "TK_RESERVED" === s.type && G(s.text, ["function", "get", "set"]))
                    return S(), void (f.last_word = s.text);
        ...
        function F(t, n) {
            ...
            this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function() {
                ...
                if (!e.multiline_frame && e.mode !== k.ForInitializer && e.mode !== k.Conditional)
                    for (var t = e.start_line_index, n = r.length; t < n;)
                        r[t].remove_indent(), t++
        ...
        function M(y, _, e) {
            ...
            function o() {
                ...
                var r = y.charAt(M);
                for (M += 1; G(r, L);) {
                    if (Y.newline.test(r) ? "\n" === r && "\r" === y.charAt(M - 2) || (I += 1, n = []) : n.push(r), $ <= M)
                        return ["", "TK_EOF"];
                    r = y.charAt(M), M += 1
                }
                ...
                if ("(" === r || "[" === r)
                    return [r, "TK_START_EXPR"];
                if (")" === r || "]" === r)
                    return [r, "TK_END_EXPR"];
                if ("{" === r)
                    return [r, "TK_START_BLOCK"];
                if ("}" === r)
                    return [r, "TK_END_BLOCK"];
                if (";" === r)
                    return [r, "TK_SEMICOLON"];
                if ("/" === r) {
                    var s = "";
                    if ("*" === y.charAt(M)) {
                        var l;
                    ...
                    if ("/" === y.charAt(M))
                        return M += 1, U.lastIndex = M, s = "//" + (l = U.exec(y))[0], M += l[0].length, [s, "TK_COMMENT"]
                }
                if ("`" === r || "'" === r || '"' === r || ("/" === r || _.e4x && "<" === r && y.slice(M - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && G(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && G(t.parent.text, ["if", "while", "for"]) || G(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var c = r,
                        ...
                        p = !1;
                    if (e = r, "/" === c)
                        for (var u = !1; M < $ && (f || u || y.charAt(M) !== c) && !Y.newline.test(y.charAt(M));)
                        ...
                        for (; M < $ && (f || y.charAt(M) !== c && ("`" === c || !Y.newline.test(y.charAt(M))));)
                    ...
                    if (p && _.unescape_strings && (e = function(e) {
                        ...
                        for (; n || i < e.length;)
                            if (t = e.charAt(i), i++, n) {
                                ...
                                if (!a.match(/^[0123456789abcdefABCDEF]+$/))
                                    return e;
                        ...
                        for (; M < $ && Y.isIdentifierStart(y.charCodeAt(M));)
                            e += y.charAt(M), M += 1;
                    return [e, "TK_STRING"]
                }
                if ("#" === r) {
                ...
                if ("<" === r && ("?" === y.charAt(M) || "%" === y.charAt(M))) {
                    ...
                    var R = z.exec(y);
                    if (R)
                        return r = R[0], M += r.length - 1, [r = r.replace(Y.lineBreak, "\n"), "TK_STRING"]
                }
                ...
                if ("-" === r && k && "--\x3e" === y.substring(M - 1, M + 2))
                    return k = !1, M += 2, ["--\x3e", "TK_COMMENT"];
                if ("." === r)
                    return [r, "TK_DOT"];
                if (G(r, O)) {
            ...
            run: function(e, t) {
                ...
                for ((t = t || {}).wrap_line_length !== undefined && 0 !== parseInt(t.wrap_line_length, 10) || t.max_char === undefined || 0 === parseInt(t.max_char, 10) || (t.wrap_line_length = t.max_char), r = t.indent_inner_html !== undefined && t.indent_inner_html, i = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10), m = t.indent_char === undefined ? " " : t.indent_char, s = t.brace_style === undefined ? "collapse" : t.brace_style, a = 0 === parseInt(t.wrap_line_length, 10) ? 32786 : parseInt(t.wrap_line_length || 250, 10), v = t.unformatted || ["a", "span", "img", "bdo", "em", "strong", "dfn", "code", "samp", "kbd", "var", "cite", "abbr", "acronym", "q", "sub", "sup", "tt", "i", "b", "big", "small", "u", "s", "strike", "font", "ins", "del", "address", "pre"], l = t.preserve_newlines === undefined || t.preserve_newlines, d = l ? isNaN(parseInt(t.max_preserve_newlines, 10)) ? 32786 : parseInt(t.max_preserve_newlines, 10) : 0, E = t.indent_handlebars !== undefined && t.indent_handlebars, b = t.wrap_attributes === undefined ? "auto" : t.wrap_attributes, T = t.wrap_attributes_indent_size === undefined ? i : parseInt(t.wrap_attributes_indent_size, 10) || i, c = t.end_with_newline !== undefined && t.end_with_newline, f = Array.isArray(t.extra_liners) ? t.extra_liners.concat() : "string" == typeof t.extra_liners ? t.extra_liners.split(",") : "head,body,/html".split(","), t.indent_with_tabs && (m = "\t", i = 1), (n = new function() {
                    return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
                        ...
                        for (; 0 < e.length; e++)
                            if (!this.Utils.in_array(e.charAt(0), this.Utils.whitespace))
                                return !1;
                        return !0
                        ...
                        do {
                            if (this.pos >= this.input.length)
                                return e && (this.pos = l, this.line_char_count = d), i.length ? i.join("") : ["", "TK_EOF"];
                            if (r = this.input.charAt(this.pos), this.pos++, this.Utils.in_array(r, this.Utils.whitespace))
                                ...
                                if (E && "{" == n && 2 < i.length && "}" == i[i.length - 2] && "}" == i[i.length - 1])
                                    break
                            }
                        } while (">" != r);
                        var p,
                    ...
                    var p = n.get_token();
                    if (n.token_text = p[0], n.token_type = p[1], "TK_EOF" == n.token_type)
                        break;
                    switch (n.token_type) {
                    case "TK_TAG_START":
    ...
    }), be.FE.PLUGINS.codeView = function(l) {
        var d,
            c;
        function f() {
        ...
        function i(e) {
            d || (!function() {
                d = be('<textarea class="fr-code" tabIndex="-1">'), l.$wp.append(d), d.attr("dir", l.opts.direction), l.$box.hasClass("fr-basic") || (h = be('<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch' + (l.helpers.isMobile() ? "" : " fr-desktop") + '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'), l.$box.append(h), l.events.bindClick(l.$box, "a.html-switch", function() {
            ...
            if (l.core.hasFocus() && (i = !0, l.events.disableBlur(), l.$el.blur()), t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "FROALA-SM")).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM"), l.codeBeautifier && (t = l.codeBeautifier.run(t, l.opts.codeBeautifierOptions)), c) {
                ...
                var s = be(l.o_doc).scrollTop();
                g = !i, d.focus(), g = !0, d.get(0).setSelectionRange(n, r), be(l.o_doc).scrollTop(s)
            }
            l.$tb.find(" > .fr-command").not(e).filter(function() {
                return l.opts.codeViewKeepActiveButtons.indexOf(be(this).data("cmd")) < 0
    ...
    }), be.FE.PLUGINS.colors = function(g) {
        function t() {
            ...
            showColorsPopup: function() {
                ...
                if (t || (t = function() {
                    ...
                    return h = i, g.events.on("popup.tab", function(e) {
                        var t = be(e.currentTarget);
                        if (!g.popups.isVisible("colors.picker") || !t.is("span"))
                            return !0;
                        var n = e.which,
                            r = !0;
                        if (be.FE.KEYCODE.TAB == n) {
                        ...
                        } else if (be.FE.KEYCODE.ARROW_UP == n || be.FE.KEYCODE.ARROW_DOWN == n || be.FE.KEYCODE.ARROW_LEFT == n || be.FE.KEYCODE.ARROW_RIGHT == n) {
                            if (t.is("span.fr-select-color")) {
                                var a = t.parent().find("span.fr-select-color"),
                                    ...
                                    f = c * s + d,
                                    p = l * s;
                                be.FE.KEYCODE.ARROW_UP == n ? f = ((f - s) % p + p) % p : be.FE.KEYCODE.ARROW_DOWN == n ? f = (f + s) % p : be.FE.KEYCODE.ARROW_LEFT == n ? f = ((f - 1) % p + p) % p : be.FE.KEYCODE.ARROW_RIGHT == n && (f = (f + 1) % p);
                                var u = be(a.get(f));
                                g.events.disableBlur(), u.focus(), r = !1
                            }
                        } else
                            be.FE.KEYCODE.ENTER == n && (g.button.exec(t), r = !1);
                    ...
                    if (g.popups.setContainer("colors.picker", g.$tb), i(t.find(".fr-selected-tab").attr("data-param1")), e.is(":visible")) {
                        ...
                        g.position.forSelection(t), g.popups.show("colors.picker")
            },
            hideColorsPopup: t,
    ...
    }, be.FE.DefineIcon("colors", {
        NAME: "tint"
    }), be.FE.RegisterCommand("color", {
        title: "Colors",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "colors"
    }), be.FE.RegisterCommand("textColor", {
        undo: !0,
        callback: function(e, t) {
            this.colors.text(t)
        }
    }), be.FE.RegisterCommand("backgroundColor", {
        undo: !0,
        callback: function(e, t) {
            this.colors.background(t)
        }
    }), be.FE.RegisterCommand("colorChangeSet", {
        undo: !1,
        focus: !1,
        callback: function(e, t) {
    ...
    }), be.FE.DefineIcon("colorsBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("colorsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.RegisterCommand("customColor", {
        title: "OK",
        undo: !0,
        callback: function() {
            this.colors.customColor()
        }
    }), be.FE.DefineIcon("remove", {
        NAME: "eraser"
    }), be.extend(be.FE.DEFAULTS, {
        dragInline: !0
    }), be.FE.PLUGINS.draggable = function(d) {
        function e(e) {
            return !(!e.originalEvent || !e.originalEvent.target || e.originalEvent.target.nodeType != Node.TEXT_NODE) || (e.target && "A" == e.target.tagName && 1 == e.target.childNodes.length && "IMG" == e.target.childNodes[0].tagName && (e.target = e.target.childNodes[0]), be(e.target).hasClass("fr-draggable") ? (d.undo.canDo() || d.undo.saveStep(), d.opts.dragInline ? d.$el.attr("contenteditable", !0) : d.$el.attr("contenteditable", !1), d.opts.toolbarInline && d.toolbar.hide(), be(e.target).addClass("fr-dragging"), d.browser.msie || d.browser.edge || d.selection.clear(), void e.originalEvent.dataTransfer.setData("text", "Froala")) : (e.preventDefault(), !1))
        }
        function c(e) {
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function() {
                for (var e = null, t = 0; t < be.FE.INSTANCES.length; t++)
                    if ((e = be.FE.INSTANCES[t].$el.find(".fr-dragging")).length)
                        return e.get(0)
                ...
                if (!c(t)) {
                    ...
                    for (var i = 0, a = t; !c(a) && a == t && e.originalEvent.pageY - d.win.pageYOffset + i < be(d.doc).height();)
                ...
                if (be(t).hasClass("fr-drag-helper"))
                    return;
                if (t && !d.node.isBlock(t) && (t = d.node.blockParent(t)), t && 0 <= ["TD", "TH", "TR", "THEAD", "TBODY"].indexOf(t.tagName) && (t = be(t).parents("table").get(0)), t && 0 <= ["LI"].indexOf(t.tagName) && (t = be(t).parents("UL, OL").get(0)), t && !be(t).hasClass("fr-drag-helper")) {
                    var o;
                    p || (be.FE.$draggable_helper || (be.FE.$draggable_helper = be('<div class="fr-drag-helper"></div>')), p = be.FE.$draggable_helper, d.events.on("shared.destroy", function() {
                        p.html("").removeData().remove(), p = null
                    }, !0)), o = e.originalEvent.pageY < be(t).offset().top + be(t).outerHeight() / 2;
                    var s = be(t),
                        l = 0;
                    o || 0 !== s.next().length ? (o || (s = s.next()), "before" == p.data("fr-position") && s.is(p.data("fr-tag")) || (0 < s.prev().length && (l = parseFloat(s.prev().css("margin-bottom")) || 0), l = Math.max(l, parseFloat(s.css("margin-top")) || 0), f(s.offset().top - l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()), p.data("fr-position", "before"))) : "after" == p.data("fr-position") && s.is(p.data("fr-tag")) || (l = parseFloat(s.css("margin-bottom")) || 0, f(s.offset().top + be(t).height() + l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()), p.data("fr-position", "after")), p.data("fr-tag", s), p.addClass("fr-visible"), p.appendTo(d.$box)
                } else
                    p && 0 < d.$box.find(p).length && p.removeClass("fr-visible")
            }(e))
        }
        function n(e) {
        ...
        function i(e) {
            var t,
                n;
            d.$el.attr("contenteditable", !0);
            for (var r = 0; r < be.FE.INSTANCES.length; r++)
                if ((t = be.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
                    n = be.FE.INSTANCES[r];
                    break
                }
            if (t.length) {
                if (e.preventDefault(), e.stopPropagation(), p && p.hasClass("fr-visible") && d.$box.find(p).length)
                    ...
                    return !1;
                if (t.removeClass("fr-dragging"), !1 === (t = d.events.chainTrigger("element.beforeDrop", t)))
                    return !1;
                var i = t;
                if (t.parent().is("A") && 1 == t.parent().get(0).childNodes.length && (i = t.parent()), d.core.isEmpty())
                    d.events.focus();
                else
                    d.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), d.selection.restore();
                if (n == d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty())
                    d.$el.html(i);
                else {
                    var a = d.markers.insert();
                    0 === i.find(a).length ? be(a).replaceWith(i) : 0 === t.find(a).length && be(a).replaceWith(t), t.after(be.FE.MARKERS), d.selection.restore()
                }
        ...
        function a(e) {
            if (e && "DIV" == e.tagName && d.node.hasClass(e, "fr-drag-helper"))
                e.parentNode.removeChild(e);
            else if (e && e.nodeType == Node.ELEMENT_NODE)
                for (var t = e.querySelectorAll("div.fr-drag-helper"), n = 0; n < t.length; n++)
                    t[n].parentNode.removeChild(t[n])
        }
        var p;
        return {
            _init: function() {
                d.opts.enter == be.FE.ENTER_BR && (d.opts.dragInline = !0), d.events.on("dragstart", e, !0), d.events.on("dragover", t, !0), d.events.on("dragenter", n, !0), d.events.on("document.dragend", r, !0), d.events.on("document.drop", r, !0), d.events.on("drop", i, !0), d.events.on("html.processGet", a)
            }
        }
    }, be.extend(be.FE.POPUP_TEMPLATES, {
        ...
        emoticonsUseImage: !0
    }), be.FE.PLUGINS.emoticons = function(m) {
        function i() {
            if (!m.selection.isCollapsed())
                return !1;
            var e = m.selection.element(),
                t = m.selection.endElement();
            if (e && m.node.hasClass(e, "fr-emoticon"))
                return e;
            if (t && m.node.hasClass(t, "fr-emoticon"))
                return t;
            ...
            if (r.nodeType == Node.ELEMENT_NODE && 0 < r.childNodes.length && 0 < n.startOffset) {
                ...
                if (m.node.hasClass(i, "fr-emoticon"))
                    return i
            }
            return !1
        }
                ...
                e(), m.events.on("html.set", e), m.events.on("keydown", function(e) {
                    if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                        var t = m.selection.ranges(0),
                            n = i();
                        m.node.hasClass(n, "fr-emoticon-img") && n && (0 === t.startOffset && m.selection.element() === n ? be(n).before(be.FE.MARKERS + be.FE.INVISIBLE_SPACE) : be(n).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS), m.selection.restore())
                    }
                }), m.events.on("keyup", function(e) {
                    for (var t = m.el.querySelectorAll(".fr-emoticon"), n = 0; n < t.length; n++)
                        "undefined" != typeof t[n].textContent && 0 === t[n].textContent.replace(/\u200B/gi, "").length && be(t[n]).remove();
                    if (!(e.which >= be.FE.KEYCODE.ARROW_LEFT && e.which <= be.FE.KEYCODE.ARROW_DOWN)) {
                        var r = i();
                        m.node.hasClass(r, "fr-emoticon-img") && (be(r).append(be.FE.MARKERS), m.selection.restore())
                    }
                })
            },
            insert: function(e, t) {
            ...
            showEmoticonsPopup: function() {
                ...
                if (t || (t = function() {
                    ...
                    return m.tooltip.bind(n, ".fr-emoticon"), g = n, m.events.on("popup.tab", function(e) {
                        var t = be(e.currentTarget);
                        if (!m.popups.isVisible("emoticons") || !t.is("span, a"))
                            return !0;
                        var n,
                            r,
                            i,
                            a = e.which;
                        if (be.FE.KEYCODE.TAB == a) {
                        ...
                        } else if (be.FE.KEYCODE.ARROW_UP == a || be.FE.KEYCODE.ARROW_DOWN == a || be.FE.KEYCODE.ARROW_LEFT == a || be.FE.KEYCODE.ARROW_RIGHT == a) {
                            if (t.is("span.fr-emoticon")) {
                                ...
                                var d = m.opts.emoticonsStep,
                                    ...
                                    u = p * d + f,
                                    h = c * d;
                                be.FE.KEYCODE.ARROW_UP == a ? u = ((u - d) % h + h) % h : be.FE.KEYCODE.ARROW_DOWN == a ? u = (u + d) % h : be.FE.KEYCODE.ARROW_LEFT == a ? u = ((u - 1) % h + h) % h : be.FE.KEYCODE.ARROW_RIGHT == a && (u = (u + 1) % h), i = be(l.get(u)), m.events.disableBlur(), i.focus(), n = !1
                            }
                        } else
                            be.FE.KEYCODE.ENTER == a && (t.is("a") ? t[0].click() : m.button.exec(t), n = !1);
    ...
    }, be.FE.DefineIcon("emoticons", {
        NAME: "smile-o",
        FA5NAME: "smile"
    }), be.FE.RegisterCommand("emoticons", {
        title: "Emoticons",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "emoticons"
    }), be.FE.RegisterCommand("insertEmoticon", {
        callback: function(e, t) {
    ...
    }), be.FE.DefineIcon("emoticonsBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("emoticonsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.PLUGINS.entities = function(i) {
        var a,
            o;
        function r(e) {
            var t = e.textContent;
        ...
        function s(e) {
            if (e && 0 <= ["STYLE", "SCRIPT", "svg", "IFRAME"].indexOf(e.tagName))
                return !0;
        ...
        return {
            _init: function() {
                ...
                var e = be("<div>").html(i.opts.entities).text(),
        ...
        function v(e) {
            ...
            try {
                if (d.opts.fileUploadToS3)
                    ...
                    var o = function(e) {
                        try {
                            if (!1 === d.events.trigger("file.uploaded", [e], !0))
                                return d.edit.on(), !1;
                            var t = JSON.parse(e);
        ...
        function o(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t,
                    n = e[0];
                if ((null === d.opts.fileUploadURL || d.opts.fileUploadURL == c) && !d.opts.fileUploadToS3)
                    return s = n, (l = new FileReader).addEventListener("load", function() {
                ...
                if (n.size > d.opts.fileMaxSize)
                    return T(u), !1;
                if (d.opts.fileAllowedTypes.indexOf("*") < 0 && d.opts.fileAllowedTypes.indexOf(n.type.replace(/file\//g, "")) < 0)
                    return T(h), !1;
                if (d.drag_support.formdata && (t = d.drag_support.formdata ? new FormData : null), t) {
                    var r;
                    if (!1 !== d.opts.fileUploadToS3)
                        for (r in t.append("key", d.opts.fileUploadToS3.keyStart + (new Date).getTime() + "-" + (n.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", n.type), d.opts.fileUploadToS3.params)
        ...
        function C(e) {
            if (e)
                return d.popups.onHide("file.insert", s), !0;
            var t;
                ...
                if (n && "undefined" != typeof n.type) {
                    if (n.type.indexOf("image") < 0) {
                        if (!d.opts.fileUpload)
                            return e.preventDefault(), e.stopPropagation(), !1;
                        d.markers.remove(), d.markers.insertAtPoint(e.originalEvent), d.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), d.popups.hideAll();
                    ...
                    n.type.indexOf("image") < 0 && (e.preventDefault(), e.stopPropagation())
            }
        }
        function S() {
            var e,
        ...
        return n[1] = "File cannot be loaded from the passed link.", n[l] = "No link in upload response.", n[f] = "Error during file upload.", n[p] = "Parsing response failed.", n[u] = "File is too large.", n[h] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function() {
                d.events.on("drop", t), d.events.$on(d.$win, "keydown", function(e) {
                    ...
                    n && t == be.FE.KEYCODE.ESC && n.trigger("abortUpload")
            ...
            showInsertPopup: function() {
                ...
                if (t || (t = C()), i(), !t.hasClass("fr-active"))
                    if (d.popups.refresh("file.insert"), d.popups.setContainer("file.insert", d.$tb), e.is(":visible")) {
                        var n = e.offset().left + e.outerWidth() / 2,
                            r = e.offset().top + (d.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
                        d.popups.show("file.insert", n, r, e.outerHeight())
                    } else
                        d.position.forSelection(t), d.popups.show("file.insert")
            },
            upload: o,
            insert: m,
            back: function() {
    ...
    }, be.FE.DefineIcon("insertFile", {
        NAME: "file-o",
        FA5NAME: "file"
    }), be.FE.RegisterCommand("insertFile", {
        title: "Upload File",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        plugin: "file"
    }), be.FE.DefineIcon("fileBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.RegisterCommand("fileDismissError", {
        title: "OK",
        callback: function() {
        ...
        function s() {
            var e = a(be(i.selection.element()).css("font-family")),
                t = [];
        ...
        return {
            ...
            refresh: function(e) {
                if (i.opts.fontFamilySelection) {
                    var t = be(i.selection.element()).css("font-family").replace(/(sans-serif|serif|monospace|cursive|fantasy)/gi, "").replace(/"|'|/g, "").split(",");
                    e.find("> span").text(i.opts.fontFamily[s()] || t[0] || i.language.translate(i.opts.fontFamilyDefaultSelection))
                }
            }
        }
    }, be.FE.RegisterCommand("fontFamily", {
        type: "dropdown",
        ...
        fontSizeUnit: "px"
    }), be.FE.PLUGINS.fontSize = function(a) {
        return {
            apply: function(e) {
                a.format.applyStyle("font-size", e)
            },
            refreshOnShow: function(e, t) {
                var n = be(a.selection.element()).css("font-size");
            ...
            refresh: function(e) {
                if (a.opts.fontSizeSelection) {
                    var t = a.helpers.getPX(be(a.selection.element()).css("font-size"));
                    "pt" === a.opts.fontSizeUnit && (t = Math.round(72 * parseFloat(t, 10) / 96) + "pt"), e.find("> span").text(t)
                }
            }
        }
    }, be.FE.RegisterCommand("fontSize", {
        type: "dropdown",
        title: "Font Size",
        displaySelection: function(e) {
    ...
    }), be.FE.PLUGINS.forms = function(a) {
        var o;
        function e(e) {
            e.preventDefault(), a.selection.clear(), be(this).data("mousedown", !0)
        }
        function t(e) {
            be(this).data("mousedown") && (e.stopPropagation(), be(this).removeData("mousedown"), l(o = this)), e.preventDefault()
        }
        function n() {
            a.$el.find("input, textarea, button").removeData("mousedown")
        }
        function r() {
            be(this).removeData("mousedown")
        }
        function s() {
            return o || null
        }
        ...
        function f(e) {
            if (e)
                return a.popups.onRefresh("forms.update", d), a.popups.onHide("forms.update", c), !0;
            var t = "";
        ...
        return {
            ...
            applyStyle: function(e, t, n) {
                ...
                if (!n) {
                    var i = Object.keys(t);
                    i.splice(i.indexOf(e), 1), be(r).removeClass(i.join(" "))
                }
                be(r).toggleClass(e)
            },
    ...
    }, be.FE.RegisterCommand("updateInput", {
        undo: !1,
        focus: !1,
        title: "Update",
        callback: function() {
    ...
    }), be.FE.DefineIcon("inputStyle", {
        NAME: "magic"
    }), be.FE.RegisterCommand("inputStyle", {
        title: "Style",
        type: "dropdown",
        html: function() {
        ...
        refreshOnShow: function(e, t) {
            ...
            if (n) {
                ...
                t.find(".fr-command").each(function() {
                    ...
                    be(this).toggleClass("fr-active", r.hasClass(e))
                })
            }
        }
    }), be.FE.DefineIcon("inputEdit", {
        NAME: "edit"
    }), be.FE.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
        refreshAfterCallback: !1,
        callback: function() {
    ...
    }), be.FE.DefineIcon("inputBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("inputBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.PLUGINS.fullscreen = function(n) {
        var t,
            r,
            i,
            a;
        ...
        return {
            _init: function() {
                if (!n.$wp)
                    return !1;
                n.events.$on(be(n.o_win), "resize", function() {
                    o() && (s(), e())
                }), n.events.on("toolbar.hide", function() {
                    if (o() && n.helpers.isMobile())
                        return !1
    ...
    }, be.FE.RegisterCommand("fullscreen", {
        title: "Fullscreen",
        undo: !1,
        focus: !1,
        ...
        plugin: "fullscreen"
    }), be.FE.DefineIcon("fullscreen", {
        NAME: "expand"
    }), be.FE.DefineIcon("fullscreenCompress", {
        NAME: "compress"
    }), be.extend(be.FE.DEFAULTS, {
        helpSets: [{
            title: "Inline Editor",
        ...
        return {
            ...
            show: function() {
                if (!r) {
                    ...
                    r = n.$modal, n.$head, n.$body, o.events.$on(be(o.o_win), "resize", function() {
                        o.modals.resize(i)
                    })
                }
    ...
    }, be.FroalaEditor.DefineIcon("help", {
        NAME: "question"
    }), be.FE.RegisterShortcut(be.FE.KEYCODE.SLASH, "help", null, "/"), be.FE.RegisterCommand("help", {
        title: "Help",
        icon: "help",
        undo: !1,
        focus: !1,
    ...
    }), be.FE.PLUGINS.image = function(c) {
        var f,
            l,
            d,
            p,
        ...
        function a() {
            ...
            if (e || (e = w()), e) {
                var t = ve();
                Ee() && (t = t.find(".fr-img-wrap")), c.popups.setContainer("image.edit", c.$sc), c.popups.refresh("image.edit");
                var n = t.offset().left + t.outerWidth() / 2,
                    r = t.offset().top + t.outerHeight();
                f.hasClass("fr-uploading") ? N() : c.popups.show("image.edit", n, r, t.outerHeight())
            }
        }
        function A() {
            O()
        ...
        function e() {
            for (var e, t, n = "IMG" == c.el.tagName ? [c.el] : c.el.querySelectorAll("img"), r = 0; r < n.length; r++) {
                var i = be(n[r]);
                !c.opts.htmlUntouched && c.opts.useClasses ? ((c.opts.imageDefaultAlign || c.opts.imageDefaultDisplay) && (0 < (t = i).parents(".fr-img-caption").length && (t = t.parents(".fr-img-caption:first")), t.hasClass("fr-dii") || t.hasClass("fr-dib") || (t.addClass("fr-fi" + pe(t)[0]), t.addClass("fr-di" + ue(t)[0]), t.css("margin", ""), t.css("float", ""), t.css("display", ""), t.css("z-index", ""), t.css("position", ""), t.css("overflow", ""), t.css("vertical-align", ""))), c.opts.imageTextNear || (0 < i.parents(".fr-img-caption").length ? i.parents(".fr-img-caption:first").removeClass("fr-dii").addClass("fr-dib") : i.removeClass("fr-dii").addClass("fr-dib"))) : c.opts.htmlUntouched || c.opts.useClasses || (c.opts.imageDefaultAlign || c.opts.imageDefaultDisplay) && (0 < (e = i).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption:first")), fe(e, e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null, e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : pe(e)), e.removeClass("fr-dib fr-dii fr-fir fr-fil")), c.opts.iframe && i.on("load", c.size.syncIframe)
            }
        }
        function C(e) {
            void 0 === e && (e = !0);
            var t,
                n = Array.prototype.slice.call(c.el.querySelectorAll("img")),
                r = [];
            for (t = 0; t < n.length; t++)
                if (r.push(n[t].getAttribute("src")), be(n[t]).toggleClass("fr-draggable", c.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && c.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
                    ...
                    a && !c.browser.mozilla && a.setAttribute("contenteditable", !0)
                }
            if (s)
                for (t = 0; t < s.length; t++)
                    r.indexOf(s[t].getAttribute("src")) < 0 && c.events.trigger("image.removed", [be(s[t])]);
            if (s && e) {
                var o = [];
                for (t = 0; t < s.length; t++)
                    o.push(s[t].getAttribute("src"));
                for (t = 0; t < n.length; t++)
                    o.indexOf(n[t].getAttribute("src")) < 0 && c.events.trigger("image.loaded", [be(n[t])])
            }
            s = n
        }
        function S() {
            if (l || function() {
                ...
                }, !0)) : (c.shared.$image_resizer = be('<div class="fr-image-resizer"></div>'), l = c.shared.$image_resizer, c.events.$on(l, "mousedown", function(e) {
                    e.stopPropagation()
                }, !0), c.opts.imageResize && (l.append(o("nw") + o("ne") + o("sw") + o("se")), c.shared.$img_overlay = be('<div class="fr-image-overlay"></div>'), p = c.shared.$img_overlay, e = l.get(0).ownerDocument, be(e).find("body:first").append(p)));
                c.events.on("shared.destroy", function() {
                    l.html("").removeData().remove(), l = null, c.opts.imageResize && (p.remove(), p = null)
                }, !0), c.helpers.isMobile() || c.events.$on(be(c.o_win), "resize", function() {
                    f && !f.hasClass("fr-uploading") ? se(!0) : f && (S(), he(), N(!1))
                });
                if (c.opts.imageResize) {
                    e = l.get(0).ownerDocument, c.events.$on(l, c._mousedown, ".fr-handler", y), c.events.$on(be(e), c._mousemove, _), c.events.$on(be(e.defaultView || e.parentWindow), c._mouseup, L), c.events.$on(p, "mouseleave", L);
                    var r = 1,
                        i = null,
                        a = 0;
                    c.events.on("keydown", function(e) {
                        if (f) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == be.FE.KEYCODE.EQUALS || c.browser.mozilla && n == be.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = Q.call(this, e, 1, 1, r) : (n == be.FE.KEYCODE.HYPHEN || c.browser.mozilla && n == be.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey ? r = Q.call(this, e, 2, -1, r) : c.keys.ctrlKey(e) || n != be.FE.KEYCODE.ENTER || (f.before("<br>"), D(f)), i = n, a = e.timeStamp
                        }
            ...
            var r = ve();
            Ee() && (r = r.find(".fr-img-wrap")), l.css("top", (c.opts.iframe ? r.offset().top : r.offset().top + t) - 1).css("left", (c.opts.iframe ? r.offset().left : r.offset().left + n) - 1).css("width", r.get(0).getBoundingClientRect().width).css("height", r.get(0).getBoundingClientRect().height).addClass("fr-active")
        }
        function o(e) {
            return '<div class="fr-handler fr-h' + e + '"></div>'
        }
        function R(e) {
            Ee() ? f.parents(".fr-img-caption").css("width", e) : f.css("width", e)
        }
        function y(e) {
            if (!c.core.sameInstance(l))
                return !0;
            if (e.preventDefault(), e.stopPropagation(), c.$el.find("img.fr-error").left)
                return !1;
            ...
            if ("mousedown" == e.type) {
                ...
                i && r.frameElement && (t += c.helpers.getPX(be(r.frameElement).offset().left) + r.frameElement.clientLeft)
            }
            (d = be(this)).data("start-x", t), d.data("start-width", f.width()), d.data("start-height", f.height());
            var a = f.width();
            if (c.opts.imageResizeWithPercent) {
                var o = f.parentsUntil(c.$el, c.html.blockTagsQuery()).get(0) || c.el;
                a = (a / be(o).outerWidth() * 100).toFixed(2) + "%"
            }
            R(a), p.show(), c.popups.hideAll(), ce()
        }
        function _(e) {
            if (!c.core.sameInstance(l))
                return !0;
            var t;
            if (d && f) {
                if (e.preventDefault(), c.$el.find("img.fr-error").left)
                    return !1;
                ...
                if ((d.hasClass("fr-hnw") || d.hasClass("fr-hsw")) && (r = 0 - r), c.opts.imageResizeWithPercent) {
                    ...
                    i = ((i + r) / be(a).outerWidth() * 100).toFixed(2), c.opts.imageRoundPercent && (i = Math.round(i)), R(i + "%"), (t = Ee() ? (c.helpers.getPX(f.parents(".fr-img-caption").css("width")) / be(a).outerWidth() * 100).toFixed(2) : (c.helpers.getPX(f.css("width")) / be(a).outerWidth() * 100).toFixed(2)) === i || c.opts.imageRoundPercent || R(t + "%"), f.css("height", "").removeAttr("height")
                } else
                    i + r >= c.opts.imageMinWidth && (R(i + r), t = Ee() ? c.helpers.getPX(f.parents(".fr-img-caption").css("width")) : c.helpers.getPX(f.css("width"))), t !== i + r && R(t), ((f.attr("style") || "").match(/(^height:)|(; *height:)/) || f.attr("height")) && (f.css("height", d.data("start-height") * f.width() / d.data("start-width")), f.removeAttr("height"));
                S(), c.events.trigger("image.resize", [me()])
            }
        }
        function L(e) {
            if (!c.core.sameInstance(l))
                return !0;
            if (d && f) {
                if (e && e.stopPropagation(), c.$el.find("img.fr-error").left)
                    return !1;
                d = null, p.hide(), S(), a(), c.undo.saveStep(), c.events.trigger("image.resizeEnd", [me()])
            }
        }
        function x(e, t, n) {
            ...
            }(c.language.translate("Something went wrong. Please try again.")), !f && n && Z(n), c.events.trigger("image.error", [{
                code: e,
                message: i[e]
            }, t, n])
        }
        function w(e) {
            if (e)
                return c.$wp && c.events.$on(c.$wp, "scroll.image-edit", function() {
                    f && c.popups.isVisible("image.edit") && (c.events.disableBlur(), a())
                }), !0;
            var t = "";
        ...
        function N(e) {
            ...
            if (t || (t = z()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), f) {
                var n = ve();
            ...
            void 0 === e && I(c.language.translate("Uploading"), 0)
        }
        function O(e) {
            var t = c.popups.get("image.insert");
            if (t && (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || c.$el.find("img.fr-error").length)) {
                if (c.events.focus(), c.$el.find("img.fr-error").length && (c.$el.find("img.fr-error").remove(), c.undo.saveStep(), c.undo.run(), c.undo.dropRedo()), !c.$wp && f) {
                    var n = f;
                    se(!0), c.selection.setAfter(n.get(0)), c.selection.restore()
                }
        ...
        function k() {
            var e = be(this);
            c.popups.hide("image.insert"), e.removeClass("fr-uploading"), e.next().is("br") && e.next().remove(), D(e), c.events.trigger("image.loaded", [e])
        }
        function F(o, e, s, l, d) {
            c.edit.off(), I(c.language.translate("Loading image")), e && (o = c.helpers.sanitizeURL(o));
            var t = new Image;
            t.onload = function() {
                var e,
                    t;
                if (l) {
                    ...
                    e.on("load", k), e.attr("src", o), c.edit.on(), C(!1), c.undo.saveStep(), c.events.disableBlur(), c.$el.blur(), c.events.trigger(n ? "image.replaced" : "image.inserted", [e, d])
                } else
                    e = P(o, s, k), C(!1), c.undo.saveStep(), c.events.disableBlur(), c.$el.blur(), c.events.trigger("image.inserted", [e, d])
            }, t.onerror = function() {
                x(r)
            }, N(c.language.translate("Loading image")), t.src = o
        }
        function M(e) {
            I(c.language.translate("Loading image"));
            var t = this.status,
                n = this.response,
                r = this.responseXML,
                i = this.responseText;
            try {
                if (c.opts.imageUploadToS3)
                    ...
                    var o = function(e) {
                        try {
                            if (!1 === c.events.trigger("image.uploaded", [e], !0))
                                return c.edit.on(), !1;
                            var t = JSON.parse(e);
        ...
        function B(e) {
            if (e.lengthComputable) {
                var t = e.loaded / e.total * 100 | 0;
                I(c.language.translate("Uploading"), t)
            }
        }
        function P(e, t, n) {
            var r,
            ...
            var o = be('<img src="' + e + '"' + i + (a ? ' style="width: ' + a + ';"' : "") + ">");
            fe(o, c.opts.imageDefaultDisplay, c.opts.imageDefaultAlign), o.on("load", n), o.on("error", function() {
                be(this).addClass("fr-error"), x(b)
        ...
        function K(e, t) {
            if (void 0 !== e && 0 < e.length) {
                if (!1 === c.events.trigger("image.beforeUpload", [e, t]))
                    return !1;
                var n,
                    r = e[0];
                if ((null === c.opts.imageUploadURL || c.opts.imageUploadURL == u) && !c.opts.imageUploadToS3)
                    return o = r, s = t || f, (l = new FileReader).addEventListener("load", function() {
                        var e = l.result;
                        if (l.result.indexOf("svg+xml") < 0) {
                            ...
                            e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {
                                type: o.type
                            })), c.image.insert(e, !1, null, s)
                        }
                    }, !1), N(), l.readAsDataURL(o), !1;
                if (r.name || (r.name = (new Date).getTime() + "." + (r.type || "image/jpeg").replace(/image\//g, "")), r.size > c.opts.imageMaxSize)
                    return x(v), !1;
                if (c.opts.imageAllowedTypes.indexOf(r.type.replace(/image\//g, "")) < 0)
                    return x(E), !1;
                if (c.drag_support.formdata && (n = c.drag_support.formdata ? new FormData : null), n) {
                    var i;
                    if (!1 !== c.opts.imageUploadToS3)
                        for (i in n.append("key", c.opts.imageUploadToS3.keyStart + (new Date).getTime() + "-" + (r.name || "untitled")), n.append("success_action_status", "201"), n.append("X-Requested-With", "xhr"), n.append("Content-Type", r.type), c.opts.imageUploadToS3.params)
                            c.opts.imageUploadToS3.params.hasOwnProperty(i) && n.append(i, c.opts.imageUploadToS3.params[i]);
                    for (i in c.opts.imageUploadParams)
                        c.opts.imageUploadParams.hasOwnProperty(i) && n.append(i, c.opts.imageUploadParams[i]);
                    ...
                    c.opts.imageUploadToS3 && (a = c.opts.imageUploadToS3.uploadURL ? c.opts.imageUploadToS3.uploadURL : "https://" + c.opts.imageUploadToS3.region + ".amazonaws.com/" + c.opts.imageUploadToS3.bucket), function(t, n, e, i) {
                        function a() {
                            var e = be(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), c.placeholder.refresh(), D(e), S(), N(), c.edit.off(), t.onload = function() {
                                M.call(t, e)
                            }, t.onerror = $, t.upload.onprogress = B, t.onabort = U, e.off("abortUpload").on("abortUpload", function() {
                        ...
                        o.addEventListener("load", function() {
                            ...
                            i ? (i.on("load", a), i.one("error", function() {
                                i.off("load"), i.attr("src", i.data("fr-old-src")), x(b)
                            }), c.edit.on(), c.undo.saveStep(), i.data("fr-old-src", i.attr("src")), i.attr("src", e)) : P(e, null, a)
                        }, !1), o.readAsDataURL(e)
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    if (!c.opts.imageUpload)
                        return e.preventDefault(), e.stopPropagation(), !1;
                    c.markers.remove(), c.markers.insertAtPoint(e.originalEvent), c.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), 0 === c.$el.find(".fr-marker").length && c.selection.setAtEnd(c.el), c.popups.hideAll();
                    var r = c.popups.get("image.insert");
                    r || (r = z()), c.popups.setContainer("image.insert", c.$sc);
                    var i = e.originalEvent.pageX,
                        a = e.originalEvent.pageY;
                    return c.opts.iframe && (a += c.$iframe.offset().top, i += c.$iframe.offset().left), c.popups.show("image.insert", i, a), N(), 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (se(!0), K(t.files)) : x(E), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        function z(e) {
            if (e)
                return c.popups.onRefresh("image.insert", T), c.popups.onHide("image.insert", A), !0;
            var t,
                n = "";
            ...
            return c.$wp && c.events.$on(c.$wp, "scroll", function() {
                f && c.popups.isVisible("image.insert") && he()
        ...
        function G() {
            ...
            e || (e = V()), O(), c.popups.refresh("image.alt"), c.popups.setContainer("image.alt", c.$sc);
            var t = ve();
            Ee() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2,
                r = t.offset().top + t.outerHeight();
        ...
        function V(e) {
            if (e)
                return c.popups.onRefresh("image.alt", Y), !0;
            var t = {
                    buttons: '<div class="fr-buttons">' + c.button.buildList(c.opts.imageAltButtons) + "</div>",
                    alt_layer: '<div class="fr-image-alt-layer fr-layer fr-active" id="fr-image-alt-layer-' + c.id + '"><div class="fr-input-line"><input id="fr-image-alt-layer-text-' + c.id + '" type="text" placeholder="' + c.language.translate("Alternative Text") + '" tabIndex="1"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageSetAlt" tabIndex="2" role="button">' + c.language.translate("Update") + "</button></div></div>"
                },
                n = c.popups.create("image.alt", t);
            return c.$wp && c.events.$on(c.$wp, "scroll.image-alt", function() {
                f && c.popups.isVisible("image.alt") && G()
            }), n
        }
        function X() {
            ...
            if (f)
                if (Ee()) {
                    var t = f.parent();
                    t.get(0).style.width || (t = f.parent().parent()), e.find('input[name="width"]').val(t.get(0).style.width).trigger("change"), e.find('input[name="height"]').val(t.get(0).style.height).trigger("change")
                } else
        ...
        function q() {
            var e = c.popups.get("image.size");
            e || (e = j()), O(), c.popups.refresh("image.size"), c.popups.setContainer("image.size", c.$sc);
            var t = ve();
            Ee() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2,
                r = t.offset().top + t.outerHeight();
        ...
        function j(e) {
            if (e)
                return c.popups.onRefresh("image.size", X), !0;
            var t = {
            ...
            return c.$wp && c.events.$on(c.$wp, "scroll.image-size", function() {
                f && c.popups.isVisible("image.size") && q()
            }), n
        }
        function Q(e, t, n, r) {
            return e.pageX = t, y.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), _.call(this, e), L.call(this, e), ++r
        }
        function Z(e) {
            (e = e || ve()) && !1 !== c.events.trigger("image.beforeRemove", [e]) && (c.popups.hideAll(), ge(), se(!0), c.undo.canDo() || c.undo.saveStep(), e.get(0) == c.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (c.selection.setBefore(e.get(0).parentNode) || c.selection.setAfter(e.get(0).parentNode) || e.parent().after(be.FE.MARKERS), be(e.get(0).parentNode).remove()) : (c.selection.setBefore(e.get(0)) || c.selection.setAfter(e.get(0)) || e.after(be.FE.MARKERS), e.remove()), c.html.fillEmptyBlocks(), c.selection.restore()), c.undo.saveStep())
        }
        function J(e) {
            var t = e.which;
            if (f && (t == be.FE.KEYCODE.BACKSPACE || t == be.FE.KEYCODE.DELETE))
                return e.preventDefault(), e.stopPropagation(), Z(), !1;
            if (f && t == be.FE.KEYCODE.ESC) {
                var n = f;
                return se(!0), c.selection.setAfter(n.get(0)), c.selection.restore(), e.preventDefault(), !1
            }
            if (f && (t == be.FE.KEYCODE.ARROW_LEFT || t == be.FE.KEYCODE.ARROW_RIGHT)) {
                var r = f.get(0);
                return se(!0), t == be.FE.KEYCODE.ARROW_LEFT ? c.selection.setBefore(r) : c.selection.setAfter(r), c.selection.restore(), e.preventDefault(), !1
            }
            return f && t != be.FE.KEYCODE.F10 && !c.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0
        }
        function ee(e) {
            if (e && "IMG" == e.tagName) {
                ...
                for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), i = 0; i < r.length; i++)
                    ee(r[i])
        }
        function te(e) {
            if (!1 === c.events.trigger("image.beforePasteUpload", [e]))
                return !1;
            f = be(e), S(), a(), he(), N(), f.one("load", function() {
                S(), N()
            });
            for (var t = atob(be(e).attr("src").split(",")[1]), n = [], r = 0; r < t.length; r++)
                n.push(t.charCodeAt(r));
        ...
        function ne() {
            c.opts.imagePaste ? c.$el.find("img[data-fr-image-pasted]").each(function(e, n) {
                if (c.opts.imagePasteProcess) {
                    ...
                    t && "auto" != t && (t += c.opts.imageResizeWithPercent ? "%" : "px"), be(n).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), fe(be(n), c.opts.imageDefaultDisplay, c.opts.imageDefaultAlign)
                }
                if (0 === n.src.indexOf("data:"))
                    te(n);
                    ...
                    r.crossOrigin = "Anonymous", r.onload = function() {
                        var e = c.o_doc.createElement("CANVAS"),
                            t = e.getContext("2d");
                        e.height = this.naturalHeight, e.width = this.naturalWidth, t.drawImage(this, 0, 0), n.src = e.toDataURL("image/png"), te(n)
                    }, r.src = (0 === n.src.indexOf("blob:") ? "" : c.opts.imageCORSProxy + "/") + n.src
                } else
                    0 !== n.src.indexOf("http") || 0 === n.src.indexOf("https://mail.google.com/mail") ? (c.selection.save(), be(n).remove(), c.selection.restore()) : be(n).removeAttr("data-fr-image-pasted")
        ...
        function re(e) {
            ...
            r && fe(r, c.opts.imageDefaultDisplay, c.opts.imageDefaultAlign), c.events.trigger("paste.after")
        }
        function ie(e) {
            if (e && e.clipboardData && e.clipboardData.items) {
                ...
                if (e.clipboardData.getData("text/rtf"))
                    ...
                    for (var n = 0; n < e.clipboardData.items.length && !(t = e.clipboardData.items[n].getAsFile()); n++)
                        ;
                if (t)
                    return r = t, (i = new FileReader).onload = re, i.readAsDataURL(r), !1
            }
            var r,
                i
        }
        ...
        function oe(e) {
            if ("false" == be(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable"))
                return !0;
            if (e && "touchend" == e.type && n)
                return !0;
            if (e && c.edit.isDisabled())
                return e.stopPropagation(), e.preventDefault(), !1;
            for (var t = 0; t < be.FE.INSTANCES.length; t++)
                be.FE.INSTANCES[t] != c && be.FE.INSTANCES[t].events.trigger("image.hideResizer");
            c.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), c.helpers.isMobile() && (c.events.disableBlur(), c.$el.blur(), c.events.enableBlur()), c.opts.iframe && c.size.syncIframe(), f = be(this), ge(), S(), a(), c.popups.areVisible() && c.events.disableBlur(), c.win.getSelection ? (c.win.getSelection().removeAllRanges(), c.win.getSelection().addRange(c.doc.createRange())) : c.selection.clear(), c.helpers.isIOS() && (c.events.disableBlur(), c.$el.blur()), c.button.bulkRefresh(), c.events.trigger("video.hideResizer")
        }
        function se(e) {
            f && (le || !0 === e) && (c.toolbar.enable(), l.removeClass("fr-active"), c.popups.hide("image.edit"), f = null, ce(), d = null, p && p.hide())
        }
        ...
        var le = !(i[b] = "Image file is corrupted.");
        function de() {
            le = !0
        }
        function ce() {
        ...
        function pe(e) {
            if (void 0 === e && (e = ve()), e) {
                ...
                if (e.css("float", "none"), "block" == e.css("display")) {
                    if (e.css("float", ""), e.css("float") != t && e.css("float", t), 0 === parseInt(e.css("margin-left"), 10))
                        return "left";
                    if (0 === parseInt(e.css("margin-right"), 10))
                        return "right"
                } else {
                    if (e.css("float", ""), e.css("float") != t && e.css("float", t), "left" == e.css("float"))
                        return "left";
        ...
        function he() {
            ...
            e || (e = z()), c.popups.isVisible("image.insert") || (O(), c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$sc));
            var t = ve();
            Ee() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2,
                r = t.offset().top + t.outerHeight();
        ...
        function ve() {
            return Ee() ? f.parents(".fr-img-caption:first") : f
        }
        function Ee() {
        ...
        return {
            _init: function() {
                ...
                c.events.$on(c.$el, c._mousedown, "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                    ...
                    if (e.shiftKey && "" === c.selection.text().replace(/\n/g, "") && c.keys.isArrow(e.which)) {
                        ...
                        t && "IMG" == t.tagName ? D(be(t)) : n && "IMG" == n.tagName && D(be(n))
                    }
                }, !0), c.events.on("drop", W), c.events.on("element.beforeDrop", H), c.events.on("mousedown window.mousedown", de), c.events.on("window.touchmove", ce), c.events.on("mouseup window.mouseup", function() {
                    if (f)
                        return se(), !1;
                    ce()
                    ...
                    f && (ge(), c.selection.clear())
                }), c.events.on("image.resizeEnd", function() {
                    c.win.getSelection && D(f)
                }), "IMG" == c.el.tagName && c.$el.addClass("fr-view"), c.events.$on(c.$el, c.helpers.isMobile() && !c.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', oe), c.helpers.isMobile() && (c.events.$on(c.$el, "touchstart", "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                    n = !1
                }), c.events.$on(c.$el, "touchmove", function() {
                    n = !0
                })), c.$wp ? (c.events.on("window.keydown keydown", J, !0), c.events.on("keyup", function(e) {
                    if (f && e.which == be.FE.KEYCODE.ENTER)
                        return !1
                }, !0), c.events.$on(c.$el, "keydown", function() {
                    var e = c.selection.element();
                    e.nodeType === Node.TEXT_NODE && (e = e.parentNode), c.node.hasClass(e, "fr-inner") || (c.node.hasClass(e, "fr-img-caption") || (e = be(e).parents(".fr-img-caption").get(0)), be(e).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS), c.selection.restore())
                })) : c.events.$on(c.$win, "keydown", J), c.events.on("toolbar.esc", function() {
                    if (f) {
                        if (c.$wp)
                            c.events.disableBlur(), c.events.focus();
                        else {
                            var e = f;
                            se(!0), c.selection.setAfter(e.get(0)), c.selection.restore()
                        }
                        return !1
                    }
                    ...
                    if (f && c.popups.isVisible("image.edit") && !c.popups.get("image.edit").find(":focus").length) {
                        var t = ve();
                        Ee() ? (t.before(be.FE.START_MARKER), t.after(be.FE.END_MARKER), c.selection.restore(), c.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ge(), c.paste.saveCopiedText(f.get(0).outerHTML, f.attr("alt"))), "copy" == e.type ? setTimeout(function() {
                            D(f)
                        }) : (se(!0), c.undo.saveStep(), setTimeout(function() {
                            c.undo.saveStep()
                        }, 0))
                    }
                }, !0), c.browser.msie && c.events.on("keydown", function(e) {
                    if (!c.selection.isCollapsed() || !f)
                        return !0;
                    var t = e.which;
                    t == be.FE.KEYCODE.C && c.keys.ctrlKey(e) ? c.events.trigger("window.copy") : t == be.FE.KEYCODE.X && c.keys.ctrlKey(e) && c.events.trigger("window.cut")
                }), c.events.$on(be(c.o_win), "keydown", function(e) {
                    var t = e.which;
                    if (f && t == be.FE.KEYCODE.BACKSPACE)
                        return e.preventDefault(), !1
                }), c.events.$on(c.$win, "keydown", function(e) {
                    var t = e.which;
                    f && f.hasClass("fr-uploading") && t == be.FE.KEYCODE.ESC && f.trigger("abortUpload")
                }), c.events.on("destroy", function() {
                    f && f.hasClass("fr-uploading") && f.trigger("abortUpload")
                }), c.events.on("paste.before", ie), c.events.on("paste.beforeCleanup", ae), c.events.on("paste.after", ne), c.events.on("html.set", e), c.events.on("html.inserted", e), e(), c.events.on("destroy", function() {
                    s = []
                }), c.events.on("html.processGet", ee), c.opts.imageOutputSize && c.events.on("html.beforeGet", function() {
                    r = c.el.querySelectorAll("img");
                    for (var e = 0; e < r.length; e++) {
                        var t = r[e].style.width || be(r[e]).width(),
                            n = r[e].style.height || be(r[e]).height();
                        t && r[e].setAttribute("width", ("" + t).replace(/px/, "")), n && r[e].setAttribute("height", ("" + n).replace(/px/, ""))
                    }
                }), c.opts.iframe && c.events.on("image.loaded", c.size.syncIframe), c.$wp && (C(), c.events.on("contentChanged", C)), c.events.$on(be(c.o_win), "orientationchange.image", function() {
                    setTimeout(function() {
                        f && D(f)
                    }, 100)
                }), w(!0), z(!0), j(!0), V(!0), c.events.on("node.remove", function(e) {
            ...
            showInsertPopup: function() {
                ...
                if (t || (t = z()), O(), !t.hasClass("fr-active"))
                    if (c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$tb), e.is(":visible")) {
                        ...
                        c.position.forSelection(t), c.popups.show("image.insert")
            },
            showLayer: function(e) {
                var t,
                    n,
                    r = c.popups.get("image.insert");
                if (f || c.opts.toolbarInline) {
                    if (f) {
                        var i = ve();
                        Ee() && (i = i.find(".fr-img-wrap")), n = i.offset().top + i.outerHeight(), t = i.offset().left + i.outerWidth() / 2
                    }
                } else {
            ...
            insertByURL: function() {
                var e = c.popups.get("image.insert").find(".fr-image-by-url-layer input");
                if (0 < e.val().length) {
                    N(), I(c.language.translate("Loading image"));
                    var t = e.val();
            ...
            align: function(e) {
                var t = ve();
                t.removeClass("fr-fir fr-fil"), !c.opts.htmlUntouched && c.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : fe(t, ue(), e), ge(), S(), a(), c.selection.clear()
            },
            refreshAlign: function(e) {
                f && e.find("> *:first").replaceWith(c.icon.create("image-align-" + pe()))
            },
            ...
            display: function(e) {
                var t = ve();
                t.removeClass("fr-dii fr-dib"), !c.opts.htmlUntouched && c.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : fe(t, e, pe()), ge(), S(), a(), c.selection.clear()
            },
            refreshDisplayOnShow: function(e, t) {
                f && t.find('.fr-command[data-param1="' + ue() + '"]').addClass("fr-active").attr("aria-selected", !0)
            },
            replace: he,
            back: function() {
                f ? (c.events.disableBlur(), be(".fr-popup input:focus").blur(), D(f)) : (c.events.disableBlur(), c.selection.restore(), c.events.enableBlur(), c.popups.hide("image.insert"), c.toolbar.showInline())
            },
            get: me,
            getEl: ve,
            insert: F,
            ...
            hideProgressBar: O,
            applyStyle: function(e, t, n) {
                if (void 0 === t && (t = c.opts.imageStyles), void 0 === n && (n = c.opts.imageMultipleStyles), !f)
                    return !1;
                var r = ve();
                if (!n) {
                    var i = Object.keys(t);
                ...
                "object" == typeof t[e] ? (r.removeAttr("style"), r.css(t[e].style)) : r.toggleClass(e), D(f)
            },
            showAltPopup: G,
            showSizePopup: q,
            setAlt: function(e) {
                if (f) {
                    ...
                    f.attr("alt", e || t.find("input").val() || ""), t.find("input:focus").blur(), D(f)
                }
            },
            setSize: function(e, t) {
                if (f) {
                    ...
                    var r = /^[\d]+((px)|%)*$/g;
                    f.removeAttr("width").removeAttr("height"), e.match(r) ? f.css("width", e) : f.css("width", ""), t.match(r) ? f.css("height", t) : f.css("height", ""), Ee() && (f.parent().removeAttr("width").removeAttr("height"), e.match(r) ? f.parent().css("width", e) : f.parent().css("width", ""), t.match(r) ? f.parent().css("height", t) : f.parent().css("height", "")), n && n.find("input:focus").blur(), D(f)
                }
            },
            toggleCaption: function() {
                var e;
                if (f && !Ee()) {
                    (e = f).parent().is("a") && (e = f.parent());
                    var t = e.width();
                    e.wrap("<span " + (c.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + f.attr("class") + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), e.after('<span class="fr-inner"' + (c.browser.mozilla ? "" : ' contenteditable="true"') + ">" + be.FE.START_MARKER + "Image caption" + be.FE.END_MARKER + "</span>"), f.removeAttr("class").removeAttr("style").removeAttr("width"), f.parents(".fr-img-caption").css("width", t + "px"), se(!0), c.selection.restore()
                } else
                    e = ve(), f.insertAfter(e), f.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), D(f)
            },
            hasCaption: Ee,
            exitEdit: se,
            edit: D
    ...
    }), be.FE.PLUGINS.imageManager = function(s) {
        var l,
            d,
            r,
            i,
        ...
        function t(i) {
            var a = new Image,
                o = be('<div class="fr-image-container fr-empty fr-image-' + u++ + '" data-loading="' + s.language.translate("Loading") + '.." data-deleting="' + s.language.translate("Deleting") + '..">');
            w(!1), a.onload = function() {
                ...
                if (i.url && n.attr("data-url", i.url), i.tag)
                    if (d.find(".fr-modal-more.fr-not-available").removeClass("fr-not-available"), d.find(".fr-modal-tags").show(), 0 <= i.tag.indexOf(",")) {
                        ...
                        0 === c.find('a[title="' + i.tag.trim() + '"]').length && c.append('<a role="button" title="' + i.tag.trim() + '">' + i.tag.trim() + "</a>"), n.attr("data-tag", i.tag.trim());
                for (var r in i.name && n.attr("alt", i.name), i)
                    i.hasOwnProperty(r) && "thumb" != r && "url" != r && "tag" != r && n.attr("data-" + r, i[r]);
                o.append(n).append(be(s.icon.create("imageManagerDelete")).addClass("fr-delete-img").attr("title", s.language.translate("Delete"))).append(be(s.icon.create("imageManagerInsert")).addClass("fr-insert-img").attr("title", s.language.translate("Insert"))), c.find(".fr-selected-tag").each(function(e, t) {
                    $(n, t.text) || o.hide()
                }), n.on("load", function() {
        ...
        function L(e) {
            ...
            for (var t = [], n = u - 1; e <= n; n--) {
                ...
                r.length && (t.push(r), be('<div id="fr-image-hidden-container">').append(r), a.find(".fr-image-" + n).remove())
            }
            return t
        }
        function x(e) {
        ...
        function w(e) {
            if (e === undefined && (e = !0), !l.is(":visible"))
                return !0;
            var t = S();
            if (t != h) {
                h = t;
        ...
        function I(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), be.ajax({
                ...
                n.parent().remove(), x(t), l.find("#fr-modal-tags > a").each(function() {
                    0 === l.find('#fr-image-list [data-tag*="' + be(this).text() + '"]').length && be(this).removeClass("fr-selected-tag").hide()
                }), F(), w(!0)
            }).fail(function(e) {
        ...
        function D(e, t) {
            10 <= e && e < 20 ? i.hide() : 20 <= e && e < 30 && be(".fr-image-deleting").removeClass("fr-image-deleting"), s.events.trigger("imageManager.error", [{
                code: e,
                message: n[e]
            }, t])
        }
        ...
        return n[e] = "Image cannot be loaded from the passed link.", n[m] = "Error during load images request.", n[v] = "Missing imageManagerLoadURL option.", n[E] = "Parsing load response failed.", n[b] = "Missing image thumb.", n[T] = "Missing image URL.", n[A] = "Error during delete image request.", n[C] = "Missing imageManagerDeleteURL option.", {
            ...
            show: function() {
                ...
                l.data("current-image", s.image.get()), s.modals.show(g), i || (i = l.find("#fr-preloader"), a = l.find("#fr-image-list"), c = l.find("#fr-modal-tags"), h = S(), R(), d.css("height", d.find(".fr-modal-head-line").outerHeight()), s.events.$on(be(s.o_win), "resize", function() {
                    w(!!o)
                }), s.helpers.isMobile() && (s.events.bindClick(a, "div.fr-image-container", function(e) {
                    l.find(".fr-mobile-selected").removeClass("fr-mobile-selected"), be(e.currentTarget).addClass("fr-mobile-selected")
                ...
                }), r.on("scroll", y), s.events.bindClick(l, "i#fr-modal-more-" + s.sid, k), s.events.bindClick(c, "a", M)), i.show(), a.find(".fr-list-column").empty(), s.opts.imageManagerLoadURL ? be.ajax({
    ...
    be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
        title: "Browse",
        undo: !1,
        focus: !1,
        modal: !0,
        ...
        plugin: "imageManager"
    }), be.FE.DefineIcon("imageManager", {
        NAME: "folder"
    }), be.FE.DefineIcon("imageManagerInsert", {
        NAME: "plus"
    }), be.FE.DefineIcon("imageManagerDelete", {
        NAME: "trash"
    }), be.extend(be.FE.DEFAULTS, {
        inlineClasses: {
            "fr-class-code": "Code",
    ...
    }), be.FE.PLUGINS.inlineClass = function(n) {
        return {
            apply: function(e) {
    ...
    }, be.FE.RegisterCommand("inlineClass", {
        type: "dropdown",
        title: "Inline Class",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }), be.FE.PLUGINS.inlineStyle = function(i) {
        return {
            apply: function(e) {
                if ("" !== i.selection.text())
                    ...
                    i.html.insert('<span style="' + e + '">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>")
            }
        }
    }, be.FE.RegisterCommand("inlineStyle", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = this.opts.inlineStyles;
            for (var n in t)
                t.hasOwnProperty(n) && (e += '<li role="presentation"><span style="' + t[n] + '" role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="inlineStyle" data-param1="' + t[n] + '" title="' + this.language.translate(n) + '">' + this.language.translate(n) + "</a></span></li>");
            return e += "</ul>"
        },
        title: "Inline Style",
        callback: function(e, t) {
        ...
        function s(e, t) {
            var n,
                ...
                d;
            if (null == e)
                o = (a = t.parent()).offset().top, n = (l = t.offset().top) - Math.min((l - o) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left;
            else if (null == t)
                (s = (a = e.parent()).offset().top + a.outerHeight()) < (d = e.offset().top + e.outerHeight()) && (s = (a = be(a).parent()).offset().top + a.outerHeight()), n = d + Math.min(Math.abs(s - d) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left;
            else {
                a = e.parent();
        ...
        function l(e) {
            if (e) {
                var t = be(e);
                if (0 === p.$el.find(t).length)
                    return null;
                if (e.nodeType != Node.TEXT_NODE && t.is(p.opts.lineBreakerTags.join(",")))
                    return t;
                if (0 < t.parents(p.opts.lineBreakerTags.join(",")).length)
                    return e = t.parents(p.opts.lineBreakerTags.join(",")).get(0), 0 !== p.$el.find(e).length && be(e).is(p.opts.lineBreakerTags.join(",")) ? be(e) : null
            }
            return null
        }
        function a(e, t) {
            var n = p.doc.elementFromPoint(e, t);
            return n && !be(n).closest(".fr-line-breaker").length && !p.node.isElement(n) && n != p.$wp.get(0) && function(e) {
        ...
        return {
            _init: function() {
                ...
                p.shared.$line_breaker || (p.shared.$line_breaker = be('<div class="fr-line-breaker"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + p.language.translate("Break") + '"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="21" y="11" width="2" height="8"/><rect x="14" y="17" width="7" height="2"/><path d="M14.000,14.000 L14.000,22.013 L9.000,18.031 L14.000,14.000 Z"/></svg></a></div>')), u = p.shared.$line_breaker, p.events.on("shared.destroy", function() {
                    ...
                    e.stopPropagation()
                }, !0), p.events.bindClick(u, "a", h), t = !1, p.events.$on(p.$win, "mousemove", e), p.events.$on(be(p.win), "scroll", r), p.events.on("popups.show.table.edit", r), p.events.on("commands.after", r), p.events.$on(be(p.win), "mousedown", c), p.events.$on(be(p.win), "mouseup", f)
            }
        }
    }, be.extend(be.FE.DEFAULTS, {
        lineHeights: {
    ...
    }), be.FE.PLUGINS.lineHeight = function(i) {
        return {
            _init: function() {},
            apply: function(e) {
                i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
                ...
                i.selection.save();
                for (var n = 0; n < t.length; n++)
                    be(t[n]).css("line-height", e), "" === be(t[n]).attr("style") && be(t[n]).removeAttr("style");
    ...
    }, be.FE.RegisterCommand("lineHeight", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
        ...
        function p() {
            ...
            if (!e && f.$wp) {
                ...
                "A" == n.tagName || f.node.isElement(n) || (n = be(n).parentsUntil(f.$el, "a:first").get(0)), "A" == r.tagName || f.node.isElement(r) || (r = be(r).parentsUntil(f.$el, "a:first").get(0));
                try {
        ...
        function u() {
            var e,
                ...
                a = [];
            if (i)
                "A" == i.get(0).parentNode.tagName && a.push(i.get(0).parentNode);
            else if (f.win.getSelection) {
                var o = f.win.getSelection();
                if (o.getRangeAt && o.rangeCount) {
                    r = f.doc.createRange();
                    for (var s = 0; s < o.rangeCount; ++s)
                        if ((t = (e = o.getRangeAt(s)).commonAncestorContainer) && 1 != t.nodeType && (t = t.parentNode), t && "a" == t.nodeName.toLowerCase())
                            a.push(t);
                        else {
                ...
                if ("a" == (t = (e = f.doc.selection.createRange()).parentElement()).nodeName.toLowerCase())
                    a.push(t);
                else {
        ...
        function h(i) {
            if (f.core.hasFocus()) {
                if (o(), i && "keyup" === i.type && (i.altKey || i.which == be.FE.KEYCODE.ALT))
                    return !0;
                setTimeout(function() {
                        ...
                        if (e && !t) {
                            if (f.image) {
                                ...
                                if (1 == n.length && "IMG" == n[0].tagName) {
                                    ...
                                    return 0 === r.startOffset && 0 === r.endOffset ? be(e).before(be.FE.MARKERS) : be(e).after(be.FE.MARKERS), f.selection.restore(), !1
                                }
                            }
        ...
        function a(e) {
            ...
            var r = n.offset().left + be(e).outerWidth() / 2,
                i = n.offset().top + n.outerHeight();
        ...
        function d() {
            ...
            if (t) {
                ...
                for (n = 0; n < a.length; n++)
                    (r = be(a[n])).val(i.attr(r.attr("name") || ""));
                for (o.prop("checked", !1), n = 0; n < o.length; n++)
                    r = be(o[n]), i.attr(r.attr("name")) == r.data("checked") && r.prop("checked", !0);
                e.find('input.fr-link-attr[type="text"][name="text"]').val(i.text())
            } else
                e.find('input.fr-link-attr[type="text"]').val(""), e.find('input.fr-link-attr[type="checkbox"]').prop("checked", !1), e.find('input.fr-link-attr[type="text"][name="text"]').val(f.selection.text());
        ...
        function s(e) {
            if (e)
                return f.popups.onRefresh("link.insert", d), f.popups.onHide("link.insert", l), !0;
            var t = "";
        ...
        function c(e, t, n) {
            if (void 0 === n && (n = {}), !1 === f.events.trigger("link.beforeInsert", [e, t, n]))
                return !1;
            ...
            if ("" === f.opts.linkAutoPrefix || new RegExp("^(" + be.FE.LinkProtocols.join("|") + "):.", "i").test(e) || /^data:image.*/i.test(e) || /^(https?:|ftps?:|file:|)\/\//i.test(e) || /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) || ["/", "{", "[", "#", "(", "."].indexOf((e || "")[0]) < 0 && (e = f.opts.linkAutoPrefix + f.helpers.sanitizeURL(e)), e = f.helpers.sanitizeURL(e), f.opts.linkAlwaysBlank && (n.target = "_blank"), f.opts.linkAlwaysNoFollow && (n.rel = "nofollow"), f.helpers.isEmail(i) && (n.target = null, n.rel = null), "_blank" == n.target ? (f.opts.linkNoOpener && (n.rel ? n.rel += " noopener" : n.rel = "noopener"), f.opts.linkNoReferrer && (n.rel ? n.rel += " noreferrer" : n.rel = "noreferrer")) : null == n.target && (n.rel ? n.rel = n.rel.replace(/noopener/, "").replace(/noreferrer/, "") : n.rel = null), t = t || "", e === f.opts.linkAutoPrefix)
                return f.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"), f.events.trigger("link.bad", [i]), !1;
            var a,
                o = p();
            if (o) {
                if ((a = be(o)).attr("href", e), 0 < t.length && a.text() != t && !r) {
                    for (var s = a.get(0); 1 === s.childNodes.length && s.childNodes[0].nodeType == Node.ELEMENT_NODE;)
                        s = s.childNodes[0];
                    be(s).text(t)
                }
                r || a.prepend(be.FE.START_MARKER).append(be.FE.END_MARKER), a.attr(n), r || f.selection.restore()
            } else {
                r ? r.wrap('<a href="' + e + '"></a>') : (f.format.remove("a"), f.selection.isCollapsed() ? (t = 0 === t.length ? i : t, f.html.insert('<a href="' + e + '">' + be.FE.START_MARKER + t.replace(/&/g, "&amp;") + be.FE.END_MARKER + "</a>"), f.selection.restore()) : 0 < t.length && t != f.selection.text().replace(/\n/g, "") ? (f.selection.remove(), f.html.insert('<a href="' + e + '">' + be.FE.START_MARKER + t.replace(/&/g, "&amp;") + be.FE.END_MARKER + "</a>"), f.selection.restore()) : (!function() {
                ...
                for (var l = u(), d = 0; d < l.length; d++)
                    (a = be(l[d])).attr(n), a.removeAttr("_moz_dirty");
                1 == l.length && f.$wp && !r && (be(l[0]).prepend(be.FE.START_MARKER).append(be.FE.END_MARKER), f.selection.restore())
            }
            if (r) {
        ...
        function g() {
            ...
            if (e) {
                ...
                var n = (f.image ? f.image.get() : null) || be(e),
        ...
        return {
            _init: function() {
                f.events.on("keyup", function(e) {
                    ...
                    if (f.popups.isVisible("link.edit"))
                        return f.events.disableBlur(), f.events.focus(), !1
                }, !0)
            },
            remove: function() {
                var e = p(),
                    t = f.image ? f.image.get() : null;
                if (!1 === f.events.trigger("link.beforeRemove", [e]))
                    return !1;
                t && e ? (t.unwrap(), f.image.edit(t)) : e && (f.selection.save(), be(e).replaceWith(be(e).html()), f.selection.restore(), o())
            },
            showInsertPopup: function() {
                ...
                if (t || (t = s()), !t.hasClass("fr-active"))
                    if (f.popups.refresh("link.insert"), f.popups.setContainer("link.insert", f.$tb || f.$sc), e.is(":visible")) {
                        ...
                        f.position.forSelection(t), f.popups.show("link.insert")
            },
            usePredefined: function(e) {
                ...
                for (n = 0; n < a.length; n++)
                    r[(t = be(a[n])).attr("name")] ? t.val(r[t.attr("name")]) : "text" != t.attr("name") && t.val("");
                for (n = 0; n < o.length; n++)
                    (t = be(o[n])).prop("checked", t.data("checked") == r[t.attr("name")]);
            ...
            insertCallback: function() {
                var e,
                    ...
                    s = {};
                for (t = 0; t < r.length; t++)
                    e = be(r[t]), ["href", "text"].indexOf(e.attr("name")) < 0 && (s[e.attr("name")] = e.val());
                for (t = 0; t < i.length; t++)
                    (e = be(i[t])).is(":checked") ? s[e.attr("name")] = e.data("checked") : s[e.attr("name")] = e.data("unchecked") || null;
                var l = f.helpers.scrollTop();
                c(a, o, s), be(f.o_win).scrollTop(l)
            },
            insert: c,
            update: g,
            get: p,
            ...
            applyStyle: function(e, t, n) {
                ...
                be(r).toggleClass(e), h()
            }
        }
    }, be.FE.DefineIcon("insertLink", {
        NAME: "link"
    }), be.FE.RegisterShortcut(be.FE.KEYCODE.K, "insertLink", null, "K"), be.FE.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkOpen", {
        NAME: "external-link",
        FA5NAME: "external-link-alt"
    }), be.FE.RegisterCommand("linkOpen", {
        title: "Open Link",
        undo: !1,
        refresh: function(e) {
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkEdit", {
        NAME: "edit"
    }), be.FE.RegisterCommand("linkEdit", {
        title: "Edit Link",
        undo: !1,
        refreshAfterCallback: !1,
        popup: !0,
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkRemove", {
        NAME: "unlink"
    }), be.FE.RegisterCommand("linkRemove", {
        title: "Unlink",
        callback: function() {
            this.link.remove()
        },
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkList", {
        NAME: "search"
    }), be.FE.RegisterCommand("linkList", {
        title: "Choose Link",
        type: "dropdown",
        focus: !1,
        undo: !1,
        ...
        plugin: "link"
    }), be.FE.RegisterCommand("linkInsert", {
        focus: !1,
        refreshAfterCallback: !1,
        callback: function() {
        ...
        plugin: "link"
    }), be.FE.DefineIcon("imageLink", {
        NAME: "link"
    }), be.FE.RegisterCommand("imageLink", {
        title: "Insert Link",
        undo: !1,
        focus: !1,
        popup: !0,
        ...
        plugin: "link"
    }), be.FE.DefineIcon("linkStyle", {
        NAME: "magic"
    }), be.FE.RegisterCommand("linkStyle", {
        title: "Style",
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
        ...
        listAdvancedTypes: !0
    }), be.FE.PLUGINS.lists = function(f) {
        function p(e) {
        ...
        function i(e, t) {
            ...
            var n,
                r = f.html.defaultTag(),
                i = null;
            e.length && (n = "rtl" == f.opts.direction || "rtl" == be(e[0]).css("direction") ? "margin-right" : "margin-left");
            for (var a = 0; a < e.length; a++)
                if ("LI" != e[a].tagName) {
                    var o = f.helpers.getPX(be(e[a]).css(n)) || 0;
                    (e[a].style.marginLeft = null) === i && (i = o);
                    var s = 0 < i ? "<" + t + ' style="' + n + ": " + i + 'px;">' : "<" + t + ">",
                        l = "</" + t + ">";
                    for (o -= i; 0 < o / f.opts.indentMargin;)
                        s += "<" + t + ">", l += l, o -= f.opts.indentMargin;
                    r && e[a].tagName.toLowerCase() == r ? be(e[a]).replaceWith(s + "<li" + f.node.attributes(e[a]) + ">" + be(e[a]).html() + "</li>" + l) : be(e[a]).wrap(s + "<li></li>" + l)
                }
            f.clean.lists()
        }
        function a(e) {
            ...
            for (t = e.length - 1; 0 <= t; t--)
                for (n = t - 1; 0 <= n; n--)
                    if (be(e[n]).find(e[t]).length || e[n] == e[t]) {
                        e.splice(t, 1);
                        break
                    }
            var r = [];
            for (t = 0; t < e.length; t++) {
                var i = be(e[t]),
                    a = e[t].parentNode,
                    o = i.attr("class");
                if (i.before(u(a.tagName)), "LI" == a.parentNode.tagName)
                    i.before(u("LI")), i.after(p("LI"));
                else {
                    var s = "";
                    o && (s += ' class="' + o + '"');
                    var l = "rtl" == f.opts.direction || "rtl" == i.css("direction") ? "margin-right" : "margin-left";
                    f.helpers.getPX(be(a).css(l)) && 0 <= (be(a).attr("style") || "").indexOf(l + ":") && (s += ' style="' + l + ":" + f.helpers.getPX(be(a).css(l)) + 'px;"'), f.html.defaultTag() && 0 === i.find(f.html.blockTagsQuery()).length && i.wrapInner("<" + f.html.defaultTag() + s + "></" + f.html.defaultTag() + ">"), f.node.isEmpty(i.get(0), !0) || 0 !== i.find(f.html.blockTagsQuery()).length || i.append("<br>"), i.append(p("LI")), i.prepend(u("LI"))
                }
        ...
        function o(e) {
            ...
            for (var t = 0; t < e.length; t++) {
                ...
                if (n) {
                    var r = be(e[t]).find("> ul, > ol").last().get(0);
                    if (r) {
                        for (var i = be("<li>").prependTo(be(r)), a = f.node.contents(e[t])[0]; a && !f.node.isList(a);) {
                            var o = a.nextSibling;
                            i.append(a), a = o
                        }
                        be(n).append(be(r)), be(e[t]).remove()
                    } else {
                        var s = be(n).find("> ul, > ol").last().get(0);
                        if (s)
                            be(s).append(be(e[t]));
                        else {
                            var l = be("<" + e[t].parentNode.tagName + ">");
                            be(n).append(l), l.append(be(e[t]))
                        }
                    }
                }
            }
        ...
        return {
            _init: function() {
                f.events.on("commands.after", e), f.events.on("keydown", function(e) {
                    if (e.which == be.FE.KEYCODE.TAB) {
                        for (var t = f.selection.blocks(), n = [], r = 0; r < t.length; r++)
                            "LI" == t[r].tagName ? n.push(t[r]) : "LI" == t[r].parentNode.tagName && n.push(t[r].parentNode);
                        if (1 < n.length || n.length && (f.selection.info(n[0]).atStart || f.node.isEmpty(n[0])))
                            return e.preventDefault(), e.stopPropagation(), e.shiftKey ? s(n) : o(n), !1
                    }
                }, !0)
            },
            format: function(e, t) {
                ...
                if (f.selection.save(), function(e, t) {
                    ...
                    for (n = 0; n < r.length; n++)
                        "LI" == r[n].tagName && (be(r[n].parentNode).css("list-style-type", t), 0 === (be(r[n].parentNode).attr("style") || "").length && be(r[n].parentNode).removeAttr("style"))
                }
            },
            refresh: function(e, t) {
                var n = be(f.selection.element());
                if (n.get(0) != f.el) {
                    var r = n.get(0);
    ...
    }, be.FE.RegisterCommand("formatUL", {
        ...
        plugin: "lists"
    }), be.FE.RegisterCommand("formatOL", {
        title: "Ordered List",
        hasOptions: function() {
            return this.opts.listAdvancedTypes
        },
        ...
        plugin: "lists"
    }), be.FE.DefineIcon("formatUL", {
        NAME: "list-ul"
    }), be.FE.DefineIcon("formatOL", {
        NAME: "list-ol"
    }), be.extend(be.FE.DEFAULTS, {
        paragraphFormat: {
            N: "Normal",
    ...
    }), be.FE.PLUGINS.paragraphFormat = function(p) {
        function u(e, t) {
        ...
        return {
            apply: function(e) {
                ...
                p.$el.find('pre:not([skip="true"]) + pre:not([skip="true"])').each(function() {
                    be(this).prev().append("<br>" + be(this).html()), be(this).remove()
            ...
            refreshOnShow: function(e, t) {
                ...
                if (n.length) {
                    ...
                    t.find('.fr-command[data-param1="N"]').addClass("fr-active").attr("aria-selected", !0)
            },
            refresh: function(e) {
                if (p.opts.paragraphFormatSelection) {
                    ...
                    if (t.length) {
                        ...
                        e.find("> span").text(p.language.translate(p.opts.paragraphFormat.N))
                }
            }
        }
    }, be.FE.RegisterCommand("paragraphFormat", {
        type: "dropdown",
        displaySelection: function(e) {
    ...
    }), be.FE.DefineIcon("paragraphFormat", {
        NAME: "paragraph"
    }), be.extend(be.FE.DEFAULTS, {
        paragraphStyles: {
            "fr-text-gray": "Gray",
    ...
    }), be.FE.PLUGINS.paragraphStyle = function(s) {
        return {
            _init: function() {},
            apply: function(e, t, n) {
                ...
                s.selection.save();
                for (var a = be(i[0]).hasClass(e), o = 0; o < i.length; o++)
                    be(i[o]).removeClass(r).toggleClass(e, !a), be(i[o]).hasClass("fr-temp-div") && be(i[o]).removeClass("fr-temp-div"), "" === be(i[o]).attr("class") && be(i[o]).removeAttr("class");
    ...
    }, be.FE.RegisterCommand("paragraphStyle", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }), be.FE.DefineIcon("paragraphStyle", {
        NAME: "magic"
    }), be.extend(be.FE.DEFAULTS, {
        html2pdf: window.html2pdf
    }), be.FE.PLUGINS.print = function(s) {
        return {
            run: function() {
                !function(e) {
                    var t = s.$el.html(),
    ...
    }, be.FE.DefineIcon("print", {
        NAME: "print"
    }), be.FE.RegisterCommand("print", {
        title: "Print",
        undo: !1,
        focus: !1,
        plugin: "print",
    ...
    }), be.FE.DefineIcon("getPDF", {
        NAME: "file-pdf-o",
        FA5NAME: "file-pdf"
    }), be.FE.RegisterCommand("getPDF", {
        title: "Download PDF",
        type: "button",
        focus: !1,
        undo: !1,
    ...
    }), be.FE.QUICK_INSERT_BUTTONS = {}, be.FE.DefineIcon("quickInsert", {
        ...
        template: "svg"
    }), be.FE.RegisterQuickInsertButton = function(e, t) {
        be.FE.QUICK_INSERT_BUTTONS[e] = be.extend({
            undo: !0
        }, t)
    }, be.FE.RegisterQuickInsertButton("image", {
        icon: "insertImage",
        ...
        callback: function() {
            var e = this;
            e.shared.$qi_image_input || (e.shared.$qi_image_input = be('<input accept="image/*" name="quickInsertImage' + this.id + '" style="display: none;" type="file">'), be("body:first").append(e.shared.$qi_image_input), e.events.$on(e.shared.$qi_image_input, "change", function() {
                var e = be(this).data("inst");
                this.files && (e.quickInsert.hide(), e.image.upload(this.files)), be(this).val("")
    ...
    }), be.FE.RegisterQuickInsertButton("video", {
        icon: "insertVideo",
    ...
    }), be.FE.RegisterQuickInsertButton("embedly", {
        icon: "embedly",
    ...
    }), be.FE.RegisterQuickInsertButton("table", {
        icon: "insertTable",
    ...
    }), be.FE.RegisterQuickInsertButton("ol", {
        icon: "formatOL",
    ...
    }), be.FE.RegisterQuickInsertButton("ul", {
        icon: "formatUL",
        requiredPlugin: "lists",
        title: "Unordered List",
        callback: function() {
    ...
    }), be.FE.RegisterQuickInsertButton("hr", {
        icon: "insertHR",
        title: "Insert Horizontal Line",
        callback: function() {
            this.commands.insertHR()
        }
    }), be.FE.PLUGINS.quickInsert = function(o) {
        var s,
            l;
        function t(e) {
            var t,
        ...
        function n(e) {
            s || function() {
                o.shared.$quick_insert || (o.shared.$quick_insert = be('<div class="fr-quick-insert"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + o.language.translate("Quick Insert") + '">' + o.icon.create("quickInsert") + "</a></div>"));
                s = o.shared.$quick_insert, o.tooltip.bind(o.$box, ".fr-quick-insert > a.fr-floating-btn"), o.events.on("destroy", function() {
                    s.removeClass("fr-on").appendTo(be("body:first")).css("left", -9999).css("top", -9999), l && (d(), l.appendTo(be("body:first")))
                    ...
                    var t = be(e.currentTarget).data("cmd");
                    if (!1 === o.events.trigger("quickInsert.commands.before", [t]))
                        return !1;
                    be.FE.QUICK_INSERT_BUTTONS[t].callback.apply(o, [e.currentTarget]), be.FE.QUICK_INSERT_BUTTONS[t].undo && o.undo.saveStep(), o.events.trigger("quickInsert.commands.after", [t]), o.quickInsert.hide()
        ...
        function r() {
            if (o.core.hasFocus()) {
                var e = o.selection.element();
                if (o.opts.enter == be.FE.ENTER_BR || o.node.isBlock(e) || (e = o.node.blockParent(e)), o.opts.enter == be.FE.ENTER_BR && !o.node.isBlock(e)) {
                    var t = o.node.deepestParent(e);
                    t && (e = t)
                }
                e && (o.opts.enter != be.FE.ENTER_BR && o.node.isEmpty(e) && 0 <= o.opts.quickInsertTags.indexOf(e.tagName.toLowerCase()) || o.opts.enter == be.FE.ENTER_BR && ("BR" == e.tagName && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling)) || o.node.isEmpty(e) && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling)) && (!e.nextSibling || "BR" == e.nextSibling.tagName || o.node.isBlock(e.nextSibling)))) ? s && s.data("tag").is(be(e)) && s.hasClass("fr-on") ? d() : o.selection.isCollapsed() && n(be(e)) : i()
            }
        }
        function i() {
        ...
        function a(e) {
            if (e && e.preventDefault(), s.hasClass("fr-on") && !s.hasClass("fr-hidden"))
                d();
            else {
                if (!o.shared.$qi_helper) {
                    for (var t = o.opts.quickInsertButtons, n = '<div class="fr-qi-helper">', r = 0, i = 0; i < t.length; i++) {
                        var a = be.FE.QUICK_INSERT_BUTTONS[t[i]];
                        a && (!a.requiredPlugin || be.FE.PLUGINS[a.requiredPlugin] && 0 <= o.opts.pluginsEnabled.indexOf(a.requiredPlugin)) && (n += '<a class="fr-btn fr-floating-btn" role="button" title="' + o.language.translate(a.title) + '" tabIndex="-1" data-cmd="' + t[i] + '" style="transition-delay: ' + .025 * r++ + 's;">' + o.icon.create(a.icon) + "</a>")
                    }
                    n += "</div>", o.shared.$qi_helper = be(n), o.tooltip.bind(o.shared.$qi_helper, "> a.fr-btn"), o.events.$on(o.shared.$qi_helper, "mousedown", function(e) {
                        e.preventDefault()
                    }, !0)
                }
        ...
        return {
            _init: function() {
                if (!o.$wp || !o.opts.quickInsertEnabled)
                    return !1;
                o.popups.onShow("image.edit", i), o.events.on("mouseup", r), o.helpers.isMobile() && o.events.$on(be(o.o_doc), "selectionchange", r), o.events.on("blur", i), o.events.on("keyup", r), o.events.on("keydown", function() {
                    setTimeout(function() {
                        r()
                    }, 0)
                })
    ...
    }, be.FE.PLUGINS.quote = function(r) {
        function i(e) {
            ...
            apply: function(e) {
                r.selection.save(), r.html.wrap(!0, !0, !0, !0), r.selection.restore(), "increase" == e ? function() {
                    ...
                    var e,
                        t = r.selection.blocks();
                    for (e = 0; e < t.length; e++)
                        "BLOCKQUOTE" != t[e].tagName && (t[e] = be(t[e]).parentsUntil(r.$el, "BLOCKQUOTE").get(0));
                    for (r.selection.save(), e = 0; e < t.length; e++)
                        t[e] && be(t[e]).replaceWith(t[e].innerHTML);
                    r.html.unwrap(), r.selection.restore()
                }()
            }
        }
    }, be.FE.RegisterShortcut(be.FE.KEYCODE.SINGLE_QUOTE, "quote", "increase", "'"), be.FE.RegisterShortcut(be.FE.KEYCODE.SINGLE_QUOTE, "quote", "decrease", "'", !0), be.FE.RegisterCommand("quote", {
        title: "Quote",
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }, be.FE.DefineIcon("save", {
        NAME: "floppy-o",
        FA5NAME: "save"
    }), be.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
    ...
    }), be.FE.PLUGINS.specialCharacters = function(s) {
        var o,
            l,
        ...
        return {
            ...
            show: function() {
                if (!o) {
                    ...
                    o = n.$modal, n.$head, l = n.$body, s.events.$on(be(s.o_win), "resize", function() {
                        ...
                        if (!(n.length || t != be.FE.KEYCODE.F10 || s.keys.ctrlKey(e) || e.shiftKey) && e.altKey)
                            return d(l.find("span.fr-special-character:first"), e), !1;
                        if (t == be.FE.KEYCODE.TAB || t == be.FE.KEYCODE.ARROW_LEFT || t == be.FE.KEYCODE.ARROW_RIGHT) {
                            var r = null,
                                i = null,
                                a = !1;
                            return t == be.FE.KEYCODE.ARROW_LEFT || t == be.FE.KEYCODE.ARROW_RIGHT ? (i = t == be.FE.KEYCODE.ARROW_RIGHT, a = !0) : i = !e.shiftKey, n.length ? (a && (r = i ? n.nextAll("span.fr-special-character:first") : n.prevAll("span.fr-special-character:first")), r && r.length || (r = i ? n.parent().next().find("span.fr-special-character:first") : n.parent().prev().find("span.fr-special-character:" + (a ? "last" : "first"))).length || (r = l.find("span.fr-special-character:" + (i ? "first" : "last")))) : r = l.find("span.fr-special-character:" + (i ? "first" : "last")), d(r, e), !1
                        }
                        if (t != be.FE.KEYCODE.ENTER || !n.length)
                            return !0;
    ...
    }, be.FroalaEditor.DefineIcon("specialCharacters", {
        template: "text",
        NAME: "&#937;"
    }), be.FE.RegisterCommand("specialCharacters", {
    ...
    }), be.FE.PLUGINS.table = function(T) {
        var A,
            s,
            i,
            a,
            ...
            if (i) {
                ...
                a || (a = function() {
                    ...
                    return T.events.$on(T.$wp, "scroll.table-colors", function() {
                        ...
                        var t = be(e.currentTarget);
                        if (!T.popups.isVisible("table.colors") || !t.is("span"))
                            return !0;
                        var n = e.which,
                            r = !0;
                        if (be.FE.KEYCODE.TAB == n) {
                            ...
                            be.FE.KEYCODE.ENTER == n && (T.button.exec(t), r = !1);
                        return !1 === r && (e.preventDefault(), e.stopPropagation()), r
                    }, !0), r;
                    var h
        ...
        function c(e) {
            ...
            return T.events.$on(i, "mouseenter", ".fr-table-size .fr-select-table-size .fr-table-cell", function(e) {
                f(be(e.currentTarget))
            }, !0), n = i, T.events.$on(n, "focus", "[tabIndex]", function(e) {
                var t = be(e.currentTarget);
                f(t)
            }), T.events.on("popup.tab", function(e) {
                var t = be(e.currentTarget);
                if (!T.popups.isVisible("table.insert") || !t.is("span, a"))
                    return !0;
                var n,
                    r = e.which;
                if (be.FE.KEYCODE.ARROW_UP == r || be.FE.KEYCODE.ARROW_DOWN == r || be.FE.KEYCODE.ARROW_LEFT == r || be.FE.KEYCODE.ARROW_RIGHT == r) {
                    if (t.is("span.fr-table-cell")) {
                        var i = t.parent().find("span.fr-table-cell"),
                            ...
                            s = a % o,
                            l = Math.floor(a / o);
                        be.FE.KEYCODE.ARROW_UP == r ? l = Math.max(0, l - 1) : be.FE.KEYCODE.ARROW_DOWN == r ? l = Math.min(T.opts.tableInsertMaxSize - 1, l + 1) : be.FE.KEYCODE.ARROW_LEFT == r ? s = Math.max(0, s - 1) : be.FE.KEYCODE.ARROW_RIGHT == r && (s = Math.min(T.opts.tableInsertMaxSize - 1, s + 1));
                        var d = l * o + s,
                            c = be(i.get(d));
                        f(c), T.events.disableBlur(), c.focus(), n = !1
                    }
                } else
                    be.FE.KEYCODE.ENTER == r && (T.button.exec(t), n = !1);
                return !1 === n && (e.preventDefault(), e.stopPropagation()), n
            }, !0), i
        }
        function f(e) {
        ...
        function p(e) {
            if (e)
                return T.popups.onHide("table.edit", l), !0;
        ...
        function g(e) {
            var t = Z();
            if (0 < t.length) {
                if (0 < T.$el.find("th.fr-selected-cell").length && "above" == e)
                    return;
                var n,
                    r,
                    i,
                ...
                for (n = 0; n < a[r].length; n++)
                    if ("below" == e && r < a.length - 1 && a[r][n] == a[r + 1][n] || "above" == e && 0 < r && a[r][n] == a[r - 1][n]) {
                        ...
                        s += "<td><br></td>";
                s += "</tr>", i = 0 < T.$el.find("th.fr-selected-cell").length && "below" == e ? be(t.find("tbody").not(t.find("table tbody"))) : be(t.find("tr").not(t.find("table tr")).get(r)), "below" == e ? "TBODY" == i.prop("tagName") ? i.prepend(s) : i.after(s) : "above" == e && (i.before(s), T.popups.isVisible("table.edit") && u())
            }
        }
        function m(e, t, n) {
            var r,
                ...
                for (i = e; i <= t; i++)
                    if (!(e < i && d[0][i] == d[0][i - 1]) && 1 < (o = Math.min(parseInt(d[0][i].getAttribute("colspan"), 10) || 1, t - e + 1)) && d[0][i] == d[0][i + 1])
                        for (l = o - 1, r = 1; r < d.length; r++)
                            if (d[r][i] != d[r - 1][i]) {
                                for (a = i; a < i + o; a++)
                                    if (1 < (s = parseInt(d[r][a].getAttribute("colspan"), 10) || 1) && d[r][a] == d[r][a + 1])
                                        a += l = Math.min(l, s - 1);
                ...
                for (r = e; r <= t; r++)
                    if (!(e < r && d[r][0] == d[r - 1][0]) && 1 < (o = Math.min(parseInt(d[r][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && d[r][0] == d[r + 1][0])
                        for (l = o - 1, i = 1; i < d[0].length; i++)
                            if (d[r][i] != d[r][i - 1]) {
                                for (a = r; a < r + o; a++)
                                    if (1 < (s = parseInt(d[a][i].getAttribute("rowspan"), 10) || 1) && d[a][i] == d[a + 1][i])
                                        a += l = Math.min(l, s - 1);
                                    else if (!(l = Math.max(0, l - 1)))
                                        break;
                                if (!l)
        ...
        function S(e) {
            ...
            return null == (e = e || null) && 0 < Q().length && (e = Z()), e && e.find("tr:visible").not(e.find("table tr")).each(function(s, e) {
                ...
                t.find("> th, > td").each(function(e, t) {
                    for (var n = be(t), r = parseInt(n.attr("colspan"), 10) || 1, i = parseInt(n.attr("rowspan"), 10) || 1, a = s; a < s + i; a++)
                        for (var o = l; o < l + r; o++)
        ...
        function N(e) {
            var t = w(e),
                n = be(e[t.min_i][t.min_j]),
                r = be(e[t.min_i][t.max_j]),
                i = be(e[t.max_i][t.min_j]);
            return {
                left: n.offset().left,
        ...
        function O(t, n) {
            if (be(t).is(n))
                L(), be(t).addClass("fr-selected-cell");
            else {
                x(), T.edit.off();
                var r = S(),
                    i = R(t, r),
                    ...
                    o = function e(t, n, r, i, a) {
                        var o,
                            ...
                            u = i;
                        for (o = c; o <= f; o++)
                            (1 < (parseInt(be(a[o][p]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[o][p]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][p], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(be(a[o][u]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[o][u]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][u], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
                        for (s = p; s <= u; s++)
                            (1 < (parseInt(be(a[c][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[c][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[c][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(be(a[f][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(be(a[f][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[f][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
                ...
                for (var s = o.min_i; s <= o.max_i; s++)
                    for (var l = o.min_j; l <= o.max_j; l++)
                        be(r[s][l]).addClass("fr-selected-cell")
            }
        }
        function I(e) {
            var t = null,
        ...
        function e(e) {
            var t = I(e);
            if ("false" == be(t).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable"))
                return !0;
            if (0 < Q().length && !t && D(), !T.edit.isDisabled() || T.popups.isVisible("table.edit"))
                if (1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)
                    (3 == e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey) && t && D();
                else if (a = !0, t) {
                    0 < Q().length && !e.shiftKey && D(), e.stopPropagation(), T.events.trigger("image.hideResizer"), T.events.trigger("video.hideResizer"), i = !0;
                    var n = t.tagName.toLowerCase();
                    e.shiftKey && 0 < T.$el.find(n + ".fr-selected-cell").length ? be(T.$el.find(n + ".fr-selected-cell").closest("table")).is(be(t).closest("table")) ? O(r, t) : x() : ((T.keys.ctrlKey(e) || e.shiftKey) && (1 < Q().length || 0 === be(t).find(T.selection.element()).length && !be(t).is(T.selection.element())) && x(), r = t, 0 < T.opts.tableEditButtons.length && O(r, r))
                }
        }
        function n(e) {
            if (i || T.$tb.is(e.target) || T.$tb.is(be(e.target).closest(T.$tb.get(0))) || (0 < Q().length && T.toolbar.enable(), L()), !(1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)) {
                if (a = !1, i)
                    i = !1, I(e) || 1 != Q().length ? 0 < Q().length && (T.selection.isCollapsed() ? u() : L()) : L();
                if (b) {
                        ...
                        if (e !== t) {
                            ...
                            if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                                ...
                                for (o = 0; o < d.length; o++)
                                    s = be(d[o][n]), l = be(d[o][r]), c[o] = s.outerWidth(), p[o] = l.outerWidth(), f[o] = c[o] / a * 100, u[o] = p[o] / a * 100;
                                for (o = 0; o < d.length; o++)
                                    if (s = be(d[o][n]), l = be(d[o][r]), d[o][n] != d[o][r]) {
        ...
        function k(e) {
            if (!0 === i && 0 < T.opts.tableEditButtons.length) {
                if (be(e.currentTarget).closest("table").is(Z())) {
                    if ("TD" == e.currentTarget.tagName && 0 === T.$el.find("th.fr-selected-cell").length)
                        return void O(r, e.currentTarget);
                    if ("TH" == e.currentTarget.tagName && 0 === T.$el.find("td.fr-selected-cell").length)
                        return void O(r, e.currentTarget)
                }
                x()
            }
        ...
        function U(e, t) {
            var n = be(t),
                r = n.closest("table"),
                i = r.parent();
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName)
                A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B();
            else {
                if (n = be(t), 0 === T.$el.find(n).length)
                    return !1;
                ...
                if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
                    ...
                    "rtl" != T.opts.direction ? e.pageX - a <= T.opts.tableResizerOffset ? (d = a, 0 < u.col ? (c = a - Y(u.col - 1, p) + T.opts.tableResizingLimit, f = a + Y(u.col, p) - T.opts.tableResizingLimit, s = u.col - 1, l = u.col) : (s = null, l = 0, c = r.offset().left - 1 - parseInt(r.css("margin-left"), 10), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)) : o - e.pageX <= T.opts.tableResizerOffset && (d = o, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = o - Y(h.col, p) + T.opts.tableResizingLimit, f = o + Y(h.col + 1, p) - T.opts.tableResizingLimit, s = h.col, l = h.col + 1) : (s = h.col, l = null, c = r.offset().left - 1 + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : o - e.pageX <= T.opts.tableResizerOffset ? (d = o, 0 < u.col ? (c = o - Y(u.col, p) + T.opts.tableResizingLimit, f = o + Y(u.col - 1, p) - T.opts.tableResizingLimit, s = u.col, l = u.col - 1) : (s = null, l = 0, c = r.offset().left + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : e.pageX - a <= T.opts.tableResizerOffset && (d = a, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = a - Y(h.col + 1, p) + T.opts.tableResizingLimit, f = a + Y(h.col, p) - T.opts.tableResizingLimit, s = h.col + 1, l = h.col) : (s = h.col, l = null, c = i.offset().left + parseFloat(i.css("padding-left")), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)), A || (T.shared.$table_resizer || (T.shared.$table_resizer = be('<div class="fr-table-resizer"><div></div></div>')), A = T.shared.$table_resizer, T.events.$on(A, "mousedown", function(e) {
                        ...
                        T.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"), A.hide().appendTo(be("body:first"))
                    ...
                    T.core.sameInstance(A) && B()
            }
        }
        function K(e, t) {
            if (T.$box.find(".fr-line-breaker").is(":visible"))
                return !1;
            s || q(), T.$box.append(s), s.data("instance", T);
            var n,
                r = be(t).find("tr:first"),
                i = e.pageX,
                a = 0,
                o = 0;
                ...
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t)))
                        for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
                            if (r = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset, e.pageY - T.win.pageYOffset + n), be(r).hasClass("fr-tooltip"))
                                return;
                            if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (be(r).parents(".fr-wrapper").length || T.opts.iframe))
                                return K(e, be(r).closest("table"));
                            if (i = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset + n, e.pageY - T.win.pageYOffset), be(i).hasClass("fr-tooltip"))
                                return;
                            if (i && ("TH" == i.tagName || "TD" == i.tagName || "TABLE" == i.tagName) && (be(i).parents(".fr-wrapper").length || T.opts.iframe))
                                return H(e, be(i).closest("table"))
                        }
        ...
        function Y(e, t) {
            var n,
                r = be(t[0][e]).outerWidth();
            for (n = 1; n < t.length; n++)
                r = Math.min(r, be(t[n][e]).outerWidth());
            return r
        }
        function G(e, t, n) {
            var r,
        ...
        function V(e) {
            if (1 < Q().length && a && x(), !1 === a && !1 === i && !1 === b)
                o && clearTimeout(o), T.edit.isDisabled() && !T.popups.isVisible("table.edit") || (o = setTimeout(W, 30, e));
            else if (b) {
        ...
        function X(e) {
            T.node.isEmpty(e.get(0)) ? e.prepend(be.FE.MARKERS) : e.prepend(be.FE.START_MARKER).append(be.FE.END_MARKER)
        }
        function q() {
            T.shared.$ti_helper || (T.shared.$ti_helper = be('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + T.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), T.events.bindClick(T.shared.$ti_helper, "a", function() {
                ...
                e.stopPropagation()
            }, !0), T.events.$on(be(T.o_win), "scroll", function() {
                P()
        ...
        function Z() {
            ...
            if (e.length) {
                for (var t = e[0]; t && "TABLE" != t.tagName && t.parentNode != T.el;)
                    t = t.parentNode;
                return t && "TABLE" == t.tagName ? be(t) : be([])
            }
            return be([])
        }
        return {
            _init: function() {
                ...
                if (!T.helpers.isMobile()) {
                    b = i = a = !1, T.events.$on(T.$el, "mousedown", e), T.popups.onShow("image.edit", function() {
                    ...
                    }), T.events.$on(T.$el, "mouseenter", "th, td", k), T.events.$on(T.$win, "mouseup", n), T.opts.iframe && T.events.$on(be(T.o_win), "mouseup", n), T.events.$on(T.$win, "mousemove", V), T.events.$on(be(T.o_win), "scroll", z), T.events.on("contentChanged", function() {
                        0 < Q().length && (u(), T.$el.find("img").on("load.selected-cells", function() {
                            be(this).off("load.selected-cells"), 0 < Q().length && u()
                        }))
                    }), T.events.$on(be(T.o_win), "resize", function() {
                        L()
                    }), T.events.on("toolbar.esc", function() {
                        if (0 < Q().length)
                            return T.events.disableBlur(), T.events.focus(), !1
                    }, !0), T.events.$on(be(T.o_win), "keydown", function() {
                        ...
                        e.shiftKey ? !1 === function(e) {
                            ...
                            if (0 < t.length) {
                                ...
                                var o = R(r, i);
                                if (be.FE.KEYCODE.ARROW_RIGHT == a) {
                                    if (o.col < i[0].length - 1)
                                        return O(n, i[o.row][o.col + 1]), !1
                                } else if (be.FE.KEYCODE.ARROW_DOWN == a) {
                                    if (o.row < i.length - 1)
                                        return O(n, i[o.row + 1][o.col]), !1
                                } else if (be.FE.KEYCODE.ARROW_LEFT == a) {
                                    if (0 < o.col)
                                        return O(n, i[o.row][o.col - 1]), !1
                                } else if (be.FE.KEYCODE.ARROW_UP == a && 0 < o.row)
                                    return O(n, i[o.row - 1][o.col]), !1
                            }
                            ...
                            if (n.length && ("TD" == (n = n[0]).tagName || "TH" == n.tagName)) {
                                for (var r = n; r && "TABLE" != r.tagName && r.parentNode != T.el;)
                                    r = r.parentNode;
                                if (r && "TABLE" == r.tagName && (be.FE.KEYCODE.ARROW_LEFT == t || be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_RIGHT == t || be.FE.KEYCODE.ARROW_DOWN == t) && (0 < Q().length && D(), T.browser.webkit && (be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_DOWN == t))) {
                                    var i = T.selection.ranges(0).startContainer;
                                    if (i.nodeType == Node.TEXT_NODE && (be.FE.KEYCODE.ARROW_UP == t && i.previousSibling || be.FE.KEYCODE.ARROW_DOWN == t && i.nextSibling))
                                        return;
                                    e.preventDefault(), e.stopPropagation();
                                    var a = S(be(r)),
                                        o = R(n, a);
                                    be.FE.KEYCODE.ARROW_UP == t ? M(o, r, a) : be.FE.KEYCODE.ARROW_DOWN == t && $(o, r, a), T.selection.restore()
                                }
                            }
                        }(e)
                        ...
                        if (!1 === function(e) {
                            if (e.which == be.FE.KEYCODE.TAB) {
                                var t;
                                if (0 < Q().length)
                                    t = T.$el.find(".fr-selected-cell:last");
                                else {
                                    var n = T.selection.element();
                                    "TD" == n.tagName || "TH" == n.tagName ? t = be(n) : n != T.el && (0 < be(n).parentsUntil(T.$el, "td").length ? t = be(n).parents("td:first") : 0 < be(n).parentsUntil(T.$el, "th").length && (t = be(n).parents("th:first")))
                                }
                                if (t)
                                    return e.preventDefault(), !!(0 < be(T.selection.element()).parentsUntil(T.$el, "ol, ul").length && (0 < be(T.selection.element()).parents("li").prev().length || be(T.selection.element()).is("li") && 0 < be(T.selection.element()).prev().length)) || (D(), e.shiftKey ? 0 < t.prev().length ? X(t.prev()) : 0 < t.closest("tr").length && 0 < t.closest("tr").prev().length ? X(t.closest("tr").prev().find("td:last")) : 0 < t.closest("tbody").length && 0 < t.closest("table").find("thead tr").length && X(t.closest("table").find("thead tr th:last")) : 0 < t.next().length ? X(t.next()) : 0 < t.closest("tr").length && 0 < t.closest("tr").next().length ? X(t.closest("tr").next().find("td:first")) : 0 < t.closest("thead").length && 0 < t.closest("table").find("tbody tr").length ? X(t.closest("table").find("tbody tr td:first")) : (t.addClass("fr-selected-cell"), g("below"), L(), X(t.closest("tr").next().find("td:first"))), T.selection.restore(), !1)
                            }
                        }(e))
                            return !1;
                        var t = Q();
                        if (0 < t.length) {
                            if (0 < t.length && T.keys.ctrlKey(e) && e.which == be.FE.KEYCODE.A)
                                return L(), T.popups.isVisible("table.edit") && T.popups.hide("table.edit"), t = [], !0;
                            if (e.which == be.FE.KEYCODE.ESC && T.popups.isVisible("table.edit"))
                                return L(), T.popups.hide("table.edit"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), !(t = []);
                            if (1 < t.length && (e.which == be.FE.KEYCODE.BACKSPACE || e.which == be.FE.KEYCODE.DELETE)) {
                                T.undo.saveStep();
                                for (var n = 0; n < t.length; n++)
                                    be(t[n]).html("<br>"), n == t.length - 1 && be(t[n]).prepend(be.FE.MARKERS);
                                return T.selection.restore(), T.undo.saveStep(), !(t = [])
                            }
                            if (1 < t.length && e.which != be.FE.KEYCODE.F10 && !T.keys.isBrowserAction(e))
                                return e.preventDefault(), !(t = [])
                        } else if (!(t = []) === function(e) {
                            if (e.altKey && e.which == be.FE.KEYCODE.SPACE) {
                                var t,
                                    n = T.selection.element();
                                if ("TD" == n.tagName || "TH" == n.tagName ? t = n : 0 < be(n).closest("td").length ? t = be(n).closest("td").get(0) : 0 < be(n).closest("th").length && (t = be(n).closest("th").get(0)), t)
                                    return e.preventDefault(), O(t, t), u(), !1
                            }
                        }(e))
                            return !1
                    }, !0);
            ...
            insert: function(e, t) {
                ...
                for (n = 0; n < e; n++) {
                    for (i += "<tr>", r = 0; r < t; r++)
                        i += "<td" + (T.opts.tableDefaultWidth ? ' style="width: ' + a.toFixed(4) + '%;"' : "") + ">", 0 === n && 0 === r && (i += be.FE.MARKERS), i += "<br></td>";
                    i += "</tr>"
                }
            ...
            deleteRow: function() {
                ...
                if (0 < e.length) {
                    var t,
                        ...
                        i = S(),
                        a = w(i);
                    if (0 === a.min_i && a.max_i == i.length - 1)
                        h();
                    else {
                        for (t = a.max_i; t >= a.min_i; t--) {
                            for (r = be(e.find("tr").not(e.find("table tr")).get(t)), n = 0; n < i[t].length; n++)
                                if (0 === n || i[t][n] != i[t][n - 1]) {
                                    ...
                                    if (t < i.length - 1 && i[t][n] == i[t + 1][n] && (0 === t || i[t][n] != i[t - 1][n])) {
                                        for (var l = i[t][n], d = n; 0 < d && i[t][d] == i[t][d - 1];)
                                            d--;
                                        0 === d ? be(e.find("tr").not(e.find("table tr")).get(t + 1)).prepend(l) : be(i[t + 1][d - 1]).after(l)
                                    }
                                }
                            var c = r.parent();
            ...
            insertColumn: function(l) {
                ...
                if (0 < e.length) {
                    ...
                    e.find("th, td").each(function() {
                        (n = be(this)).data("old-width", n.outerWidth() / e.outerWidth() * 100)
                    }), e.find("tr").not(e.find("table tr")).each(function(e) {
                        for (var t, n = be(this), r = 0, i = 0; r - 1 < d;) {
                            if (!(t = n.find("> th, > td").get(i))) {
                                t = null;
                                break
                            }
                            t == c[e][r] ? (r += parseInt(be(t).attr("colspan"), 10) || 1, i++) : (r += parseInt(be(c[e][r]).attr("colspan"), 10) || 1, "after" == l && (t = 0 === i ? -1 : n.find("> th, > td").get(i - 1)))
                        }
                        var a,
                            o = be(t);
                        if ("after" == l && d < r - 1 || "before" == l && 0 < d && c[e][d] == c[e][d - 1]) {
                            ...
                            a = 0 < n.find("th").length ? '<th style="width: ' + p.toFixed(4) + '%;"><br></th>' : '<td style="width: ' + p.toFixed(4) + '%;"><br></td>', -1 == t ? n.prepend(a) : null == t ? n.append(a) : "before" == l ? o.before(a) : "after" == l && o.after(a)
                    }), e.find("th, td").each(function() {
                        (n = be(this)).data("old-width") && (n.css("width", (n.data("old-width") * p / f).toFixed(4) + "%"), n.removeData("old-width"))
                    }), T.popups.isVisible("table.edit") && u()
                }
            },
            deleteColumn: function() {
                ...
                if (0 < e.length) {
                    var t,
                        ...
                        i = S(),
                        a = w(i);
                    if (0 === a.min_j && a.max_j == i[0].length - 1)
                        h();
                    else {
                        var o = 0;
                        for (t = 0; t < i.length; t++)
                            for (n = 0; n < i[0].length; n++)
                                (r = be(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
                        for (o /= i.length, n = a.max_j; n >= a.min_j; n--)
                            for (t = 0; t < i.length; t++)
                                if (0 === t || i[t][n] != i[t - 1][n])
                                    if (r = be(i[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
                        ...
                        C(0, i.length - 1, 0, i[0].length - 1, e), 0 < a.min_j ? T.selection.setAtEnd(i[a.min_i][a.min_j - 1]) : T.selection.setAtEnd(i[a.min_i][0]), T.selection.restore(), T.popups.hide("table.edit"), e.find("th, td").each(function() {
                            (r = be(this)).data("old-width") && (r.css("width", (100 * r.data("old-width") / o).toFixed(4) + "%"), r.removeData("old-width"))
                        })
                    }
                }
            },
            mergeCells: function() {
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    ...
                    for (i.css("width", Math.min(100, l / o.outerWidth() * 100).toFixed(4) + "%"), n.min_j < n.max_j && i.attr("colspan", n.max_j - n.min_j + 1), n.min_i < n.max_i && i.attr("rowspan", n.max_i - n.min_i + 1), e = 1; e < r.length; e++)
                        "<br>" != (t = be(r[e])).html() && "" !== t.html() && (s += "<br>" + t.html()), t.remove();
                ...
                if (1 == Q().length) {
                    ...
                    if (1 < r) {
                        ...
                        for (var l = a.row + s, d = 0 === a.col ? a.col : a.col - 1; 0 <= d && (i[l][d] == i[l][d - 1] || 0 < l && i[l][d] == i[l - 1][d]);)
                            d--;
                        -1 == d ? be(n.find("tr").not(n.find("table tr")).get(l)).prepend(o) : be(i[l][d]).after(o)
                    } else {
                        var c,
                            f = be("<tr>").append(o);
            ...
            removeHeader: function() {
                var e = Z(),
                    t = e.find("thead");
                if (0 < t.length)
                    if (0 === e.find("tbody tr").length)
                        h();
                    else if (t.remove(), 0 < Q().length)
                        u();
                    else {
    ...
    }, be.FE.DefineIcon("insertTable", {
        NAME: "table"
    }), be.FE.RegisterCommand("insertTable", {
        title: "Insert Table",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "table"
    }), be.FE.RegisterCommand("tableInsert", {
        callback: function(e, t, n) {
            this.table.insert(t, n), this.popups.hide("table.insert")
        }
    }), be.FE.DefineIcon("tableHeader", {
        NAME: "header",
        FA5NAME: "heading"
    }), be.FE.RegisterCommand("tableHeader", {
        title: "Table Header",
        focus: !1,
        toggle: !0,
        callback: function() {
    ...
    }), be.FE.DefineIcon("tableRows", {
        NAME: "bars"
    }), be.FE.RegisterCommand("tableRows", {
        type: "dropdown",
        focus: !1,
        title: "Row",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.tableRows.options;
            for (var n in t)
    ...
    }), be.FE.DefineIcon("tableColumns", {
        NAME: "bars fa-rotate-90"
    }), be.FE.RegisterCommand("tableColumns", {
        type: "dropdown",
        focus: !1,
        title: "Column",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.tableColumns.options;
            for (var n in t)
    ...
    }), be.FE.DefineIcon("tableCells", {
        NAME: "square-o",
        FA5NAME: "square"
    }), be.FE.RegisterCommand("tableCells", {
        type: "dropdown",
        focus: !1,
        title: "Cell",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.tableCells.options;
            for (var n in t)
    ...
    }), be.FE.DefineIcon("tableRemove", {
        NAME: "trash"
    }), be.FE.RegisterCommand("tableRemove", {
        title: "Remove Table",
        focus: !1,
        callback: function() {
            this.table.remove()
        }
    }), be.FE.DefineIcon("tableStyle", {
        NAME: "paint-brush"
    }), be.FE.RegisterCommand("tableStyle", {
        title: "Table Style",
        type: "dropdown",
        focus: !1,
        html: function() {
    ...
    }), be.FE.DefineIcon("tableCellBackground", {
        NAME: "tint"
    }), be.FE.RegisterCommand("tableCellBackground", {
    ...
    }), be.FE.RegisterCommand("tableCellBackgroundColor", {
        undo: !0,
        focus: !1,
        callback: function(e, t) {
            this.table.setBackground(t)
        }
    }), be.FE.DefineIcon("tableBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.DefineIcon("tableCellVerticalAlign", {
        NAME: "arrows-v",
        FA5NAME: "arrows-alt-v"
    }), be.FE.RegisterCommand("tableCellVerticalAlign", {
        type: "dropdown",
        focus: !1,
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.tableCellVerticalAlign.options;
            for (var n in t)
    ...
    }), be.FE.DefineIcon("tableCellHorizontalAlign", {
        NAME: "align-left"
    }), be.FE.DefineIcon("align-left", {
        NAME: "align-left"
    }), be.FE.DefineIcon("align-right", {
        ...
        NAME: "align-justify"
    }), be.FE.RegisterCommand("tableCellHorizontalAlign", {
        type: "dropdown",
        focus: !1,
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.tableCellHorizontalAlign.options;
            for (var n in t)
        ...
        refresh: function(e) {
            ...
            t.length && e.find("> *:first").replaceWith(this.icon.create("align-" + this.helpers.getAlignment(be(t[0]))))
        },
        refreshOnShow: function(e, t) {
    ...
    }), be.FE.DefineIcon("tableCellStyle", {
        NAME: "magic"
    }), be.FE.RegisterCommand("tableCellStyle", {
        title: "Cell Style",
        type: "dropdown",
        focus: !1,
        html: function() {
    ...
    }), be.FE.RegisterCommand("tableCellBackgroundCustomColor", {
        title: "OK",
        undo: !0,
        callback: function() {
            this.table.customColor()
        }
    }), be.FE.DefineIcon("tableColorRemove", {
        NAME: "eraser"
    }), be.FE.URLRegEx = "(^| |\\u00A0)(" + be.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$", be.FE.PLUGINS.url = function(a) {
        var o = null;
        function t(e, t, n) {
            for (var r = ""; n.length && "." == n[n.length - 1];)
                r += ".", n = n.substring(0, n.length - 1);
            var i = n;
            if (a.opts.linkConvertEmailAddress)
                a.helpers.isEmail(i) && !/^mailto:.*/i.test(i) && (i = "mailto:" + i);
            else if (a.helpers.isEmail(i))
                return t + n;
        ...
        function s() {
            return new RegExp(be.FE.URLRegEx, "gi")
        }
        function l(e) {
        ...
        function n() {
            var t = a.selection.ranges(0),
                n = t.startContainer;
            if (!n || n.nodeType !== Node.TEXT_NODE || t.startOffset !== (n.textContent || "").length)
                return !1;
            if (function e(t) {
            ...
            if (s().test(d(n.textContent))) {
                be(n).before(l(n.textContent));
                var r = be(n.parentNode).find("a[data-fr-linked]");
                ...
                s().test(d(i)) && (be(n.previousSibling).replaceWith(l(i)), n.parentNode.removeChild(n))
            }
        }
        return {
            _init: function() {
                a.events.on("keypress", function(e) {
                    ...
                    var t = e.which;
                    !a.selection.isCollapsed() || t != be.FE.KEYCODE.ENTER && t != be.FE.KEYCODE.SPACE || n()
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }], be.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe.*><\/iframe>)|(<embed.*>))\W*$/i, be.FE.PLUGINS.video = function(f) {
        var s,
            c,
            p,
            u,
        ...
        function o(e) {
            if (e)
                return f.popups.onRefresh("video.insert", E), f.popups.onHide("image.insert", V), !0;
            var t = "";
        ...
        function b(e) {
            ...
            var t = !1;
            u && (G(), t = !0), f.html.insert('<span contenteditable="false" draggable="true" class="fr-jiv fr-video">' + e + "</span>", !1, f.opts.videoSplitHTML), f.popups.hide("video.insert");
            var n = f.$el.find(".fr-jiv");
            n.removeClass("fr-jiv"), n.toggleClass("fr-rv", f.opts.videoResponsive), X(n, f.opts.videoDefaultDisplay, f.opts.videoDefaultAlign), n.toggleClass("fr-draggable", f.opts.videoMove), f.events.trigger(t ? "video.replaced" : "video.inserted", [n])
        }
        function T() {
            var e = be(this);
            f.popups.hide("video.insert"), e.removeClass("fr-uploading"), e.parent().next().is("br") && e.parent().next().remove(), y(e.parent()), f.events.trigger("video.loaded", [e.parent()])
        }
        function A(s, e, l, d, c) {
            f.edit.off(), R("Loading video"), e && (s = f.helpers.sanitizeURL(s));
            C("Loading video"), function() {
                ...
                if (d) {
                    ...
                    e.find("video").on("canplay", T), e.find("video").attr("src", s), f.edit.on(), k(), f.undo.saveStep(), f.$el.blur(), f.events.trigger(r ? "video.replaced" : "video.inserted", [e, c])
                } else
                    e = function(e, t, n) {
                        var r,
                            i = "";
                        ...
                        a && "auto" != a && (a += "px");
                        var o = be('<span contenteditable="false" draggable="true" class="fr-video fr-dv' + f.opts.videoDefaultDisplay[0] + ("center" != f.opts.videoDefaultAlign ? " fr-fv" + f.opts.videoDefaultAlign[0] : "") + '"><video src="' + e + '" ' + i + (a ? ' style="width: ' + a + ';" ' : "") + " controls>" + f.language.translate("Your browser does not support HTML5 video.") + "</video></span>");
                    ...
                    }(s, l, T), k(), f.undo.saveStep(), f.events.trigger("video.inserted", [e, c])
            }()
        }
        function C(e) {
            ...
            void 0 === e && R(f.language.translate("Uploading"), 0)
        }
        function S(e) {
            var t = f.popups.get("video.insert");
            if (t && (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-video-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || f.$el.find("video.fr-error").length)) {
                if (f.events.focus(), f.$el.find("video.fr-error").length && (f.$el.find("video.fr-error").parent().remove(), f.undo.saveStep(), f.undo.run(), f.undo.dropRedo()), !f.$wp && u) {
                    var n = u;
                    $(!0), f.selection.setAfter(n.find("video").get(0)), f.selection.restore()
                }
        ...
        function _(e) {
            ...
            try {
                if (f.opts.videoUploadToS3)
                    ...
                    var o = function(e) {
                        try {
                            if (!1 === f.events.trigger("video.uploaded", [e], !0))
                                return f.edit.on(), !1;
                            var t = JSON.parse(e);
        ...
        function x(e) {
            if (e.lengthComputable) {
                var t = e.loaded / e.total * 100 | 0;
                R(f.language.translate("Uploading"), t)
            }
        }
        function w() {
            f.edit.on(), S(!0)
        ...
        function N(e) {
            ...
            if ("mousedown" == e.type) {
                ...
                a && i.frameElement && (t += f.helpers.getPX(be(i.frameElement).offset().left) + i.frameElement.clientLeft, n = e.clientY + f.helpers.getPX(be(i.frameElement).offset().top) + i.frameElement.clientTop)
            }
            f.undo.canDo() || f.undo.saveStep(), (c = be(this)).data("start-x", t), c.data("start-y", n), s.show(), f.popups.hideAll(), B()
        }
        function O(e) {
            if (!f.core.sameInstance(p))
                return !0;
            if (c) {
                ...
                var a = t - r,
                    ...
                    l = s.width(),
                    d = s.height();
                (c.hasClass("fr-hnw") || c.hasClass("fr-hsw")) && (a = 0 - a), (c.hasClass("fr-hnw") || c.hasClass("fr-hne")) && (o = 0 - o), s.css("width", l + a), s.css("height", d + o), s.removeAttr("width"), s.removeAttr("height"), F()
            }
        }
        function I(e) {
            if (!f.core.sameInstance(p))
                return !0;
            c && u && (e && e.stopPropagation(), c = null, s.hide(), F(), a(), f.undo.saveStep())
        }
        function t(e) {
            return '<div class="fr-handler fr-h' + e + '"></div>'
        }
        function D(e, t, n, r) {
            return e.pageX = t, e.pageY = t, N.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), e.pageY = e.pageY + n * Math.floor(Math.pow(1.1, r)), O.call(this, e), I.call(this, e), ++r
        }
        function k() {
            var e,
                t = Array.prototype.slice.call(f.el.querySelectorAll("video, .fr-video > *")),
                n = [];
            for (e = 0; e < t.length; e++)
                n.push(t[e].getAttribute("src")), be(t[e]).toggleClass("fr-draggable", f.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
            if (r)
                for (e = 0; e < r.length; e++)
                    n.indexOf(r[e].getAttribute("src")) < 0 && f.events.trigger("video.removed", [be(r[e])]);
            r = t
        }
        function F() {
            p || function() {
                ...
                if (f.shared.$video_resizer ? (p = f.shared.$video_resizer, s = f.shared.$vid_overlay, f.events.on("destroy", function() {
                    p.removeClass("fr-active").appendTo(be("body:first"))
                }, !0)) : (f.shared.$video_resizer = be('<div class="fr-video-resizer"></div>'), p = f.shared.$video_resizer, f.events.$on(p, "mousedown", function(e) {
                    e.stopPropagation()
                }, !0), f.opts.videoResize && (p.append(t("nw") + t("ne") + t("sw") + t("se")), f.shared.$vid_overlay = be('<div class="fr-video-overlay"></div>'), s = f.shared.$vid_overlay, e = p.get(0).ownerDocument, be(e).find("body:first").append(s))), f.events.on("shared.destroy", function() {
                    p.html("").removeData().remove(), p = null, f.opts.videoResize && (s.remove(), s = null)
                }, !0), f.helpers.isMobile() || f.events.$on(be(f.o_win), "resize.video", function() {
                    $(!0)
                }), f.opts.videoResize) {
                    e = p.get(0).ownerDocument, f.events.$on(p, f._mousedown, ".fr-handler", N), f.events.$on(be(e), f._mousemove, O), f.events.$on(be(e.defaultView || e.parentWindow), f._mouseup, I), f.events.$on(s, "mouseleave", I);
                    var r = 1,
                        i = null,
                        a = 0;
                    f.events.on("keydown", function(e) {
                        if (u) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == be.FE.KEYCODE.EQUALS || f.browser.mozilla && n == be.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = D.call(this, e, 1, 1, r) : (n == be.FE.KEYCODE.HYPHEN || f.browser.mozilla && n == be.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey && (r = D.call(this, e, 2, -1, r)), i = n, a = e.timeStamp
                        }
        ...
        function M(e) {
            ...
            if (e && f.edit.isDisabled())
                return e.stopPropagation(), e.preventDefault(), !1;
            if (f.edit.isDisabled())
                return !1;
            for (var t = 0; t < be.FE.INSTANCES.length; t++)
                be.FE.INSTANCES[t] != f && be.FE.INSTANCES[t].events.trigger("video.hideResizer");
            f.toolbar.disable(), f.helpers.isMobile() && (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur()), f.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = be(this)).addClass("fr-active"), f.opts.iframe && f.size.syncIframe(), j(), F(), a(), f.selection.clear(), f.button.bulkRefresh(), f.events.trigger("image.hideResizer")
        }
        function $(e) {
            u && (f.shared.vid_exit_flag || !0 === e) && (p.removeClass("fr-active"), f.toolbar.enable(), u.removeClass("fr-active"), u = null, B())
        }
        function e() {
        ...
        function P(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("video")) {
                    if (!f.opts.videoUpload)
                        return e.preventDefault(), e.stopPropagation(), !1;
                    f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), f.popups.hideAll();
                    var r = f.popups.get("video.insert");
                    return r || (r = o()), f.popups.setContainer("video.insert", f.$sc), f.popups.show("video.insert", e.originalEvent.pageX, e.originalEvent.pageY), C(), 0 <= f.opts.videoAllowedTypes.indexOf(n.type.replace(/video\//g, "")) ? U(t.files) : K(v), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        function U(e) {
            if (void 0 !== e && 0 < e.length) {
                if (!1 === f.events.trigger("video.beforeUpload", [e]))
                    return !1;
                var t,
                    n = e[0];
                if ((null === f.opts.videoUploadURL || f.opts.videoUploadURL == d) && !f.opts.videoUploadToS3)
                    return s = n, (l = new FileReader).addEventListener("load", function() {
                        l.result;
                        for (var e = atob(l.result.split(",")[1]), t = [], n = 0; n < e.length; n++)
                            t.push(e.charCodeAt(n));
                        A(window.URL.createObjectURL(new Blob([new Uint8Array(t)], {
                            type: s.type
                        })), !1, null, u)
                    }, !1), C(), l.readAsDataURL(s), !1;
                if (n.size > f.opts.videoMaxSize)
                    return K(m), !1;
                if (f.opts.videoAllowedTypes.indexOf(n.type.replace(/video\//g, "")) < 0)
                    return K(v), !1;
                if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                    var r;
                    if (!1 !== f.opts.videoUploadToS3)
                        for (r in t.append("key", f.opts.videoUploadToS3.keyStart + (new Date).getTime() + "-" + (n.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", n.type), f.opts.videoUploadToS3.params)
                            f.opts.videoUploadToS3.params.hasOwnProperty(r) && t.append(r, f.opts.videoUploadToS3.params[r]);
                    for (r in f.opts.videoUploadParams)
                        f.opts.videoUploadParams.hasOwnProperty(r) && t.append(r, f.opts.videoUploadParams[r]);
                    ...
                    a.onload = function() {
                        _.call(a, u)
                    }, a.onerror = L, a.upload.onprogress = x, a.onabort = w, C(), f.events.disableBlur(), f.edit.off(), f.events.enableBlur();
        ...
        function W(e) {
            if (e)
                return f.popups.onRefresh("video.size", H), !0;
            var t = {
            ...
            return f.events.$on(f.$wp, "scroll", function() {
                u && f.popups.isVisible("video.size") && (f.events.disableBlur(), y(u))
            }), n
        }
        function z(e) {
            if (void 0 === e && (e = u), e) {
        ...
        function G() {
            if (u && !1 !== f.events.trigger("video.beforeRemove", [u])) {
                var e = u;
                f.popups.hideAll(), $(!0), f.selection.setBefore(e.get(0)) || f.selection.setAfter(e.get(0)), e.remove(), f.selection.restore(), f.html.fillEmptyBlocks(), f.events.trigger("video.removed", [e])
            }
        }
        function V() {
            S()
        ...
        function q() {
            f.$el.find("video").filter(function() {
                return 0 === be(this).parents("span.fr-video").length
            }).wrap('<span class="fr-video" contenteditable="false"></span>'), f.$el.find("embed, iframe").filter(function() {
                if (f.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < be(this).parents("span.fr-video").length)
                    return !1;
                for (var e = be(this).attr("src"), t = 0; t < be.FE.VIDEO_PROVIDERS.length; t++) {
                    var n = be.FE.VIDEO_PROVIDERS[t];
                    if (n.test_regex.test(e) && new RegExp(f.opts.videoAllowedProviders.join("|")).test(n.provider))
                        return !0
                }
                return !1
            }).map(function() {
                return 0 === be(this).parents("object").length ? this : be(this).parents("object").get(0)
            }).wrap('<span class="fr-video" contenteditable="false"></span>');
            for (var e, t, n = f.$el.find("span.fr-video, video"), r = 0; r < n.length; r++) {
                var i = be(n[r]);
                !f.opts.htmlUntouched && f.opts.useClasses ? ((t = i).hasClass("fr-dvi") || t.hasClass("fr-dvb") || (t.addClass("fr-fv" + z(t)[0]), t.addClass("fr-dv" + Y(t)[0])), f.opts.videoTextNear || i.removeClass("fr-dvi").addClass("fr-dvb")) : f.opts.htmlUntouched || f.opts.useClasses || (X(e = i, e.hasClass("fr-dvb") ? "block" : e.hasClass("fr-dvi") ? "inline" : null, e.hasClass("fr-fvl") ? "left" : e.hasClass("fr-fvr") ? "right" : z(e)), e.removeClass("fr-dvb fr-dvi fr-fvr fr-fvl"))
            }
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
            _init: function() {
                f.opts.videoResponsive && (f.opts.videoResize = !1), f.events.on("drop", P, !0), f.events.on("mousedown window.mousedown", e), f.events.on("window.touchmove", B), f.events.on("mouseup window.mouseup", $), f.events.on("commands.mousedown", function(e) {
                    ...
                    n = !0
                })), f.events.on("html.set", q), q(), f.events.$on(f.$el, "mousedown", "span.fr-video", function(e) {
                    e.stopPropagation(), (f.browser.msie || f.browser.edge) && (e.target.dragDrop(), M.call(this, e))
                    ...
                    var t = e.which;
                    return !u || t != be.FE.KEYCODE.BACKSPACE && t != be.FE.KEYCODE.DELETE ? u && t == be.FE.KEYCODE.ESC ? ($(!0), e.preventDefault(), !1) : u && t != be.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), G(), f.undo.saveStep(), !1)
                ...
                }), f.$wp && (k(), f.events.on("contentChanged", k)), o(!0), W(!0)
            },
            showInsertPopup: function() {
                var e = f.$tb.find('.fr-command[data-cmd="insertVideo"]'),
                    t = f.popups.get("video.insert");
                if (t || (t = o()), S(), !t.hasClass("fr-active"))
                    if (f.popups.refresh("video.insert"), f.popups.setContainer("video.insert", f.$tb), e.is(":visible")) {
                        ...
                        f.position.forSelection(t), f.popups.show("video.insert")
            },
            showLayer: function(e) {
                var t,
                    n,
                    r = f.popups.get("video.insert");
            ...
            insertByURL: function(e) {
                ...
                if (/^http/.test(e) || (e = "https://" + e), f.helpers.isURL(e))
                    for (var n = 0; n < be.FE.VIDEO_PROVIDERS.length; n++) {
                        var r = be.FE.VIDEO_PROVIDERS[n];
                ...
                t ? b(t) : f.events.trigger("video.linkError", [e])
            },
            insertEmbed: function(e) {
                void 0 === e && (e = f.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && be.FE.VIDEO_EMBED_REGEX.test(e) ? b(e) : f.events.trigger("video.codeError", [e])
            },
            insert: b,
            align: function(e) {
                u.removeClass("fr-fvr fr-fvl"), !f.opts.htmlUntouched && f.opts.useClasses ? "left" == e ? u.addClass("fr-fvl") : "right" == e && u.addClass("fr-fvr") : X(u, Y(), e), j(), F(), a(), f.selection.clear()
            },
            refreshAlign: function(e) {
                if (!u)
                    return !1;
                e.find("> *:first").replaceWith(f.icon.create("video-align-" + z()))
            },
            refreshAlignOnShow: function(e, t) {
                u && t.find('.fr-command[data-param1="' + z() + '"]').addClass("fr-active").attr("aria-selected", !0)
            },
            display: function(e) {
                u.removeClass("fr-dvi fr-dvb"), !f.opts.htmlUntouched && f.opts.useClasses ? "inline" == e ? u.addClass("fr-dvi") : "block" == e && u.addClass("fr-dvb") : X(u, e, z()), j(), F(), a(), f.selection.clear()
            },
            refreshDisplayOnShow: function(e, t) {
            ...
            showSizePopup: function() {
                var e = f.popups.get("video.size");
                e || (e = W()), S(), f.popups.refresh("video.size"), f.popups.setContainer("video.size", f.$sc);
                var t = u.find("iframe, embed, video"),
            ...
            replace: function() {
                var e = f.popups.get("video.insert");
                e || (e = o()), f.popups.isVisible("video.insert") || (S(), f.popups.refresh("video.insert"), f.popups.setContainer("video.insert", f.$sc));
    ...
    }, be.FE.RegisterCommand("insertVideo", {
        title: "Insert Video",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        plugin: "video"
    }), be.FE.DefineIcon("insertVideo", {
        NAME: "video-camera",
        FA5NAME: "camera"
    }), be.FE.DefineIcon("videoByURL", {
        NAME: "link"
    }), be.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), be.FE.DefineIcon("videoEmbed", {
        NAME: "code"
    }), be.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), be.FE.DefineIcon("videoUpload", {
        NAME: "upload"
    }), be.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), be.FE.RegisterCommand("videoInsertByURL", {
        undo: !0,
        focus: !0,
        callback: function() {
            this.video.insertByURL()
        }
    }), be.FE.RegisterCommand("videoInsertEmbed", {
        undo: !0,
        focus: !0,
        callback: function() {
            this.video.insertEmbed()
        }
    }), be.FE.DefineIcon("videoDisplay", {
        NAME: "star"
    }), be.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
        options: {
            inline: "Inline",
    ...
    }), be.FE.DefineIcon("video-align", {
        NAME: "align-left"
    }), be.FE.DefineIcon("video-align-left", {
        NAME: "align-left"
    }), be.FE.DefineIcon("video-align-right", {
        NAME: "align-right"
    }), be.FE.DefineIcon("video-align-center", {
        NAME: "align-justify"
    }), be.FE.DefineIcon("videoAlign", {
        NAME: "align-center"
    }), be.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {
            left: "Align Left",
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = be.FE.COMMANDS.videoAlign.options;
            for (var n in t)
    ...
    }), be.FE.DefineIcon("videoReplace", {
        NAME: "exchange",
        FA5NAME: "exchange-alt"
    }), be.FE.RegisterCommand("videoReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), be.FE.DefineIcon("videoRemove", {
        NAME: "trash"
    }), be.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function() {
            this.video.remove()
        }
    }), be.FE.DefineIcon("videoSize", {
        NAME: "arrows-alt"
    }), be.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }), be.FE.DefineIcon("videoBack", {
        NAME: "arrow-left"
    }), be.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), be.FE.RegisterCommand("videoDismissError", {
        title: "OK",
        undo: !1,
        callback: function() {
            this.video.hideProgressBar(!0)
        }
    }), be.FE.RegisterCommand("videoSetSize", {
        undo: !0,
        focus: !1,
        title: "Update",
        refreshAfterCallback: !1,
    ...
    }), be.FE.PLUGINS.wordPaste = function(T) {
        var a,
            r,
            o = "word_paste";
        function t(e) {
            ...
            e || (T.opts.wordAllowedStyleProps = []), 0 === r.indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = function(e, t) {
                ...
                c(i, function(e) {
                    if (e.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                        if (!/\S| /.test(e.data))
                            return e.data == be.FE.UNICODE_NBSP ? (e.data = "\u200b", !0) : 1 == e.data.length && 10 == e.data.charCodeAt(0) ? (e.data = " ", !0) : (A(e), !1);
                    ...
                    return e.nodeType != Node.ELEMENT_NODE || "V:IMAGEDATA" != e.tagName && "IMG" != e.tagName || function(e, t) {
                        ...
                        if ("IMG" == e.tagName) {
                            ...
                            if (!r || -1 == r.indexOf("file://"))
                                return;
                            if (0 === r.indexOf("file://") && T.helpers.isURL(e.getAttribute("alt")))
                                return e.setAttribute("src", e.getAttribute("alt"));
                            (n = h[e.getAttribute("v:shapes")]) || (n = e.getAttribute("v:shapes"))
                        } else
                            n = e.parentNode.getAttribute("o:spid");
                        ...
                        if (a) {
                            ...
                            "IMG" === e.tagName ? (e.src = s, e.setAttribute("data-fr-image-pasted", !0)) : be(e.parentNode).before('<img data-fr-image-pasted="true" src="' + s + '" style="' + e.parentNode.getAttribute("style") + '">').remove()
                        }
                    }(e, t), !0
                });
                ...
                c(i, function(t) {
                    if (t.nodeType == Node.TEXT_NODE)
                        return t.data = t.data.replace(/<br>(\n|\r)/gi, "<br>"), !1;
                                ...
                                i = function e(t, n) {
                                    ...
                                    for (; l && C(l);) {
                                        ...
                                        if (o = f, l.previousElementSibling || l.nextElementSibling || l.parentNode) {
                                            ...
                                            l = c ? c.nextElementSibling : d.firstElementChild
                                    }
                                    s += "</li></" + a + ">";
            ...
            for (var r = e.split(n), i = 1; i < r.length; i++) {
                ...
                if (1 < (a = a.split("shplid")).length) {
                    ...
                    if (l && l.length < 2)
                        continue;
                    var d = null;
                    if (-1 != l[0].indexOf("pngblip") ? d = "image/png" : -1 != l[0].indexOf("jpegblip") && (d = "image/jpeg"), !d)
                        continue;
                    var c,
                        f = l[1].split("}");
                    if (f && f.length < 2)
                        continue;
                    if (2 < f.length && -1 != f[0].indexOf("blipuid"))
                        c = f[1].split(" ");
                    else {
                        if ((c = f[0].split(" ")) && c.length < 2)
                            continue;
                        c.shift()
                    }
                    var p = c.join("");
        ...
        function p(e, t) {
            ...
            if (-1 != ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"].indexOf(n))
                return A(e), !1;
            var i = -1,
                a = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
            for (i = 0; i < a.length; i++)
                if (-1 != n.indexOf(a[i]))
                    return e.innerHTML && (e.outerHTML = e.innerHTML), A(e), !1;
            if ("TD" != n) {
            ...
            if ("TR" == n && function(e, t) {
                ...
                for (var n = e.firstElementChild, r = 0, i = !1, a = null; n;) {
                    n.firstElementChild && -1 != n.firstElementChild.tagName.indexOf("W:") && (n.innerHTML = n.firstElementChild.innerHTML), (a = n.getAttribute("width")) || i || (i = !0), r += parseInt(a, 10), (!n.firstChild || n.firstChild && n.firstChild.data == be.FE.UNICODE_NBSP) && (n.firstChild && A(n.firstChild), n.innerHTML = "<br>");
